...
/**
 * This is the item provider adapter for a {@link ftp.AndGate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AndGateItemProvider extends FTNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AndGate_inputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AndGate_inputs_feature", "_UI_AndGate_type"),
				 FtpPackage.Literals.AND_GATE__INPUTS,
				 true,
				 false,
				 true,
				 null,
