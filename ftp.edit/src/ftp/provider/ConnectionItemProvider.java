...
/**
 * This is the item provider adapter for a {@link ftp.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider extends CompositionElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_fromPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_fromPort_feature", "_UI_Connection_type"),
				 FtpPackage.Literals.CONNECTION__FROM_PORT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addToPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_toPort_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_toPort_feature", "_UI_Connection_type"),
				 FtpPackage.Literals.CONNECTION__TO_PORT,
				 true,
				 false,
				 true,
				 null,
