...
/**
 * This is the item provider adapter for a {@link ftp.FaultTree} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FaultTreeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FtpPackage.Literals.FAULT_TREE__ROOT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FtpPackage.Literals.FAULT_TREE__FTNODES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FtpPackage.Literals.FAULT_TREE__FTNODES,
				 FtpFactory.eINSTANCE.createFTNode()));

		newChildDescriptors.add
			(createChildParameter
				(FtpPackage.Literals.FAULT_TREE__FTNODES,
				 FtpFactory.eINSTANCE.createOrGate()));

		newChildDescriptors.add
			(createChildParameter
				(FtpPackage.Literals.FAULT_TREE__FTNODES,
				 FtpFactory.eINSTANCE.createAndGate()));

		newChildDescriptors.add
			(createChildParameter
				(FtpPackage.Literals.FAULT_TREE__FTNODES,
				 FtpFactory.eINSTANCE.createFault()));

		newChildDescriptors.add
			(createChildParameter
				(FtpPackage.Literals.FAULT_TREE__FTNODES,
				 FtpFactory.eINSTANCE.createRootEvent()));
	}
