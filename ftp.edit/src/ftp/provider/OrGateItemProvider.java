...
/**
 * This is the item provider adapter for a {@link ftp.OrGate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrGateItemProvider extends FTNodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OrGate_inputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OrGate_inputs_feature", "_UI_OrGate_type"),
				 FtpPackage.Literals.OR_GATE__INPUTS,
				 true,
				 false,
				 true,
				 null,
