...
public class ExhibitPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ExhibitPropertiesEditionPart {
	...
	protected void createAnnotationTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.annotation.setHelpText(propertiesEditionComponent.getHelpContent(AmlViewsRepository.Exhibit.annotation, AmlViewsRepository.FORM_KIND));
	...
	protected void moveAnnotation(Annotation element, int oldIndex, int newIndex) {
		...
		annotation.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExhibitPropertiesEditionPartForm.this, AmlViewsRepository.Exhibit.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToAnnotation() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						annotation.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExhibitPropertiesEditionPartForm.this, AmlViewsRepository.Exhibit.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromAnnotation(Annotation element) {
		// Start of user code for the removeFromAnnotation() method body
				...
				annotation.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExhibitPropertiesEditionPartForm.this, AmlViewsRepository.Exhibit.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editAnnotation() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						annotation.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExhibitPropertiesEditionPartForm.this, AmlViewsRepository.Exhibit.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	...
	protected void createIdText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, AmlMessages.ExhibitPropertiesEditionPart_IdLabel, propertiesEditionComponent.isRequired(AmlViewsRepository.Exhibit.id, AmlViewsRepository.FORM_KIND));
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ExhibitPropertiesEditionPartForm.this, AmlViewsRepository.Exhibit.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AmlViewsRepository.Exhibit.id, AmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
