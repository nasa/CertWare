...
public class RelevancePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, RelevancePropertiesEditionPart {
	...
	protected void createDescriptionTextarea(FormToolkit widgetFactory, Composite parent) {
		Label descriptionLabel = FormUtils.createPartLabel(widgetFactory, parent, AmlMessages.RelevancePropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(AmlViewsRepository.Relevance.description, AmlViewsRepository.FORM_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelevancePropertiesEditionPartForm.this, AmlViewsRepository.Relevance.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}

		});
		EditingUtils.setID(description, AmlViewsRepository.Relevance.description);
		EditingUtils.setEEFtype(description, "eef::Textarea"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AmlViewsRepository.Relevance.description, AmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createLabelText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, AmlMessages.RelevancePropertiesEditionPart_LabelLabel, propertiesEditionComponent.isRequired(AmlViewsRepository.Relevance.label, AmlViewsRepository.FORM_KIND));
		...
		label.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelevancePropertiesEditionPartForm.this, AmlViewsRepository.Relevance.label, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, label.getText()));
			}
		});
		...
		EditingUtils.setID(label, AmlViewsRepository.Relevance.label);
		EditingUtils.setEEFtype(label, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AmlViewsRepository.Relevance.label, AmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createOrdinalText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, AmlMessages.RelevancePropertiesEditionPart_OrdinalLabel, propertiesEditionComponent.isRequired(AmlViewsRepository.Relevance.ordinal, AmlViewsRepository.FORM_KIND));
		...
		ordinal.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelevancePropertiesEditionPartForm.this, AmlViewsRepository.Relevance.ordinal, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, ordinal.getText()));
			}
		});
		...
		EditingUtils.setID(ordinal, AmlViewsRepository.Relevance.ordinal);
		EditingUtils.setEEFtype(ordinal, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AmlViewsRepository.Relevance.ordinal, AmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createSymbolText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, AmlMessages.RelevancePropertiesEditionPart_SymbolLabel, propertiesEditionComponent.isRequired(AmlViewsRepository.Relevance.symbol, AmlViewsRepository.FORM_KIND));
		...
		symbol.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RelevancePropertiesEditionPartForm.this, AmlViewsRepository.Relevance.symbol, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, symbol.getText()));
			}
		});
		...
		EditingUtils.setID(symbol, AmlViewsRepository.Relevance.symbol);
		EditingUtils.setEEFtype(symbol, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AmlViewsRepository.Relevance.symbol, AmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
