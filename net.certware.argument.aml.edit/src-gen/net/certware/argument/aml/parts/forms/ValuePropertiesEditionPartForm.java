...
public class ValuePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ValuePropertiesEditionPart {
	...
	protected void createPropertiesGroup(FormToolkit widgetFactory, final Composite view) {
		...
		createUnitText(widgetFactory, propertiesGroup);
		...
		editMixed.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValuePropertiesEditionPartForm.this, AmlViewsRepository.Value.mixed, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, mixedList));
					setHasChanged(true);
				}
			}
		});
	...
	protected void createTypeText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, AmlMessages.ValuePropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(AmlViewsRepository.Value.type, AmlViewsRepository.FORM_KIND));
		...
		type.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValuePropertiesEditionPartForm.this, AmlViewsRepository.Value.type, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, type.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AmlViewsRepository.Value.type, AmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createUnitText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, AmlMessages.ValuePropertiesEditionPart_UnitLabel, propertiesEditionComponent.isRequired(AmlViewsRepository.Value.unit, AmlViewsRepository.FORM_KIND));
		...
		unit.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ValuePropertiesEditionPartForm.this, AmlViewsRepository.Value.unit, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, unit.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AmlViewsRepository.Value.unit, AmlViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
