...
public class AnswerPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, AnswerPropertiesEditionPart {
	...
	protected void createPropertiesGroup(Composite parent) {
		...
		createQuestionIdText(propertiesGroup);
	}
		...
		editGroup.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnswerPropertiesEditionPartImpl.this, AmlViewsRepository.Answer.group, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, groupList));
					setHasChanged(true);
				}
			}
		});
	...
	protected void createQuestionIdText(Composite parent) {
		SWTUtils.createPartLabel(parent, AmlMessages.AnswerPropertiesEditionPart_QuestionIdLabel, propertiesEditionComponent.isRequired(AmlViewsRepository.Answer.questionId, AmlViewsRepository.SWT_KIND));
		...
		questionId.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AnswerPropertiesEditionPartImpl.this, AmlViewsRepository.Answer.questionId, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, questionId.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(AmlViewsRepository.Answer.questionId, AmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
