...
public class ArgumentPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ArgumentPropertiesEditionPart {
	...
	protected void createPropertiesGroup(Composite parent) {
		...
		createAnswerAdvancedTableComposition(propertiesGroup);
	...
	protected void createAnnotationAdvancedTableComposition(Composite parent) {
		...
		this.annotation.setHelpText(propertiesEditionComponent.getHelpContent(AmlViewsRepository.Argument.annotation, AmlViewsRepository.SWT_KIND));
	...
	protected void moveAnnotation(Annotation element, int oldIndex, int newIndex) {
		...
		annotation.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentPropertiesEditionPartImpl.this, AmlViewsRepository.Argument.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToAnnotation() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						annotation.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentPropertiesEditionPartImpl.this, AmlViewsRepository.Argument.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromAnnotation(Annotation element) {
		// Start of user code removeFromAnnotation() method body
				...
				annotation.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentPropertiesEditionPartImpl.this, AmlViewsRepository.Argument.annotation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editAnnotation() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						annotation.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentPropertiesEditionPartImpl.this, AmlViewsRepository.Argument.annotation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	 ...
	 * 
	 */
	protected void createAnswerAdvancedTableComposition(Composite parent) {
		...
		this.answer.setHelpText(propertiesEditionComponent.getHelpContent(AmlViewsRepository.Argument.answer, AmlViewsRepository.SWT_KIND));
	...
	protected void moveAnswer(Answer element, int oldIndex, int newIndex) {
		...
		answer.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentPropertiesEditionPartImpl.this, AmlViewsRepository.Argument.answer, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToAnswer() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						answer.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentPropertiesEditionPartImpl.this, AmlViewsRepository.Argument.answer, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromAnswer(Answer element) {
		// Start of user code removeFromAnswer() method body
				EObject editedElement = answerEditUtil.foundCorrespondingEObject(element);
				answerEditUtil.removeElement(element);
				answer.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentPropertiesEditionPartImpl.this, AmlViewsRepository.Argument.answer, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editAnswer() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						answer.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentPropertiesEditionPartImpl.this, AmlViewsRepository.Argument.answer, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	...
	protected void createIdText(Composite parent) {
		SWTUtils.createPartLabel(parent, AmlMessages.ArgumentPropertiesEditionPart_IdLabel, propertiesEditionComponent.isRequired(AmlViewsRepository.Argument.id, AmlViewsRepository.SWT_KIND));
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentPropertiesEditionPartImpl.this, AmlViewsRepository.Argument.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(AmlViewsRepository.Argument.id, AmlViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
