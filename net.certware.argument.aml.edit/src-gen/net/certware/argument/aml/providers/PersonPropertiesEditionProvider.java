...
import net.certware.argument.aml.components.PersonPropertiesEditionComponent;
...
public class PersonPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Person) && (AmlPackage.eINSTANCE.getPerson() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof Person) && (PersonPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof Person) && (refinement == PersonPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof Person) && ((PersonPropertiesEditionComponent.BASE_PART.equals(part) && refinement == PersonPropertiesEditionComponent.class));
	}
