...
/**
 * This is the item provider adapter for a {@link net.certware.argument.aml.Annotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Annotation_id_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Annotation_id_feature", "_UI_Annotation_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 AmlPackage.Literals.ANNOTATION__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmlPackage.Literals.ANNOTATION__MIXED);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.ANNOTATION__MIXED,
		...
		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.ANNOTATION__MIXED,
				 FeatureMapUtil.createEntry
					(AmlPackage.Literals.ANNOTATION__MEMO,
		...
		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.ANNOTATION__MIXED,
				 FeatureMapUtil.createEntry
					(AmlPackage.Literals.ANNOTATION__FLAG,
