...
/**
 * This is the item provider adapter for a {@link net.certware.argument.aml.Exhibit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExhibitItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Exhibit_id_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Exhibit_id_feature", "_UI_Exhibit_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 AmlPackage.Literals.EXHIBIT__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmlPackage.Literals.EXHIBIT__ARCHIVE);
			childrenFeatures.add(AmlPackage.Literals.EXHIBIT__META_DATA);
			childrenFeatures.add(AmlPackage.Literals.EXHIBIT__ANNOTATION);
		}
	...
	public String getText(Object object) {
		String label = ((Exhibit)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.EXHIBIT__ARCHIVE,
				 XMLTypeFactory.eINSTANCE.createAnyType()));

		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.EXHIBIT__META_DATA,
				 AmlFactory.eINSTANCE.createMetaData()));

		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.EXHIBIT__ANNOTATION,
