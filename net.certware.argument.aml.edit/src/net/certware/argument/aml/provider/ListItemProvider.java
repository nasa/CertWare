...
/**
 * This is the item provider adapter for a {@link net.certware.argument.aml.List} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ListItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmlPackage.Literals.LIST__GROUP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/List")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		return getString("_UI_List_type"); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(net.certware.argument.aml.List.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.LIST__GROUP,
				 FeatureMapUtil.createEntry
					(AmlPackage.Literals.LIST__LI,
