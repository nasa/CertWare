...
/**
 * This is the item provider adapter for a {@link net.certware.argument.aml.Value} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Value_type_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Value_type_feature", "_UI_Value_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 AmlPackage.Literals.VALUE__TYPE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AmlPackage.Literals.VALUE__UNIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmlPackage.Literals.VALUE__MIXED);
		}
	...
	public String getText(Object object) {
		String label = ((Value)object).getType();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.VALUE__MIXED,
		...
		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.VALUE__MIXED,
				 FeatureMapUtil.createEntry
					(AmlPackage.Literals.VALUE__INTERVAL,
		...
		newChildDescriptors.add
			(createChildParameter
				(AmlPackage.Literals.VALUE__MIXED,
				 FeatureMapUtil.createEntry
					(AmlPackage.Literals.VALUE__LIST,
