...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Object Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.argument.aml.AmlPackage#getObjectType1()
 * @model extendedMetaData="name='object-type_._1_._type'"
 * @generated
 */
public enum ObjectType1 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Object Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ObjectType1[] VALUES_ARRAY =
		new ObjectType1[] {
			TEMPLATE,
			ARGUMENT,
			COLLECTION,
	...
	/**
	 * A public read-only list of all the '<em><b>Object Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ObjectType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Object Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ObjectType1 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ObjectType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Object Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ObjectType1 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ObjectType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Object Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ObjectType1 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ObjectType1(int value, String name, String literal) {
		this.value = value;
		this.name = name;
