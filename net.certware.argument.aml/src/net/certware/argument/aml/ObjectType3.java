...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Object Type3</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.argument.aml.AmlPackage#getObjectType3()
 * @model extendedMetaData="name='object-type_._3_._type'"
 * @generated
 */
public enum ObjectType3 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Object Type3</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ObjectType3[] VALUES_ARRAY =
		new ObjectType3[] {
			TEMPLATE,
			ARGUMENT,
			COLLECTION,
	...
	/**
	 * A public read-only list of all the '<em><b>Object Type3</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ObjectType3> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Object Type3</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ObjectType3 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ObjectType3 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Object Type3</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ObjectType3 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ObjectType3 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Object Type3</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ObjectType3 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ObjectType3(int value, String name, String literal) {
		this.value = value;
		this.name = name;
