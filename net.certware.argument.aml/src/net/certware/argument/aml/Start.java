 ...
 * <ul>
 *   <li>{@link net.certware.argument.aml.Start#getValue <em>Value</em>}</li>
 *   <li>{@link net.certware.argument.aml.Start#getScheme <em>Scheme</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.argument.aml.AmlPackage#getStart()
 * @model extendedMetaData="name='start_._type' kind='simple'"
 * @generated
 */
public interface Start extends EObject {
	 ...
	 * @see #setValue(String)
	 * @see net.certware.argument.aml.AmlPackage#getStart_Value()
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.aml.Start#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.certware.argument.aml.AmlPackage#getStart_Scheme()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.aml.Start#getScheme <em>Scheme</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
