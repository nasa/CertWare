 ...
 * <ul>
 *   <li>{@link net.certware.argument.aml.impl.IntervalImpl#getMax <em>Max</em>}</li>
 *   <li>{@link net.certware.argument.aml.impl.IntervalImpl#getMin <em>Min</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntervalImpl extends EObjectImpl implements Interval {
	...
	protected EClass eStaticClass() {
		return AmlPackage.Literals.INTERVAL;
	}
	...
	public void setMax(String newMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmlPackage.INTERVAL__MAX, oldMax, max));
	}
	...
	public void setMin(String newMin) {
		...
		min = newMin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmlPackage.INTERVAL__MIN, oldMin, min));
	}
