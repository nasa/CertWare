...
public class InternalAnalysisDSLLexer extends Lexer {
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:541:13: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
            // InternalAnalysisDSL.g:541:15: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            {
            // InternalAnalysisDSL.g:541:15: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalAnalysisDSL.g:541:16: '0'
                    {
                    match('0'); 
                    ...
                    break;
                case 2 :
                    // InternalAnalysisDSL.g:541:20: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // InternalAnalysisDSL.g:541:29: ( '0' .. '9' )*
                    loop1:
                    do {
                        int alt1=2;
                        ...
                        switch (alt1) {
                    	case 1 :
                    	    // InternalAnalysisDSL.g:541:30: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_IDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:543:17: ( 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalAnalysisDSL.g:543:19: 'a' .. 'z' ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            matchRange('a','z'); 
            // InternalAnalysisDSL.g:543:28: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_SATISFIABLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:545:18: ( 'SATISFIABLE' )
            // InternalAnalysisDSL.g:545:20: 'SATISFIABLE'
            {
            match("SATISFIABLE"); 
    ...
    public final void mRULE_UNSATISFIABLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:547:20: ( 'UNSATISFIABLE' )
            // InternalAnalysisDSL.g:547:22: 'UNSATISFIABLE'
            {
            match("UNSATISFIABLE"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:549:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalAnalysisDSL.g:549:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalAnalysisDSL.g:549:11: ( '^' )?
            int alt4=2;
            ...
            // InternalAnalysisDSL.g:549:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:551:10: ( ( '0' .. '9' )+ )
            // InternalAnalysisDSL.g:551:12: ( '0' .. '9' )+
            {
            // InternalAnalysisDSL.g:551:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalAnalysisDSL.g:551:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:553:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalAnalysisDSL.g:553:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalAnalysisDSL.g:553:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalAnalysisDSL.g:553:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalAnalysisDSL.g:553:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalAnalysisDSL.g:553:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalAnalysisDSL.g:553:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:555:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalAnalysisDSL.g:555:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalAnalysisDSL.g:555:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:557:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalAnalysisDSL.g:557:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalAnalysisDSL.g:557:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
            ...
            // InternalAnalysisDSL.g:557:40: ( ( '\\r' )? '\\n' )?
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalAnalysisDSL.g:557:41: ( '\\r' )? '\\n'
                    {
                    // InternalAnalysisDSL.g:557:41: ( '\\r' )?
                    int alt12=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:559:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalAnalysisDSL.g:559:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalAnalysisDSL.g:559:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalAnalysisDSL.g:561:16: ( . )
            // InternalAnalysisDSL.g:561:18: .
            {
            matchAny(); 
