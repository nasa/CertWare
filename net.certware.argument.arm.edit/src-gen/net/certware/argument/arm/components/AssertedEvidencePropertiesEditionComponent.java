 ...
 * 
 */
public class AssertedEvidencePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * 
	 */
	protected AssertedEvidencePropertiesEditionPart basePart;

	/**
	 * Default constructor
	 * 
	 */
	public AssertedEvidencePropertiesEditionComponent(EObject assertedEvidence, String editing_mode) {
		if (assertedEvidence instanceof AssertedEvidence) {
			this.assertedEvidence = (AssertedEvidence)assertedEvidence;
			if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode)) {
				semanticAdapter = initializeSemanticAdapter();
				this.assertedEvidence.eAdapters().add(semanticAdapter);
			}
		}
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(final Notification msg) {
				if (basePart == null)
					AssertedEvidencePropertiesEditionComponent.this.dispose();
				else {
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return ArmViewsRepository.AssertedEvidence.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (assertedEvidence != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (AssertedEvidencePropertiesEditionPart)provider.getPropertiesEditionPart(ArmViewsRepository.AssertedEvidence.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == ArmViewsRepository.AssertedEvidence.class)
			this.basePart = (AssertedEvidencePropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (basePart != null && key == ArmViewsRepository.AssertedEvidence.class) {
			((IPropertiesEditionPart)basePart).setContext(elt, allResource);
			final AssertedEvidence assertedEvidence = (AssertedEvidence)elt;
			// init values
			if (assertedEvidence.getIdentifier() != null)
				basePart.setIdentifier(EEFConverterUtil.convertToString(ArmPackage.eINSTANCE.getString(), assertedEvidence.getIdentifier()));

			if (assertedEvidence.getDescription() != null)
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((assertedEvidence != null) && (basePart != null)) { 
			...
			for (Iterator iter = isTaggedToMoveFromIsTagged.iterator(); iter.hasNext();){
				...
				cc.append(MoveCommand.create(editingDomain, assertedEvidence, ArmPackage.eINSTANCE.getTaggedValue(), moveElement.getElement(), moveElement.getIndex()));
			}
			List targetToAddFromTarget = basePart.getTargetToAdd();
			for (Iterator iter = targetToAddFromTarget.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Target(), iter.next()));
			List targetToRemoveFromTarget = basePart.getTargetToRemove();
			for (Iterator iter = targetToRemoveFromTarget.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Target(), iter.next()));
			//List targetToMoveFromTarget = basePart.getTargetToMove();
			//for (Iterator iter = targetToMoveFromTarget.iterator(); iter.hasNext();){
			//	org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			//	cc.append(MoveCommand.create(editingDomain, assertedEvidence, ArmPackage.eINSTANCE.getModelElement(), moveElement.getElement(), moveElement.getIndex()));
			//}
			List sourceToAddFromSource = basePart.getSourceToAdd();
			for (Iterator iter = sourceToAddFromSource.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Source(), iter.next()));
			List sourceToRemoveFromSource = basePart.getSourceToRemove();
			for (Iterator iter = sourceToRemoveFromSource.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Source(), iter.next()));
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof AssertedEvidence) {
			AssertedEvidence assertedEvidenceToUpdate = (AssertedEvidence)source;
			assertedEvidenceToUpdate.setIdentifier((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), basePart.getIdentifier()));
			...
			return assertedEvidenceToUpdate;
		}
		else
			return null;
	}
	...
	public void firePropertiesChanged(IPropertiesEditionEvent event) {
		if (!isInitializing()) {
			...
			if (ArmViewsRepository.AssertedEvidence.identifier == event.getAffectedEditor()) {
				command.append(SetCommand.create(liveEditingDomain, assertedEvidence, ArmPackage.eINSTANCE.getModelElement_Identifier(), EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), (String)event.getNewValue())));
			}
			if (ArmViewsRepository.AssertedEvidence.description == event.getAffectedEditor()) {
			...
			if (ArmViewsRepository.AssertedEvidence.isTagged == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					// TODO: Complete the assertedEvidence update command
					...
					command.append(AddCommand.create(liveEditingDomain, assertedEvidence, ArmPackage.eINSTANCE.getModelElement_IsTagged(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, assertedEvidence, ArmPackage.eINSTANCE.getTaggedValue(), event.getNewValue(), event.getNewIndex()));
			}
			if (ArmViewsRepository.AssertedEvidence.target == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Target(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Target(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Target(), event.getNewValue(), event.getNewIndex()));
			}
			if (ArmViewsRepository.AssertedEvidence.source == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Source(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Source(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, assertedEvidence, ArmPackage.eINSTANCE.getArgumentLink_Source(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			EObject copy = EcoreUtil.copy(assertedEvidence);
			copy = getPropertiesEditionObject(copy);
			validate =  EEFRuntimePlugin.getEEFValidator().validate(copy);
		}
		else if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode))
			validate = EEFRuntimePlugin.getEEFValidator().validate(assertedEvidence);
	...
	public void dispose() {
		if (semanticAdapter != null)
			assertedEvidence.eAdapters().remove(semanticAdapter);
	}
