 ...
 * 
 */
public class InformationElementPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * 
	 */
	protected InformationElementPropertiesEditionPart basePart;

	/**
	 * Default constructor
	 * 
	 */
	public InformationElementPropertiesEditionComponent(EObject informationElement, String editing_mode) {
		if (informationElement instanceof InformationElement) {
			this.informationElement = (InformationElement)informationElement;
			if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode)) {
				semanticAdapter = initializeSemanticAdapter();
				this.informationElement.eAdapters().add(semanticAdapter);
			}
		}
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(final Notification msg) {
				if (basePart == null)
					InformationElementPropertiesEditionComponent.this.dispose();
				else {
	...
	protected void runUpdateRunnable(final Notification msg) {
		...
		if (msg.getFeature() != null && ((EStructuralFeature)msg.getFeature() == ArmPackage.eINSTANCE.getModelElement_IsTagged())) {
			basePart.updateIsTagged(informationElement);
		}
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return ArmViewsRepository.InformationElement.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (informationElement != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (InformationElementPropertiesEditionPart)provider.getPropertiesEditionPart(ArmViewsRepository.InformationElement.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == ArmViewsRepository.InformationElement.class)
			this.basePart = (InformationElementPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (basePart != null && key == ArmViewsRepository.InformationElement.class) {
			((IPropertiesEditionPart)basePart).setContext(elt, allResource);
			final InformationElement informationElement = (InformationElement)elt;
			// init values
			if (informationElement.getIdentifier() != null)
				basePart.setIdentifier(EEFConverterUtil.convertToString(ArmPackage.eINSTANCE.getString(), informationElement.getIdentifier()));

			if (informationElement.getDescription() != null)
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((informationElement != null) && (basePart != null)) { 
			...
			for (Iterator iter = isTaggedToMoveFromIsTagged.iterator(); iter.hasNext();){
				...
				cc.append(MoveCommand.create(editingDomain, informationElement, ArmPackage.eINSTANCE.getTaggedValue(), moveElement.getElement(), moveElement.getIndex()));
			}
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof InformationElement) {
			InformationElement informationElementToUpdate = (InformationElement)source;
			informationElementToUpdate.setIdentifier((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), basePart.getIdentifier()));
	...
	public void firePropertiesChanged(IPropertiesEditionEvent event) {
		if (!isInitializing()) {
			...
			if (ArmViewsRepository.InformationElement.identifier == event.getAffectedEditor()) {
				command.append(SetCommand.create(liveEditingDomain, informationElement, ArmPackage.eINSTANCE.getModelElement_Identifier(), EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), (String)event.getNewValue())));
			}
			if (ArmViewsRepository.InformationElement.description == event.getAffectedEditor()) {
			...
			if (ArmViewsRepository.InformationElement.isTagged == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					// TODO: Complete the informationElement update command
					...
					command.append(AddCommand.create(liveEditingDomain, informationElement, ArmPackage.eINSTANCE.getModelElement_IsTagged(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, informationElement, ArmPackage.eINSTANCE.getTaggedValue(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			EObject copy = EcoreUtil.copy(informationElement);
			copy = getPropertiesEditionObject(copy);
			validate =  EEFRuntimePlugin.getEEFValidator().validate(copy);
		}
		else if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode))
			validate = EEFRuntimePlugin.getEEFValidator().validate(informationElement);
	...
	public void dispose() {
		if (semanticAdapter != null)
			informationElement.eAdapters().remove(semanticAdapter);
	}
