 ...
 * 
 */
public class AssertedChallengePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, AssertedChallengePropertiesEditionPart {
	...
	protected void createPropertiesGroup(FormToolkit widgetFactory, final Composite view) {
		...
		propertiesSection.setText(ArmMessages.AssertedChallengePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected void createIdentifierText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ArmMessages.AssertedChallengePropertiesEditionPart_IdentifierLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedChallenge.identifier, ArmViewsRepository.FORM_KIND));
		...
		identifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.identifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, identifier.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.identifier, ArmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ArmMessages.AssertedChallengePropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedChallenge.description, ArmViewsRepository.FORM_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.description, ArmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsTaggedTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.isTagged.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.isTagged, ArmViewsRepository.FORM_KIND));
	...
	protected void moveIsTagged(TaggedValue element, int oldIndex, int newIndex) {
		...
		isTagged.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromIsTagged(TaggedValue element) {
		// Start of user code for the removeFromIsTagged() method body
				...
				isTagged.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	...
	protected void createTargetReferencesTable(FormToolkit widgetFactory, Composite parent) {
				...
				"ModelElement", ArmPackage.eINSTANCE.getModelElement(), current.eResource()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.target,
		...
		this.target.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.target, ArmViewsRepository.FORM_KIND));
	...
	protected void removeFromTarget(ModelElement element) {
		// Start of user code for the removeFromTarget() method body
				...
				target.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.target, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editTarget() method body		
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						target.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.target, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	...
	protected void createSourceReferencesTable(FormToolkit widgetFactory, Composite parent) {
				...
				"ModelElement", ArmPackage.eINSTANCE.getModelElement(), current.eResource()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.source,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						source.refresh();
					}
		...
		this.source.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.source, ArmViewsRepository.FORM_KIND));
	...
	protected void removeFromSource(ModelElement element) {
		// Start of user code for the removeFromSource() method body
				...
				source.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editSource() method body		
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						source.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartForm.this, ArmViewsRepository.AssertedChallenge.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
