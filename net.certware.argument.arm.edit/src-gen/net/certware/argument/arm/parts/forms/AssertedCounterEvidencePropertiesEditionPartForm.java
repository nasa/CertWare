...
public class AssertedCounterEvidencePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, AssertedCounterEvidencePropertiesEditionPart {
	...
	protected void createContentText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ArmMessages.AssertedCounterEvidencePropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedCounterEvidence.content, ArmViewsRepository.FORM_KIND));
