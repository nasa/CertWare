 ...
 * 
 */
public class AssertedEvidencePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, AssertedEvidencePropertiesEditionPart {
	...
	protected void createPropertiesGroup(FormToolkit widgetFactory, final Composite view) {
		...
		propertiesSection.setText(ArmMessages.AssertedEvidencePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected void createIdentifierText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ArmMessages.AssertedEvidencePropertiesEditionPart_IdentifierLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedEvidence.identifier, ArmViewsRepository.FORM_KIND));
		...
		identifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.identifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, identifier.getText()));
			}
		});
		...
		EditingUtils.setID(identifier, ArmViewsRepository.AssertedEvidence.identifier);
		EditingUtils.setEEFtype(identifier, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedEvidence.identifier, ArmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, ArmMessages.AssertedEvidencePropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedEvidence.description, ArmViewsRepository.FORM_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		});
		...
		EditingUtils.setID(description, ArmViewsRepository.AssertedEvidence.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedEvidence.description, ArmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createContentTextarea(FormToolkit widgetFactory, Composite parent) {
		Label contentLabel = FormUtils.createPartLabel(widgetFactory, parent, ArmMessages.AssertedEvidencePropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedEvidence.content, ArmViewsRepository.FORM_KIND));
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.content, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, content.getText()));
			}

		});
		EditingUtils.setID(content, ArmViewsRepository.AssertedEvidence.content);
		EditingUtils.setEEFtype(content, "eef::Textarea"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedEvidence.content, ArmViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsTaggedTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.isTagged = new ReferencesTable<TaggedValue>(ArmMessages.AssertedEvidencePropertiesEditionPart_IsTaggedLabel, new ReferencesTableListener<TaggedValue>() {			
		...
		this.isTagged.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedEvidence.isTagged, ArmViewsRepository.FORM_KIND));
		...
		isTagged.setID(ArmViewsRepository.AssertedEvidence.isTagged);
	...
	protected void moveIsTagged(TaggedValue element, int oldIndex, int newIndex) {
		...
		isTagged.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromIsTagged(TaggedValue element) {
		// Start of user code for the removeFromIsTagged() method body
				...
				isTagged.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	...
	protected void createTargetReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.target = new ReferencesTable<ModelElement>(ArmMessages.AssertedEvidencePropertiesEditionPart_TargetLabel, new ReferencesTableListener<ModelElement>() {
				...
				"ModelElement", ArmPackage.eINSTANCE.getModelElement(), current.eResource()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.target,
		...
		this.target.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedEvidence.target, ArmViewsRepository.FORM_KIND));
		...
		target.setID(ArmViewsRepository.AssertedEvidence.target);
	...
	protected void removeFromTarget(ModelElement element) {
		// Start of user code for the removeFromTarget() method body
				...
				target.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.target, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editTarget() method body		
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						target.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.target, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	...
	protected void createSourceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.source = new ReferencesTable<ModelElement>(ArmMessages.AssertedEvidencePropertiesEditionPart_SourceLabel, new ReferencesTableListener<ModelElement>() {
			public void handleAdd() {
				...
				"ModelElement", ArmPackage.eINSTANCE.getModelElement(), current.eResource()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.source,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						source.refresh();
					}
		...
		this.source.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedEvidence.source, ArmViewsRepository.FORM_KIND));
		...
		source.setID(ArmViewsRepository.AssertedEvidence.source);
	...
	protected void removeFromSource(ModelElement element) {
		// Start of user code for the removeFromSource() method body
				...
				source.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editSource() method body		
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						source.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedEvidencePropertiesEditionPartForm.this, ArmViewsRepository.AssertedEvidence.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getIsTaggedToAdd()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getIsTaggedToRemove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getIsTaggedToEdit()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getIsTaggedToMove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getIsTaggedTable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#updateIsTagged(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getTargetToAdd()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getTargetToRemove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getTargetTable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#initTarget(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#updateTarget(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getSourceToAdd()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getSourceToRemove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#getSourceTable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#initSource(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedEvidencePropertiesEditionPart#updateSource(EObject newValue)
	 * 
	 */
