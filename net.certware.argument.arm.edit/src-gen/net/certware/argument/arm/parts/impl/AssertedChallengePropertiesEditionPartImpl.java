...
public class AssertedChallengePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, AssertedChallengePropertiesEditionPart {
	...
	protected void createIdentifierText(Composite parent) {
		SWTUtils.createPartLabel(parent, ArmMessages.AssertedChallengePropertiesEditionPart_IdentifierLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedChallenge.identifier, ArmViewsRepository.SWT_KIND));
		...
		identifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.identifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, identifier.getText()));
			}
		...
		EditingUtils.setID(identifier, ArmViewsRepository.AssertedChallenge.identifier);
		EditingUtils.setEEFtype(identifier, "eef::Text"); //$NON-NLS-1$
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.identifier, ArmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, ArmMessages.AssertedChallengePropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedChallenge.description, ArmViewsRepository.SWT_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		EditingUtils.setID(description, ArmViewsRepository.AssertedChallenge.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.description, ArmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createContentText(Composite parent) {
		SWTUtils.createPartLabel(parent, ArmMessages.AssertedChallengePropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedChallenge.content, ArmViewsRepository.SWT_KIND));
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.content, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, content.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.content, ArmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsTaggedAdvancedTableComposition(Composite parent) {
		this.isTagged = new ReferencesTable<TaggedValue>(ArmMessages.AssertedChallengePropertiesEditionPart_IsTaggedLabel, new ReferencesTableListener<TaggedValue>() {			
		...
		this.isTagged.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.isTagged, ArmViewsRepository.SWT_KIND));
		...
		isTagged.setID(ArmViewsRepository.AssertedChallenge.isTagged);
	...
	protected void moveIsTagged(TaggedValue element, int oldIndex, int newIndex) {
		...
		isTagged.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromIsTagged(TaggedValue element) {
		// Start of user code removeFromIsTagged() method body
				...
				isTagged.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.isTagged, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.isTagged, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	...
	protected void createTargetAdvancedReferencesTable(Composite parent) {
				...
				"ModelElement", ArmPackage.eINSTANCE.getModelElement(), current.eResource()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.target,
		...
		this.target.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.target, ArmViewsRepository.SWT_KIND));
		...
		target.setID(ArmViewsRepository.AssertedChallenge.target);
	...
	protected void removeFromTarget(ModelElement element) {
		...
		// Start of user code removeFromTarget() method body
				...
				target.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.target, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editTarget() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						target.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.target, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	...
	protected void createSourceAdvancedReferencesTable(Composite parent) {
				...
				"ModelElement", ArmPackage.eINSTANCE.getModelElement(), current.eResource()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.source,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						source.refresh();
					}
		...
		this.source.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.AssertedChallenge.source, ArmViewsRepository.SWT_KIND));
		...
		source.setID(ArmViewsRepository.AssertedChallenge.source);
	...
	protected void removeFromSource(ModelElement element) {
		...
		// Start of user code removeFromSource() method body
				...
				source.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editSource() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						source.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssertedChallengePropertiesEditionPartImpl.this, ArmViewsRepository.AssertedChallenge.source, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getIsTaggedToAdd()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getIsTaggedToRemove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getIsTaggedToEdit()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getIsTaggedToMove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getIsTaggedTable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#updateIsTagged(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getTargetToAdd()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getTargetToRemove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getTargetTable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#initTarget(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#updateTarget(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getSourceToAdd()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getSourceToRemove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#getSourceTable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#initSource(EObject current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.AssertedChallengePropertiesEditionPart#updateSource(EObject newValue)
	 * 
	 */
