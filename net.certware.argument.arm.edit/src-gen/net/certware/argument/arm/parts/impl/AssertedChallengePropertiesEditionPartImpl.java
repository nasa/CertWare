...
public class AssertedChallengePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, AssertedChallengePropertiesEditionPart {
	...
	protected void createContentTextarea(Composite parent) {
		Label contentLabel = SWTUtils.createPartLabel(parent, ArmMessages.AssertedChallengePropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedChallenge.content, ArmViewsRepository.SWT_KIND));
