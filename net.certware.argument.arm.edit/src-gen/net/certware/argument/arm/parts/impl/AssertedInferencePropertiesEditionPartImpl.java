...
public class AssertedInferencePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, AssertedInferencePropertiesEditionPart {
	...
	protected void createContentTextarea(Composite parent) {
		Label contentLabel = SWTUtils.createPartLabel(parent, ArmMessages.AssertedInferencePropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.AssertedInference.content, ArmViewsRepository.SWT_KIND));
