...
// End of user code
	...
	protected void createContentTextarea(Composite parent) {
		Label contentLabel = SWTUtils.createPartLabel(parent, ArmMessages.EvidenceAssertionPropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.EvidenceAssertion.content, ArmViewsRepository.SWT_KIND));
