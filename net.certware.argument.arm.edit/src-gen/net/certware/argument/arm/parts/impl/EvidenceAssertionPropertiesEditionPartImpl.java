...
public class EvidenceAssertionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EvidenceAssertionPropertiesEditionPart {
	...
	protected void createIdentifierText(Composite parent) {
		SWTUtils.createPartLabel(parent, ArmMessages.EvidenceAssertionPropertiesEditionPart_IdentifierLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.EvidenceAssertion.identifier, ArmViewsRepository.SWT_KIND));
		...
		identifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceAssertionPropertiesEditionPartImpl.this, ArmViewsRepository.EvidenceAssertion.identifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, identifier.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.EvidenceAssertion.identifier, ArmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, ArmMessages.EvidenceAssertionPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.EvidenceAssertion.description, ArmViewsRepository.SWT_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceAssertionPropertiesEditionPartImpl.this, ArmViewsRepository.EvidenceAssertion.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.EvidenceAssertion.description, ArmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createContentText(Composite parent) {
		SWTUtils.createPartLabel(parent, ArmMessages.EvidenceAssertionPropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(ArmViewsRepository.EvidenceAssertion.content, ArmViewsRepository.SWT_KIND));
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceAssertionPropertiesEditionPartImpl.this, ArmViewsRepository.EvidenceAssertion.content, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, content.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.EvidenceAssertion.content, ArmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsTaggedAdvancedTableComposition(Composite parent) {
		this.isTagged = new ReferencesTable<TaggedValue>(ArmMessages.EvidenceAssertionPropertiesEditionPart_IsTaggedLabel, new ReferencesTableListener<TaggedValue>() {			
		...
		this.isTagged.setHelpText(propertiesEditionComponent.getHelpContent(ArmViewsRepository.EvidenceAssertion.isTagged, ArmViewsRepository.SWT_KIND));
	...
	protected void moveIsTagged(TaggedValue element, int oldIndex, int newIndex) {
		...
		isTagged.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceAssertionPropertiesEditionPartImpl.this, ArmViewsRepository.EvidenceAssertion.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceAssertionPropertiesEditionPartImpl.this, ArmViewsRepository.EvidenceAssertion.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromIsTagged(TaggedValue element) {
		// Start of user code removeFromIsTagged() method body
				...
				isTagged.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceAssertionPropertiesEditionPartImpl.this, ArmViewsRepository.EvidenceAssertion.isTagged, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceAssertionPropertiesEditionPartImpl.this, ArmViewsRepository.EvidenceAssertion.isTagged, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	...
	protected void createAssumedCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.EvidenceAssertion.assumed, ArmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createToBeSupportedCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArmViewsRepository.EvidenceAssertion.toBeSupported, ArmViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.EvidenceAssertionPropertiesEditionPart#getIsTaggedToAdd()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.EvidenceAssertionPropertiesEditionPart#getIsTaggedToRemove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.EvidenceAssertionPropertiesEditionPart#getIsTaggedToEdit()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.EvidenceAssertionPropertiesEditionPart#getIsTaggedToMove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.EvidenceAssertionPropertiesEditionPart#getIsTaggedTable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.arm.parts.EvidenceAssertionPropertiesEditionPart#updateIsTagged(EObject newValue)
	 * 
	 */
