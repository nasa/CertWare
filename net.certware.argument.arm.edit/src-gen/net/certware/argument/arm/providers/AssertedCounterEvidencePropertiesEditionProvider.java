...
import net.certware.argument.arm.components.AssertedCounterEvidencePropertiesEditionComponent;
...
public class AssertedCounterEvidencePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof AssertedCounterEvidence) && (ArmPackage.eINSTANCE.getAssertedCounterEvidence() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof AssertedCounterEvidence) && (AssertedCounterEvidencePropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof AssertedCounterEvidence) && (refinement == AssertedCounterEvidencePropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof AssertedCounterEvidence) && ((AssertedCounterEvidencePropertiesEditionComponent.BASE_PART.equals(part) && refinement == AssertedCounterEvidencePropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof AssertedCounterEvidence) {
			return new AssertedCounterEvidencePropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
