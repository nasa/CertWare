 ...
 * 
 */
public class ClaimPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Claim) && (ArmPackage.eINSTANCE.getClaim() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof Claim) && (ClaimPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof Claim) && (refinement == ClaimPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof Claim) && ((ClaimPropertiesEditionComponent.BASE_PART.equals(part) && refinement == ClaimPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof Claim) {
			return new ClaimPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
