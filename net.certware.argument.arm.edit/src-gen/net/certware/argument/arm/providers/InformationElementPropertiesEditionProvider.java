...
import net.certware.argument.arm.components.InformationElementPropertiesEditionComponent;
 ...
 * 
 */
public class InformationElementPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof InformationElement) && (ArmPackage.eINSTANCE.getInformationElement() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof InformationElement) && (InformationElementPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof InformationElement) && (refinement == InformationElementPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof InformationElement) && ((InformationElementPropertiesEditionComponent.BASE_PART.equals(part) && refinement == InformationElementPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof InformationElement) {
			return new InformationElementPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
