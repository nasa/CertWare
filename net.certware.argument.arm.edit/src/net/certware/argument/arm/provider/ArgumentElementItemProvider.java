...
/**
 * This is the item provider adapter for a {@link net.certware.argument.arm.ArgumentElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentElementItemProvider extends ModelElementItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public String getText(Object object) {
		String label = ((ArgumentElement)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_ArgumentElement_type") : //$NON-NLS-1$
			getString("_UI_ArgumentElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
