...
/**
 * This is the item provider adapter for a {@link net.certware.argument.arm.AssertedChallenge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssertedChallengeItemProvider extends AssertedRelationshipItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public String getText(Object object) {
		String label = ((AssertedChallenge)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_AssertedChallenge_type") : //$NON-NLS-1$
			getString("_UI_AssertedChallenge_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
