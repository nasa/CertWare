...
/**
 * This is the item provider adapter for a {@link net.certware.argument.arm.AssertedInference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssertedInferenceItemProvider extends AssertedRelationshipItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	public String getText(Object object) {
		String label = ((AssertedInference)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_AssertedInference_type") : //$NON-NLS-1$
			getString("_UI_AssertedInference_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
