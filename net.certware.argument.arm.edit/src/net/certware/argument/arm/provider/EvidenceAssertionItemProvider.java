...
/**
 * This is the item provider adapter for a {@link net.certware.argument.arm.EvidenceAssertion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EvidenceAssertionItemProvider extends ClaimItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public EvidenceAssertionItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns EvidenceAssertion.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EvidenceAssertion")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((EvidenceAssertion)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_EvidenceAssertion_type") : //$NON-NLS-1$
			getString("_UI_EvidenceAssertion_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
