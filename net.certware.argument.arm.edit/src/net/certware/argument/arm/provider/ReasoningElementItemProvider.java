...
/**
 * This is the item provider adapter for a {@link net.certware.argument.arm.ReasoningElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReasoningElementItemProvider extends ArgumentElementItemProvider {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	public ReasoningElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ReasoningElement)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_ReasoningElement_type") : //$NON-NLS-1$
			getString("_UI_ReasoningElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
