...
/**
 * The class <code>AssertedCounterEvidenceTest</code> contains tests for the class <code>{@link AssertedCounterEvidence}</code>.
 * <p>
 * CertWare Project
 ...
 * @author mrb
 */
public class AssertedCounterEvidenceTest {
