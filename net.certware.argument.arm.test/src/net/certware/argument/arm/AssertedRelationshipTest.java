...
/**
 * The class <code>AssertedRelationshipTest</code> contains tests for the class <code>{@link AssertedRelationship}</code>.
 * @generatedBy CodePro at 10/12/10 1:19 PM
 * @author mrb
 */
public class AssertedRelationshipTest {
