 ...
 * <ul>
 *   <li>{@link net.certware.argument.arm.impl.TaggedValueImpl#getKey <em>Key</em>}</li>
 *   <li>{@link net.certware.argument.arm.impl.TaggedValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TaggedValueImpl extends EObjectImpl implements TaggedValue {
	...
	protected EClass eStaticClass() {
		return ArmPackage.Literals.TAGGED_VALUE;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArmPackage.TAGGED_VALUE__KEY, oldKey, key));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArmPackage.TAGGED_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArmPackage.TAGGED_VALUE__KEY:
				return getKey();
			case ArmPackage.TAGGED_VALUE__VALUE:
				return getValue();
		}
