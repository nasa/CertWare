...
public class AssumptionPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * 
	 */
	protected AssumptionPropertiesEditionPart basePart;

	/**
	 * Default constructor
	 * 
	 */
	public AssumptionPropertiesEditionComponent(EObject assumption, String editing_mode) {
		if (assumption instanceof Assumption) {
			this.assumption = (Assumption)assumption;
			if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode)) {
				semanticAdapter = initializeSemanticAdapter();
				this.assumption.eAdapters().add(semanticAdapter);
			}
		}
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(final Notification msg) {
				if (basePart == null)
					AssumptionPropertiesEditionComponent.this.dispose();
				else {
	...
	protected void runUpdateRunnable(final Notification msg) {
		if (ArmPackage.eINSTANCE.getModelElement_Identifier().equals(msg.getFeature()) && basePart != null){
			if (msg.getNewValue() != null) {
				...
				basePart.setIdentifier(Messages.AssumptionPropertiesEditionComponent_0);
			}
		}
		if (ArmPackage.eINSTANCE.getModelElement_Description().equals(msg.getFeature()) && basePart != null){
			if (msg.getNewValue() != null) {
				...
				basePart.setDescription(Messages.AssumptionPropertiesEditionComponent_1);
			}
		}
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return CaeViewsRepository.Assumption.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (assumption != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (AssumptionPropertiesEditionPart)provider.getPropertiesEditionPart(CaeViewsRepository.Assumption.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == CaeViewsRepository.Assumption.class)
			this.basePart = (AssumptionPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (basePart != null && key == CaeViewsRepository.Assumption.class) {
			((IPropertiesEditionPart)basePart).setContext(elt, allResource);
			final Assumption assumption = (Assumption)elt;
			// init values
			if (assumption.getIdentifier() != null)
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((assumption != null) && (basePart != null)) { 
			...
			for (Iterator iter = isTaggedToMoveFromIsTagged.iterator(); iter.hasNext();){
				...
				cc.append(MoveCommand.create(editingDomain, assumption, ArmPackage.eINSTANCE.getTaggedValue(), moveElement.getElement(), moveElement.getIndex()));
			}
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof Assumption) {
			Assumption assumptionToUpdate = (Assumption)source;
			assumptionToUpdate.setIdentifier((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), basePart.getIdentifier()));
	...
	public void firePropertiesChanged(IPropertiesEditionEvent event) {
		if (!isInitializing()) {
			...
			if (CaeViewsRepository.Assumption.identifier == event.getAffectedEditor()) {
				command.append(SetCommand.create(liveEditingDomain, assumption, ArmPackage.eINSTANCE.getModelElement_Identifier(), EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), (String)event.getNewValue())));
			}
			if (CaeViewsRepository.Assumption.description == event.getAffectedEditor()) {
			...
			if (CaeViewsRepository.Assumption.content == event.getAffectedEditor()) {
			...
			if (CaeViewsRepository.Assumption.isTagged == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					TaggedValue oldValue = (TaggedValue)event.getOldValue();
					TaggedValue newValue = (TaggedValue)event.getNewValue();
					// TODO: Complete the assumption update command
					...
					command.append(AddCommand.create(liveEditingDomain, assumption, ArmPackage.eINSTANCE.getModelElement_IsTagged(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, assumption, ArmPackage.eINSTANCE.getTaggedValue(), event.getNewValue(), event.getNewIndex()));
			}

				if (!command.isEmpty() && !command.canExecute()) {
					EEFRuntimePlugin.getDefault().logError(Messages.AssumptionPropertiesEditionComponent_3, null);
				} else {
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			EObject copy = EcoreUtil.copy(assumption);
			copy = getPropertiesEditionObject(copy);
			validate =  EEFRuntimePlugin.getEEFValidator().validate(copy);
		}
		else if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode))
			validate = EEFRuntimePlugin.getEEFValidator().validate(assumption);
	...
	public void dispose() {
		if (semanticAdapter != null)
			assumption.eAdapters().remove(semanticAdapter);
	}
