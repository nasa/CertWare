...
public class JustificationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public JustificationPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject justification, String editing_mode) {
		...
		partKey = CaeViewsRepository.Justification.class;
	}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == CaeViewsRepository.Justification.Properties.identifier) {
			return ArmPackage.eINSTANCE.getModelElement_Identifier();
		}
		if (editorKey == CaeViewsRepository.Justification.Properties.description) {
			return ArmPackage.eINSTANCE.getModelElement_Description();
		}
		if (editorKey == CaeViewsRepository.Justification.Properties.content) {
			return ArmPackage.eINSTANCE.getModelElement_Content();
		}
		if (editorKey == CaeViewsRepository.Justification.Properties.isTagged) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (CaeViewsRepository.Justification.Properties.identifier == event.getAffectedEditor()) {
		...
		if (CaeViewsRepository.Justification.Properties.description == event.getAffectedEditor()) {
		...
		if (CaeViewsRepository.Justification.Properties.content == event.getAffectedEditor()) {
		...
		if (CaeViewsRepository.Justification.Properties.isTagged == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Identifier().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CaeViewsRepository.Justification.Properties.identifier)) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Description().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CaeViewsRepository.Justification.Properties.description)) {
				if (msg.getNewValue() != null) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Content().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(CaeViewsRepository.Justification.Properties.content)) {
				if (msg.getNewValue() != null) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_IsTagged().equals(msg.getFeature()) && isAccessible(CaeViewsRepository.Justification.Properties.isTagged))
