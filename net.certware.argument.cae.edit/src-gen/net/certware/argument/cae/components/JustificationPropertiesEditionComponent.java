...
public class JustificationPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return CaeViewsRepository.Justification.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (justification != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (JustificationPropertiesEditionPart)provider.getPropertiesEditionPart(CaeViewsRepository.Justification.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (basePart != null && key == CaeViewsRepository.Justification.class) {
	...
	public void firePropertiesChanged(IPropertiesEditionEvent event) {
		if (!isInitializing()) {
			...
			if (CaeViewsRepository.Justification.identifier == event.getAffectedEditor()) {
			...
			if (CaeViewsRepository.Justification.description == event.getAffectedEditor()) {
			...
			if (CaeViewsRepository.Justification.content == event.getAffectedEditor()) {
			...
			if (CaeViewsRepository.Justification.isTagged == event.getAffectedEditor()) {
