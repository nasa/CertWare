...
public class AssumptionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, AssumptionPropertiesEditionPart {
	...
	protected void createIdentifierText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, CaeMessages.AssumptionPropertiesEditionPart_IdentifierLabel, propertiesEditionComponent.isRequired(CaeViewsRepository.Assumption.identifier, CaeViewsRepository.FORM_KIND));
		...
		identifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssumptionPropertiesEditionPartForm.this, CaeViewsRepository.Assumption.identifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, identifier.getText()));
			}
		});
		...
		EditingUtils.setID(identifier, CaeViewsRepository.Assumption.identifier);
		EditingUtils.setEEFtype(identifier, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CaeViewsRepository.Assumption.identifier, CaeViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, CaeMessages.AssumptionPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(CaeViewsRepository.Assumption.description, CaeViewsRepository.FORM_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssumptionPropertiesEditionPartForm.this, CaeViewsRepository.Assumption.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		});
		...
		EditingUtils.setID(description, CaeViewsRepository.Assumption.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CaeViewsRepository.Assumption.description, CaeViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createContentTextarea(FormToolkit widgetFactory, Composite parent) {
		Label contentLabel = FormUtils.createPartLabel(widgetFactory, parent, CaeMessages.AssumptionPropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(CaeViewsRepository.Assumption.content, CaeViewsRepository.FORM_KIND));
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssumptionPropertiesEditionPartForm.this, CaeViewsRepository.Assumption.content, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, content.getText()));
			}

		});
		EditingUtils.setID(content, CaeViewsRepository.Assumption.content);
		EditingUtils.setEEFtype(content, "eef::Textarea"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(CaeViewsRepository.Assumption.content, CaeViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsTaggedTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.isTagged = new ReferencesTable<TaggedValue>(CaeMessages.AssumptionPropertiesEditionPart_IsTaggedLabel, new ReferencesTableListener<TaggedValue>() {			
		...
		this.isTagged.setHelpText(propertiesEditionComponent.getHelpContent(CaeViewsRepository.Assumption.isTagged, CaeViewsRepository.FORM_KIND));
		...
		isTagged.setID(CaeViewsRepository.Assumption.isTagged);
	...
	protected void moveIsTagged(TaggedValue element, int oldIndex, int newIndex) {
		...
		isTagged.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssumptionPropertiesEditionPartForm.this, CaeViewsRepository.Assumption.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssumptionPropertiesEditionPartForm.this, CaeViewsRepository.Assumption.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromIsTagged(TaggedValue element) {
		// Start of user code for the removeFromIsTagged() method body
				...
				isTagged.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssumptionPropertiesEditionPartForm.this, CaeViewsRepository.Assumption.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AssumptionPropertiesEditionPartForm.this, CaeViewsRepository.Assumption.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.cae.parts.AssumptionPropertiesEditionPart#getIsTaggedToAdd()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.cae.parts.AssumptionPropertiesEditionPart#getIsTaggedToRemove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.cae.parts.AssumptionPropertiesEditionPart#getIsTaggedToEdit()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.cae.parts.AssumptionPropertiesEditionPart#getIsTaggedToMove()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.cae.parts.AssumptionPropertiesEditionPart#getIsTaggedTable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.argument.cae.parts.AssumptionPropertiesEditionPart#updateIsTagged(EObject newValue)
	 * 
	 */
