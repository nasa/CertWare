 ...
 * 
 */
public class EvidencePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EvidencePropertiesEditionPart {
	 ...
	 */
	public EvidencePropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EvidencePropertiesEditionPartForm.this,
							CaeViewsRepository.Evidence.Properties.identifier,
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EvidencePropertiesEditionPartForm.this,
							CaeViewsRepository.Evidence.Properties.description,
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EvidencePropertiesEditionPartForm.this,
							CaeViewsRepository.Evidence.Properties.content,
	...
	protected Composite createTargetReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.target = new ReferencesTable(getDescription(CaeViewsRepository.Evidence.Properties.target, CaeMessages.EvidencePropertiesEditionPart_TargetLabel), new ReferencesTableListener	() {
	...
	protected Composite createSourceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.source = new ReferencesTable(getDescription(CaeViewsRepository.Evidence.Properties.source, CaeMessages.EvidencePropertiesEditionPart_SourceLabel), new ReferencesTableListener	() {
	...
	protected Composite createEvidenceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.evidence = new ReferencesTable(getDescription(CaeViewsRepository.Evidence.Properties.evidence_, CaeMessages.EvidencePropertiesEditionPart_EvidenceLabel), new ReferencesTableListener	() {
	...
	public void setIdentifier(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Evidence.Properties.identifier);
		if (eefElementEditorReadOnlyState && identifier.isEnabled()) {
			identifier.setEnabled(false);
			identifier.setToolTipText(CaeMessages.Evidence_ReadOnly);
	...
	public void setDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Evidence.Properties.description);
		if (eefElementEditorReadOnlyState && description.isEnabled()) {
			description.setEnabled(false);
			description.setToolTipText(CaeMessages.Evidence_ReadOnly);
	...
	public void setContent(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Evidence.Properties.content);
		if (eefElementEditorReadOnlyState && content.isEnabled()) {
			content.setEnabled(false);
			content.setToolTipText(CaeMessages.Evidence_ReadOnly);
	...
	public void initIsTagged(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Evidence.Properties.isTagged);
		if (eefElementEditorReadOnlyState && isTagged.isEnabled()) {
			isTagged.setEnabled(false);
			isTagged.setToolTipText(CaeMessages.Evidence_ReadOnly);
	...
	public void initTarget(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Evidence.Properties.target);
		if (eefElementEditorReadOnlyState && target.getTable().isEnabled()) {
			target.setEnabled(false);
			target.setToolTipText(CaeMessages.Evidence_ReadOnly);
	...
	public void initSource(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Evidence.Properties.source);
		if (eefElementEditorReadOnlyState && source.getTable().isEnabled()) {
			source.setEnabled(false);
			source.setToolTipText(CaeMessages.Evidence_ReadOnly);
	...
	public void initContext(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Evidence.Properties.context);
		if (eefElementEditorReadOnlyState && context.isEnabled()) {
			context.setEnabled(false);
			context.setToolTipText(CaeMessages.Evidence_ReadOnly);
	...
	public void initEvidence(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Evidence.Properties.evidence_);
		if (eefElementEditorReadOnlyState && evidence.getTable().isEnabled()) {
			evidence.setEnabled(false);
			evidence.setToolTipText(CaeMessages.Evidence_ReadOnly);
