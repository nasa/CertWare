...
public class AssumptionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, AssumptionPropertiesEditionPart {
	...
	public void setIdentifier(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Assumption.Properties.identifier);
		if (eefElementEditorReadOnlyState && identifier.isEnabled()) {
			identifier.setEnabled(false);
			identifier.setToolTipText(CaeMessages.Assumption_ReadOnly);
	...
	public void setDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Assumption.Properties.description);
		if (eefElementEditorReadOnlyState && description.isEnabled()) {
			description.setEnabled(false);
			description.setToolTipText(CaeMessages.Assumption_ReadOnly);
	...
	public void setContent(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Assumption.Properties.content);
		if (eefElementEditorReadOnlyState && content.isEnabled()) {
			content.setEnabled(false);
			content.setToolTipText(CaeMessages.Assumption_ReadOnly);
	...
	public void initIsTagged(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(CaeViewsRepository.Assumption.Properties.isTagged);
		if (eefElementEditorReadOnlyState && isTagged.isEnabled()) {
			isTagged.setEnabled(false);
			isTagged.setToolTipText(CaeMessages.Assumption_ReadOnly);
