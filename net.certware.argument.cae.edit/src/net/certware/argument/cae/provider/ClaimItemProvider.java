...
/**
 * This is the item provider adapter for a {@link net.certware.argument.cae.Claim} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClaimItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CaePackage.Literals.CLAIM__STRATEGY);
			childrenFeatures.add(CaePackage.Literals.CLAIM__ASSUMPTION);
			childrenFeatures.add(CaePackage.Literals.CLAIM__CONTEXT);
			childrenFeatures.add(CaePackage.Literals.CLAIM__SOLUTION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CaePackage.Literals.CLAIM__STRATEGY,
				 CaeFactory.eINSTANCE.createArgument()));

		newChildDescriptors.add
			(createChildParameter
				(CaePackage.Literals.CLAIM__ASSUMPTION,
				 CaeFactory.eINSTANCE.createAssumption()));

		newChildDescriptors.add
			(createChildParameter
				(CaePackage.Literals.CLAIM__CONTEXT,
				 CaeFactory.eINSTANCE.createContext()));

		newChildDescriptors.add
			(createChildParameter
				(CaePackage.Literals.CLAIM__SOLUTION,
