...
/**
 * The class <code>AssumptionImplTest</code> contains tests for the class <code>{@link AssumptionImpl}</code>.
 * <p>
 ...
 * @author mrb
 */
public class AssumptionImplTest {
	/**
	 * Run the AssumptionImpl() constructor test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 10/13/10 4:48 PM
	 */
	@Test
	public void testAssumptionImpl_1()
		throws Exception {

		AssumptionImpl result = new AssumptionImpl();
	...
	public void testEStaticClass_1()
		throws Exception {
		AssumptionImpl fixture = new AssumptionImpl();
		...
		assertEquals("net.certware.argument.cae.Assumption", result.getInstanceClassName());
		assertEquals(3, result.getClassifierID());
		assertEquals("net.certware.argument.cae.Assumption", result.getInstanceTypeName());
		assertEquals("Assumption", result.getName());
		assertEquals(false, result.eIsProxy());
		assertEquals(true, result.eDeliver());
	}
