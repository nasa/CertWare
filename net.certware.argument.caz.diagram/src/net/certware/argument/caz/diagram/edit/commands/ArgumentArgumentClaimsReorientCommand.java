 ...
 * @generated
 */
public class ArgumentArgumentClaimsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentClaimsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Claim && newEnd instanceof Argument)) {
			return false;
		}
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistArgumentArgumentClaims_4008(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistArgumentArgumentClaims_4008(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getArgumentClaims().remove(getOldTarget());
		getNewSource().getArgumentClaims().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getArgumentClaims().remove(getOldTarget());
		getOldSource().getArgumentClaims().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
