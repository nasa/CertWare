 ...
 * @generated
 */
public class ArgumentArgumentEvidenceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentEvidenceCreateCommand(
	...
	public boolean canExecute() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateArgumentArgumentEvidence_4007(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getArgumentEvidence().add(getTarget());
		}
