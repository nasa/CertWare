 ...
 * @generated
 */
public class ArgumentArgumentJustificationCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentJustificationCreateCommand(
	...
	public boolean canExecute() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateArgumentArgumentJustification_4006(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getArgumentJustification().add(getTarget());
		}
