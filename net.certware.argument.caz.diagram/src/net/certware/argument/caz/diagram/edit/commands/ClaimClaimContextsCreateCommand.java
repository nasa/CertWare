 ...
 * @generated
 */
public class ClaimClaimContextsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ClaimClaimContextsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateClaimClaimContexts_4003(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getClaimContexts().add(getTarget());
		}
