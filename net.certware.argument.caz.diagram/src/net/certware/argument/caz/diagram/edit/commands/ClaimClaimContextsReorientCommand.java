 ...
 * @generated
 */
public class ClaimClaimContextsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ClaimClaimContextsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Context && newEnd instanceof Claim)) {
			return false;
		}
		return CazBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistClaimClaimContexts_4003(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CazBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canExistClaimClaimContexts_4003(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getClaimContexts().remove(getOldTarget());
		getNewSource().getClaimContexts().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getClaimContexts().remove(getOldTarget());
		getOldSource().getClaimContexts().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
