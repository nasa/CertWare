 ...
 * @generated
 */
public class ClaimClaimSolutionsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ClaimClaimSolutionsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Evidence && newEnd instanceof Claim)) {
			return false;
		}
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistClaimClaimSolutions_4004(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistClaimClaimSolutions_4004(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getClaimSolutions().remove(getOldTarget());
		getNewSource().getClaimSolutions().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getClaimSolutions().remove(getOldTarget());
		getOldSource().getClaimSolutions().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
