 ...
 * @generated
 */
public class ClaimClaimStrategiesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ClaimClaimStrategiesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateClaimClaimStrategies_4001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getClaimStrategies().add(getTarget());
		}
