 ...
 * @generated
 */
public class ClaimClaimStrategiesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ClaimClaimStrategiesReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Argument && newEnd instanceof Claim)) {
			return false;
		}
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistClaimClaimStrategies_4001(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistClaimClaimStrategies_4001(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getClaimStrategies().remove(getOldTarget());
		getNewSource().getClaimStrategies().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getClaimStrategies().remove(getOldTarget());
		getOldSource().getClaimStrategies().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
