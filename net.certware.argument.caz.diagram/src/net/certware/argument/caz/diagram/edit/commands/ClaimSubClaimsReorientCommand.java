 ...
 * @generated
 */
public class ClaimSubClaimsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ClaimSubClaimsReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistClaimSubClaims_4005(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistClaimSubClaims_4005(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSubClaims().remove(getOldTarget());
		getNewSource().getSubClaims().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSubClaims().remove(getOldTarget());
		getOldSource().getSubClaims().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
