 ...
 * @generated
 */
public class EvidenceEvidenceContextsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EvidenceEvidenceContextsCreateCommand(
	...
	public boolean canExecute() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateEvidenceEvidenceContexts_4009(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getEvidenceContexts().add(getTarget());
		}
