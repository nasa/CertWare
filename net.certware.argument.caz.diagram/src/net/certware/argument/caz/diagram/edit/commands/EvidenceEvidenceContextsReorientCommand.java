 ...
 * @generated
 */
public class EvidenceEvidenceContextsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EvidenceEvidenceContextsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Context && newEnd instanceof Evidence)) {
			return false;
		}
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEvidenceEvidenceContexts_4009(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CazBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEvidenceEvidenceContexts_4009(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getEvidenceContexts().remove(getOldTarget());
		getNewSource().getEvidenceContexts().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getEvidenceContexts().remove(getOldTarget());
		getOldSource().getEvidenceContexts().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
