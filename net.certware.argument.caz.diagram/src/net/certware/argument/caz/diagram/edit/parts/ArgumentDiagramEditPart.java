...
import net.certware.argument.caz.diagram.edit.policies.ArgumentDiagramCanonicalEditPolicy;
import net.certware.argument.caz.diagram.edit.policies.ArgumentDiagramItemSemanticEditPolicy;
...
public class ArgumentDiagramEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Caz"; //$NON-NLS-1$
