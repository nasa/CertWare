...
public class AssumptionContentEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AssumptionContentEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CazParserProvider
					.getParser(
							...
							getParserElement(),
							CazVisualIDRegistry
									.getType(net.certware.argument.caz.diagram.edit.parts.AssumptionContentEditPart.VISUAL_ID));
		}
		return parser;
	}
