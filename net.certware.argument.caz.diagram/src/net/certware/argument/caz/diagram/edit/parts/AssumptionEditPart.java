...
import net.certware.argument.caz.diagram.edit.policies.AssumptionItemSemanticEditPolicy;
...
public class AssumptionEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == CazElementTypes.ClaimClaimAssumptions_4002) {
	 ...
	 * @generated
	 */
	public class AssumptionFigure extends Ellipse {
