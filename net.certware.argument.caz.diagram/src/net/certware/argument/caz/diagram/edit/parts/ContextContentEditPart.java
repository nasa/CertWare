 ...
 * @generated
 */
public class ContextContentEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ContextContentEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CazParserProvider
					.getParser(
							...
							getParserElement(),
							CazVisualIDRegistry
									.getType(net.certware.argument.caz.diagram.edit.parts.ContextContentEditPart.VISUAL_ID));
		}
		return parser;
	}
