...
import net.certware.argument.caz.diagram.edit.policies.ContextItemSemanticEditPolicy;
...
public class ContextEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ContextIdentifierEditPart) {
			((ContextIdentifierEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureContextLabelFigure());
			return true;
		}
		if (childEditPart instanceof ContextContentEditPart) {
			((ContextContentEditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnTarget() {
		...
		types.add(CazElementTypes.EvidenceEvidenceContexts_4009);
		types.add(CazElementTypes.EvidenceEvidence_4010);
		return types;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == CazElementTypes.ClaimClaimContexts_4003) {
			types.add(CazElementTypes.Claim_2001);
		} else if (relationshipType == CazElementTypes.EvidenceEvidenceContexts_4009) {
			types.add(CazElementTypes.Evidence_2002);
		} else if (relationshipType == CazElementTypes.EvidenceEvidence_4010) {
			types.add(CazElementTypes.Evidence_2002);
		}
		return types;
	}
	 ...
	 * @generated
	 */
	public class ContextFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureContextLabelFigure;
		/**
		 * @generated
		 */
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureContextLabelFigure() {
			return fFigureContextLabelFigure;
		}
