...
import net.certware.argument.caz.diagram.edit.policies.EvidenceItemSemanticEditPolicy;
...
public class EvidenceEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == CazElementTypes.EvidenceEvidenceContexts_4009) {
	...
	public List<IElementType> getMARelTypesOnTarget() {
		...
		types.add(CazElementTypes.ArgumentArgumentEvidence_4007);
		return types;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == CazElementTypes.ClaimClaimSolutions_4004) {
			types.add(CazElementTypes.Claim_2001);
		} else if (relationshipType == CazElementTypes.ArgumentArgumentEvidence_4007) {
	 ...
	 * @generated
	 */
	public class EvidenceFigure extends RectangleFigure {
