...
public class JustificationContentEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public JustificationContentEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = CazParserProvider
					.getParser(
							...
							getParserElement(),
							CazVisualIDRegistry
									.getType(net.certware.argument.caz.diagram.edit.parts.JustificationContentEditPart.VISUAL_ID));
		}
		return parser;
	}
