...
import net.certware.argument.caz.diagram.edit.policies.JustificationItemSemanticEditPolicy;
...
public class JustificationEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnTarget() {
		...
		types.add(CazElementTypes.ArgumentArgumentJustification_4006);
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == CazElementTypes.ArgumentArgumentJustification_4006) {
	 ...
	 * @generated
	 */
	public class JustificationFigure extends RoundedRectangle {
