...
public class WrappingLabel10EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				CazVisualIDRegistry
						.getType(net.certware.argument.caz.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CazParserProvider.getParser(
					CazElementTypes.EvidenceEvidence_4010, getParserElement(),
