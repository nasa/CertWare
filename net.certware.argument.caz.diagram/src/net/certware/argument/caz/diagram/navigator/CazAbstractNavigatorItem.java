...
public abstract class CazAbstractNavigatorItem extends PlatformObject {
	...
	static {
		...
		final ITabbedPropertySheetPageContributor propertySheetPageContributor = new ITabbedPropertySheetPageContributor() {
			public String getContributorId() {
				return "net.certware.argument.caz.diagram"; //$NON-NLS-1$
			}
		};
		Platform.getAdapterManager().registerAdapters(
				...
				net.certware.argument.caz.diagram.navigator.CazAbstractNavigatorItem.class);
	}
	 ...
	 * @generated
	 */
	protected CazAbstractNavigatorItem(Object parent) {
		myParent = parent;
	}
