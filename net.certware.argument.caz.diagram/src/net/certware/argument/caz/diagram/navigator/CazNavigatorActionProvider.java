...
import net.certware.argument.caz.diagram.part.CazDiagramEditor;
 ...
 * @generated
 */
public class CazNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof CazNavigatorItem) {
					selectedElement = ((CazNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (ArgumentDiagramEditPart.MODEL_ID
							.equals(CazVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, CazDiagramEditor.ID);
