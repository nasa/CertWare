...
import net.certware.argument.caz.diagram.part.CazDiagramEditorUtil;
 ...
 * @generated
 */
public class CazMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = CazDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			CazDiagramEditorUtil.selectElementsInDiagram(editor,
