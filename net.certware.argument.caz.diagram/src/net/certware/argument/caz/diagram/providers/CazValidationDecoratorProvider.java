 ...
 * @generated
 */
public class CazValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = CazDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof CazDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ArgumentDiagramEditPart.MODEL_ID.equals(CazVisualIDRegistry
						.getModelID(view));
	}
