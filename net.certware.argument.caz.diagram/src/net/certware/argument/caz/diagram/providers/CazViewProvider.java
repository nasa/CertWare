 ...
 * @generated
 */
public class CazViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ArgumentDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& CazVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = CazVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = CazVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!CazElementTypes.isKnownElementType(elementType)
				...
				if (!ArgumentDiagramEditPart.MODEL_ID
						.equals(CazVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return ClaimEditPart.VISUAL_ID == visualID
				|| EvidenceEditPart.VISUAL_ID == visualID
				|| ArgumentEditPart.VISUAL_ID == visualID
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = CazVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != CazVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = CazVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = CazVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ClaimEditPart.VISUAL_ID:
			return createClaim_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case EvidenceEditPart.VISUAL_ID:
			return createEvidence_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case ArgumentEditPart.VISUAL_ID:
			return createArgument_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case AssumptionEditPart.VISUAL_ID:
			return createAssumption_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case JustificationEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (CazVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ClaimClaimStrategiesEditPart.VISUAL_ID:
			return createClaimClaimStrategies_4001(containerView, index,
					persisted, preferencesHint);
		case ClaimClaimAssumptionsEditPart.VISUAL_ID:
			return createClaimClaimAssumptions_4002(containerView, index,
					persisted, preferencesHint);
		case ClaimClaimContextsEditPart.VISUAL_ID:
			return createClaimClaimContexts_4003(containerView, index,
					persisted, preferencesHint);
		case ClaimClaimSolutionsEditPart.VISUAL_ID:
			return createClaimClaimSolutions_4004(containerView, index,
					persisted, preferencesHint);
		case ClaimSubClaimsEditPart.VISUAL_ID:
			return createClaimSubClaims_4005(containerView, index, persisted,
					preferencesHint);
		case ArgumentArgumentJustificationEditPart.VISUAL_ID:
			return createArgumentArgumentJustification_4006(containerView,
					index, persisted, preferencesHint);
		case ArgumentArgumentEvidenceEditPart.VISUAL_ID:
			return createArgumentArgumentEvidence_4007(containerView, index,
					persisted, preferencesHint);
		case ArgumentArgumentClaimsEditPart.VISUAL_ID:
			return createArgumentArgumentClaims_4008(containerView, index,
					persisted, preferencesHint);
		case EvidenceEvidenceContextsEditPart.VISUAL_ID:
			return createEvidenceEvidenceContexts_4009(containerView, index,
					persisted, preferencesHint);
		case EvidenceEvidenceEditPart.VISUAL_ID:
			return createEvidenceEvidence_4010(containerView, index, persisted,
					preferencesHint);
		}
	...
	public Node createClaim_2001(EObject domainElement, View containerView,
		...
		node.setType(CazVisualIDRegistry.getType(ClaimEditPart.VISUAL_ID));
		...
		Node label5002 = createLabel(node,
				CazVisualIDRegistry.getType(ClaimContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createEvidence_2002(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CazVisualIDRegistry.getType(EvidenceEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5004 = createLabel(node,
				CazVisualIDRegistry.getType(EvidenceContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createArgument_2003(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CazVisualIDRegistry.getType(ArgumentEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5006 = createLabel(node,
				CazVisualIDRegistry.getType(ArgumentContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createAssumption_2004(EObject domainElement,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CazVisualIDRegistry.getType(AssumptionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	...
	public Node createJustification_2005(EObject domainElement,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CazVisualIDRegistry
	...
	public Node createContext_2006(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(CazVisualIDRegistry.getType(ContextEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5012 = createLabel(node,
				CazVisualIDRegistry.getType(ContextContentEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createClaimClaimStrategies_4001(View containerView, int index,
		...
		edge.setType(CazVisualIDRegistry
		...
		Node label6001 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createClaimClaimAssumptions_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6002 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createClaimClaimContexts_4003(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6003 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabel3EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createClaimClaimSolutions_4004(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6004 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabel4EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createClaimSubClaims_4005(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6005 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabel5EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createArgumentArgumentJustification_4006(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6006 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabel6EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createArgumentArgumentEvidence_4007(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6007 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabel7EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createArgumentArgumentClaims_4008(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6008 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabel8EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createEvidenceEvidenceContexts_4009(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6009 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabel9EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createEvidenceEvidence_4010(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6010 = createLabel(edge,
				CazVisualIDRegistry.getType(WrappingLabel10EditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ArgumentDiagramEditPart.MODEL_ID.equals(CazVisualIDRegistry
