 ...
 * <!-- end-user-doc -->
 * @see net.certware.argument.caz.CazPackage
 * @generated
 */
public class CazAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static CazPackage modelPackage;
	 ...
	 * @generated
	 */
	public CazAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = CazPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected CazSwitch<Adapter> modelSwitch =
		new CazSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link net.certware.argument.caz.Claim <em>Claim</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
