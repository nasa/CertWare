...
public class JustificationPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public JustificationPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject justification, String editing_mode) {
		...
		partKey = EurViewsRepository.Justification.class;
	}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EurViewsRepository.Justification.Properties.identifier) {
			return ArmPackage.eINSTANCE.getModelElement_Identifier();
		}
		if (editorKey == EurViewsRepository.Justification.Properties.description) {
			return ArmPackage.eINSTANCE.getModelElement_Description();
		}
		if (editorKey == EurViewsRepository.Justification.Properties.content) {
			return ArmPackage.eINSTANCE.getModelElement_Content();
		}
		if (editorKey == EurViewsRepository.Justification.Properties.isTagged) {
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (ArmPackage.eINSTANCE.getModelElement_IsTagged().equals(msg.getFeature()) && isAccessible(EurViewsRepository.Justification.Properties.isTagged))
