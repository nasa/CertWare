...
public class SolutionPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * 
	 */
	protected SolutionPropertiesEditionPart basePart;

	/**
	 * Default constructor
	 * 
	 */
	public SolutionPropertiesEditionComponent(EObject solution, String editing_mode) {
		if (solution instanceof Solution) {
			this.solution = (Solution)solution;
			if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode)) {
				semanticAdapter = initializeSemanticAdapter();
				this.solution.eAdapters().add(semanticAdapter);
			}
		}
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(final Notification msg) {
				if (basePart == null)
					SolutionPropertiesEditionComponent.this.dispose();
				else {
	...
	protected void runUpdateRunnable(final Notification msg) {
		...
		if (msg.getFeature() != null && ((EStructuralFeature)msg.getFeature() == ArmPackage.eINSTANCE.getModelElement_IsTagged())) {
			basePart.updateIsTagged(solution);
		}
		...
		if (EurPackage.eINSTANCE.getSolution_Context().equals(msg.getFeature()))
			basePart.updateContext(solution);
		if (EurPackage.eINSTANCE.getSolution_Evidence().equals(msg.getFeature()) && basePart != null)
			basePart.setEvidence((EObject)msg.getNewValue());
		if (EurPackage.eINSTANCE.getSolution_Criteria().equals(msg.getFeature()))
			basePart.updateCriteria(solution);
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return EurViewsRepository.Solution.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (solution != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (SolutionPropertiesEditionPart)provider.getPropertiesEditionPart(EurViewsRepository.Solution.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == EurViewsRepository.Solution.class)
			this.basePart = (SolutionPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (basePart != null && key == EurViewsRepository.Solution.class) {
			((IPropertiesEditionPart)basePart).setContext(elt, allResource);
			final Solution solution = (Solution)elt;
			// init values
			if (solution.getIdentifier() != null)
			...
			basePart.initContext(solution, null, EurPackage.eINSTANCE.getSolution_Context());
			// init part
			basePart.initEvidence(allResource, solution.getEvidence());
			// set the button mode
			basePart.setEvidenceButtonMode(ButtonsModeEnum.BROWSE);
			basePart.initCriteria(solution, null, EurPackage.eINSTANCE.getSolution_Criteria());
			// init filters
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if ((solution != null) && (basePart != null)) { 
			...
			for (Iterator iter = isTaggedToMoveFromIsTagged.iterator(); iter.hasNext();){
				...
				cc.append(MoveCommand.create(editingDomain, solution, ArmPackage.eINSTANCE.getTaggedValue(), moveElement.getElement(), moveElement.getIndex()));
			}
			List targetToAddFromTarget = basePart.getTargetToAdd();
			for (Iterator iter = targetToAddFromTarget.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, solution, ArmPackage.eINSTANCE.getArgumentLink_Target(), iter.next()));
			List targetToRemoveFromTarget = basePart.getTargetToRemove();
			for (Iterator iter = targetToRemoveFromTarget.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, solution, ArmPackage.eINSTANCE.getArgumentLink_Target(), iter.next()));
			...
			for (Iterator iter = sourceToAddFromSource.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, solution, ArmPackage.eINSTANCE.getArgumentLink_Source(), iter.next()));
			List sourceToRemoveFromSource = basePart.getSourceToRemove();
			for (Iterator iter = sourceToRemoveFromSource.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, solution, ArmPackage.eINSTANCE.getArgumentLink_Source(), iter.next()));
			...
			for (Iterator iter = contextToAddFromContext.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, solution, EurPackage.eINSTANCE.getSolution_Context(), iter.next()));
			...
			for (Iterator iter = contextToRemoveFromContext.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, solution, EurPackage.eINSTANCE.getSolution_Context(), iter.next()));
			//List contextToMoveFromContext = basePart.getContextToMove();
			//for (Iterator iter = contextToMoveFromContext.iterator(); iter.hasNext();){
			//	org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			//	cc.append(MoveCommand.create(editingDomain, solution, EurPackage.eINSTANCE.getContext(), moveElement.getElement(), moveElement.getIndex()));
			//}
			if (solution.eGet(EurPackage.eINSTANCE.getSolution_Evidence()) == null || !solution.eGet(EurPackage.eINSTANCE.getSolution_Evidence()).equals(basePart.getEvidence())) {
				cc.append(SetCommand.create(editingDomain, solution, EurPackage.eINSTANCE.getSolution_Evidence(), basePart.getEvidence()));
			}
			...
			for (Iterator iter = criteriaToAddFromCriteria.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, solution, EurPackage.eINSTANCE.getSolution_Criteria(), iter.next()));
			...
			for (Iterator iter = criteriaToRemoveFromCriteria.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, solution, EurPackage.eINSTANCE.getSolution_Criteria(), iter.next()));
			...
			//	org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			//	cc.append(MoveCommand.create(editingDomain, solution, EurPackage.eINSTANCE.getCriteria(), moveElement.getElement(), moveElement.getIndex()));
			//}
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof Solution) {
			Solution solutionToUpdate = (Solution)source;
			solutionToUpdate.setIdentifier((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), basePart.getIdentifier()));
			...
			solutionToUpdate.setEvidence((InformationElement)basePart.getEvidence());
			solutionToUpdate.getCriteria().addAll(basePart.getCriteriaToAdd());
	...
	public void firePropertiesChanged(IPropertiesEditionEvent event) {
		if (!isInitializing()) {
			...
			if (EurViewsRepository.Solution.identifier == event.getAffectedEditor()) {
				command.append(SetCommand.create(liveEditingDomain, solution, ArmPackage.eINSTANCE.getModelElement_Identifier(), EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), (String)event.getNewValue())));
			}
			if (EurViewsRepository.Solution.description == event.getAffectedEditor()) {
			...
			if (EurViewsRepository.Solution.isTagged == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, solution, ArmPackage.eINSTANCE.getModelElement_IsTagged(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, solution, ArmPackage.eINSTANCE.getTaggedValue(), event.getNewValue(), event.getNewIndex()));
			}
			if (EurViewsRepository.Solution.target == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, solution, ArmPackage.eINSTANCE.getArgumentLink_Target(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, solution, ArmPackage.eINSTANCE.getArgumentLink_Target(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, solution, ArmPackage.eINSTANCE.getArgumentLink_Target(), event.getNewValue(), event.getNewIndex()));
			}
			if (EurViewsRepository.Solution.source == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, solution, ArmPackage.eINSTANCE.getArgumentLink_Source(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, solution, ArmPackage.eINSTANCE.getArgumentLink_Source(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
			...
			if (EurViewsRepository.Solution.context == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, solution, EurPackage.eINSTANCE.getSolution_Context(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, solution, EurPackage.eINSTANCE.getSolution_Context(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, solution, EurPackage.eINSTANCE.getSolution_Context(), event.getNewValue(), event.getNewIndex()));
			}
			if (EurViewsRepository.Solution.evidence == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, solution, EurPackage.eINSTANCE.getSolution_Evidence(), event.getNewValue()));
			if (EurViewsRepository.Solution.criteria == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, solution, EurPackage.eINSTANCE.getSolution_Criteria(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, solution, EurPackage.eINSTANCE.getSolution_Criteria(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, solution, EurPackage.eINSTANCE.getSolution_Criteria(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public boolean isRequired(String key, int kind) {
		return key == EurViewsRepository.Solution.evidence;
	}
	...
	public Diagnostic validate() {
		...
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			EObject copy = EcoreUtil.copy(solution);
			copy = getPropertiesEditionObject(copy);
			validate =  EEFRuntimePlugin.getEEFValidator().validate(copy);
		}
		else if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode))
			validate = EEFRuntimePlugin.getEEFValidator().validate(solution);
	...
	public void dispose() {
		if (semanticAdapter != null)
			solution.eAdapters().remove(semanticAdapter);
	}
