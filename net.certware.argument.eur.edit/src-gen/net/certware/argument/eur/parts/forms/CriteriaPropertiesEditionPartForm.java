...
public class CriteriaPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, CriteriaPropertiesEditionPart {
	...
	protected void createIdentifierText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EurMessages.CriteriaPropertiesEditionPart_IdentifierLabel, propertiesEditionComponent.isRequired(EurViewsRepository.Criteria.identifier, EurViewsRepository.FORM_KIND));
		...
		identifier.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.identifier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, identifier.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EurViewsRepository.Criteria.identifier, EurViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EurMessages.CriteriaPropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(EurViewsRepository.Criteria.description, EurViewsRepository.FORM_KIND));
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EurViewsRepository.Criteria.description, EurViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	
	protected void createContentText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, EurMessages.CriteriaPropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(EurViewsRepository.Criteria.content, EurViewsRepository.FORM_KIND));
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.content, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, content.getText()));
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EurViewsRepository.Criteria.content, EurViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsTaggedTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.isTagged.setHelpText(propertiesEditionComponent.getHelpContent(EurViewsRepository.Criteria.isTagged, EurViewsRepository.FORM_KIND));
	...
	protected void moveIsTagged(TaggedValue element, int oldIndex, int newIndex) {
		...
		isTagged.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromIsTagged(TaggedValue element) {
		// Start of user code for the removeFromIsTagged() method body
				...
				isTagged.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editIsTagged() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						isTagged.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.isTagged, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	...
	protected void createContextReferencesTable(FormToolkit widgetFactory, Composite parent) {
				...
				"Context", EurPackage.eINSTANCE.getContext(), current.eResource()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.context,
		...
		this.context.setHelpText(propertiesEditionComponent.getHelpContent(EurViewsRepository.Criteria.context, EurViewsRepository.FORM_KIND));
	...
	protected void moveContext(Context element, int oldIndex, int newIndex) {
		...
		context.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.context, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void removeFromContext(Context element) {
		// Start of user code for the removeFromContext() method body
				...
				context.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.context, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editContext() method body		
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						context.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.context, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
	...
	protected void createAssumptionReferencesTable(FormToolkit widgetFactory, Composite parent) {
				...
				"Assumption", EurPackage.eINSTANCE.getAssumption(), current.eResource()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.assumption,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						assumption.refresh();
					}
		...
		this.assumption.setHelpText(propertiesEditionComponent.getHelpContent(EurViewsRepository.Criteria.assumption, EurViewsRepository.FORM_KIND));
	...
	protected void moveAssumption(Assumption element, int oldIndex, int newIndex) {
		...
		assumption.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.assumption, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void removeFromAssumption(Assumption element) {
		// Start of user code for the removeFromAssumption() method body
				...
				assumption.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.assumption, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		...
		// Start of user code editAssumption() method body		
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						assumption.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartForm.this, EurViewsRepository.Criteria.assumption, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
