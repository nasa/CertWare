...
public class CriteriaPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CriteriaPropertiesEditionPart {
	...
	protected void createContentText(Composite parent) {
		SWTUtils.createPartLabel(parent, EurMessages.CriteriaPropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(EurViewsRepository.Criteria.content, EurViewsRepository.SWT_KIND));
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CriteriaPropertiesEditionPartImpl.this, EurViewsRepository.Criteria.content, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, content.getText()));
			}
