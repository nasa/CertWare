...
public class ContextPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Context) && (EurPackage.eINSTANCE.getContext() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof Context) && (ContextPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof Context) && (refinement == ContextPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof Context) && ((ContextPropertiesEditionComponent.BASE_PART.equals(part) && refinement == ContextPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof Context) {
			return new ContextPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
