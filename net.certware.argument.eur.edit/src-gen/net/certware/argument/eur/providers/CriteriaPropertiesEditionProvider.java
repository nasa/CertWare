...
public class CriteriaPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Criteria) && (EurPackage.eINSTANCE.getCriteria() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof Criteria) && (CriteriaPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof Criteria) && (refinement == CriteriaPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof Criteria) && ((CriteriaPropertiesEditionComponent.BASE_PART.equals(part) && refinement == CriteriaPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof Criteria) {
			return new CriteriaPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
