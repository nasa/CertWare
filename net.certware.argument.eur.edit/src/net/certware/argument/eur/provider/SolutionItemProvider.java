...
/**
 * This is the item provider adapter for a {@link net.certware.argument.eur.Solution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolutionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Solution_evidence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Solution_evidence_feature", "_UI_Solution_type"),
				 EurPackage.Literals.SOLUTION__EVIDENCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EurPackage.Literals.SOLUTION__CONTEXT);
			childrenFeatures.add(EurPackage.Literals.SOLUTION__CRITERIA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EurPackage.Literals.SOLUTION__CONTEXT,
				 EurFactory.eINSTANCE.createContext()));

		newChildDescriptors.add
			(createChildParameter
				(EurPackage.Literals.SOLUTION__CRITERIA,
