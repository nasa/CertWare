 ...
 * @generated
 */
public class ArgumentArgumentAssumptionsCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentAssumptionsCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateArgumentArgumentAssumptions_4002(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getArgumentAssumptions().add(getTarget());
		}
