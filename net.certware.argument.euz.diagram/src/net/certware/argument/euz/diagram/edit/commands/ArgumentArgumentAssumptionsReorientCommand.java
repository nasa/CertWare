 ...
 * @generated
 */
public class ArgumentArgumentAssumptionsReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentAssumptionsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Assumption && newEnd instanceof Argument)) {
			return false;
		}
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistArgumentArgumentAssumptions_4002(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistArgumentArgumentAssumptions_4002(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getArgumentAssumptions().remove(getOldTarget());
		getNewSource().getArgumentAssumptions().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getArgumentAssumptions().remove(getOldTarget());
		getOldSource().getArgumentAssumptions().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
