 ...
 * @generated
 */
public class ArgumentArgumentContextsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentContextsCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateArgumentArgumentContexts_4003(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getArgumentContexts().add(getTarget());
		}
