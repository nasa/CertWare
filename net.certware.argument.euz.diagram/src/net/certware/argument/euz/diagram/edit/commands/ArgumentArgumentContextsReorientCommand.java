 ...
 * @generated
 */
public class ArgumentArgumentContextsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentContextsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Context && newEnd instanceof Argument)) {
			return false;
		}
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistArgumentArgumentContexts_4003(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistArgumentArgumentContexts_4003(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getArgumentContexts().remove(getOldTarget());
		getNewSource().getArgumentContexts().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getArgumentContexts().remove(getOldTarget());
		getOldSource().getArgumentContexts().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
