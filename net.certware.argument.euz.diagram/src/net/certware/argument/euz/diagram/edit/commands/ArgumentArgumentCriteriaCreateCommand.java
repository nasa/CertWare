 ...
 * @generated
 */
public class ArgumentArgumentCriteriaCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentCriteriaCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateArgumentArgumentCriteria_4005(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getArgumentCriteria().add(getTarget());
		}
