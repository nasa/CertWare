 ...
 * @generated
 */
public class ArgumentArgumentJustificationsCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentJustificationsCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateArgumentArgumentJustifications_4006(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getArgumentJustifications().add(getTarget());
		}
