 ...
 * @generated
 */
public class ArgumentArgumentJustificationsReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentJustificationsReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistArgumentArgumentJustifications_4006(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistArgumentArgumentJustifications_4006(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getArgumentJustifications().remove(getOldTarget());
		getNewSource().getArgumentJustifications().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getArgumentJustifications().remove(getOldTarget());
		getOldSource().getArgumentJustifications().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
