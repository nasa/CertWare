 ...
 * @generated
 */
public class ArgumentArgumentSolutionsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentSolutionsCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateArgumentArgumentSolutions_4004(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getArgumentSolutions().add(getTarget());
		}
