 ...
 * @generated
 */
public class ArgumentArgumentStrategiesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentArgumentStrategiesCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateArgumentArgumentStrategies_4001(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getArgumentStrategies().add(getTarget());
		}
