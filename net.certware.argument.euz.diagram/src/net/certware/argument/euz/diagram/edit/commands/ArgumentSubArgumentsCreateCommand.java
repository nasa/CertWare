 ...
 * @generated
 */
public class ArgumentSubArgumentsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ArgumentSubArgumentsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateArgumentSubArguments_4017(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSubArguments().add(getTarget());
		}
