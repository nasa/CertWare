 ...
 * @generated
 */
public class ContextContextAssumptionsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ContextContextAssumptionsCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateContextContextAssumptions_4007(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getContextAssumptions().add(getTarget());
		}
