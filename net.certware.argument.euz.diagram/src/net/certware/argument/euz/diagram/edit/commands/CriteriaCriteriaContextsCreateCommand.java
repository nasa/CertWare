 ...
 * @generated
 */
public class CriteriaCriteriaContextsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CriteriaCriteriaContextsCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateCriteriaCriteriaContexts_4008(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getCriteriaContexts().add(getTarget());
		}
