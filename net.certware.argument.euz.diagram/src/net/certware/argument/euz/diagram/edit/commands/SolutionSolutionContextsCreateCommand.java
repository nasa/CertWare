 ...
 * @generated
 */
public class SolutionSolutionContextsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SolutionSolutionContextsCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateSolutionSolutionContexts_4014(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSolutionContexts().add(getTarget());
		}
