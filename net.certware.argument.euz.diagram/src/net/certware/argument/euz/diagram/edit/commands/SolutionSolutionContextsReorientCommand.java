 ...
 * @generated
 */
public class SolutionSolutionContextsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SolutionSolutionContextsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Context && newEnd instanceof Solution)) {
			return false;
		}
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSolutionSolutionContexts_4014(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistSolutionSolutionContexts_4014(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSolutionContexts().remove(getOldTarget());
		getNewSource().getSolutionContexts().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSolutionContexts().remove(getOldTarget());
		getOldSource().getSolutionContexts().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
