 ...
 * @generated
 */
public class StrategyStrategyArgumentsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StrategyStrategyArgumentsCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateStrategyStrategyArguments_4010(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getStrategyArguments().add(getTarget());
		}
