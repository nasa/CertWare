 ...
 * @generated
 */
public class StrategyStrategyStrategiesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StrategyStrategyStrategiesCreateCommand(
	...
	public boolean canExecute() {
		...
		return EuzBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateStrategyStrategyStrategies_4018(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getStrategyStrategies().add(getTarget());
		}
