 ...
 * @generated
 */
public class ArgumentArgumentCriteriaExternalLabelEditPart extends
	...
	static {
		registerSnapBackPosition(
				EuzVisualIDRegistry
						.getType(net.certware.argument.euz.diagram.edit.parts.ArgumentArgumentCriteriaExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ArgumentArgumentCriteriaExternalLabelEditPart(View view) {
		super(view);
	}
