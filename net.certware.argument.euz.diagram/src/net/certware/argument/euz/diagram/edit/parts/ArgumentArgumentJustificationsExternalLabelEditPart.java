 ...
 * @generated
 */
public class ArgumentArgumentJustificationsExternalLabelEditPart extends
	...
	static {
		registerSnapBackPosition(
				EuzVisualIDRegistry
						.getType(net.certware.argument.euz.diagram.edit.parts.ArgumentArgumentJustificationsExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ArgumentArgumentJustificationsExternalLabelEditPart(View view) {
		super(view);
	}
