...
import net.certware.argument.euz.diagram.edit.policies.ArgumentDiagramCanonicalEditPolicy;
import net.certware.argument.euz.diagram.edit.policies.ArgumentDiagramItemSemanticEditPolicy;
...
public class ArgumentDiagramEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Euz"; //$NON-NLS-1$
