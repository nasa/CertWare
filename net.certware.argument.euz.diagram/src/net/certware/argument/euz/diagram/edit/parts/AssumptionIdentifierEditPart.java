...
public class AssumptionIdentifierEditPart extends CompartmentEditPart implements
	...
	protected Image getLabelIcon() {
		...
		return EuzElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EuzParserProvider
					.getParser(
							EuzElementTypes.Assumption_2005,
							getParserElement(),
							EuzVisualIDRegistry
									.getType(net.certware.argument.euz.diagram.edit.parts.AssumptionIdentifierEditPart.VISUAL_ID));
		}
		return parser;
	}
