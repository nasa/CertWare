 ...
 * @generated
 */
public class CriteriaContentEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CriteriaContentEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = EuzParserProvider
					.getParser(
							...
							getParserElement(),
							EuzVisualIDRegistry
									.getType(net.certware.argument.euz.diagram.edit.parts.CriteriaContentEditPart.VISUAL_ID));
		}
		return parser;
	}
