...
import net.certware.argument.euz.diagram.edit.policies.SolutionItemSemanticEditPolicy;
...
public class SolutionEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == EuzElementTypes.SolutionSolutionContexts_4014) {
			types.add(EuzElementTypes.Context_2007);
		} else if (relationshipType == EuzElementTypes.SolutionSolutionEvidence_4015) {
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == EuzElementTypes.ArgumentArgumentSolutions_4004) {
