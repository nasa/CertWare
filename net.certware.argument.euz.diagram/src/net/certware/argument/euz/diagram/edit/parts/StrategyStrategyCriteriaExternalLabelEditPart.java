 ...
 * @generated
 */
public class StrategyStrategyCriteriaExternalLabelEditPart extends
	...
	static {
		registerSnapBackPosition(
				EuzVisualIDRegistry
						.getType(net.certware.argument.euz.diagram.edit.parts.StrategyStrategyCriteriaExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public StrategyStrategyCriteriaExternalLabelEditPart(View view) {
		super(view);
	}
