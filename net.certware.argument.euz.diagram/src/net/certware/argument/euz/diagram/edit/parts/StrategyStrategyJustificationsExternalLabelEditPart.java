 ...
 * @generated
 */
public class StrategyStrategyJustificationsExternalLabelEditPart extends
	...
	static {
		registerSnapBackPosition(
				EuzVisualIDRegistry
						.getType(net.certware.argument.euz.diagram.edit.parts.StrategyStrategyJustificationsExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public StrategyStrategyJustificationsExternalLabelEditPart(View view) {
		super(view);
	}
