...
import net.certware.argument.euz.diagram.part.EuzDiagramEditor;
 ...
 * @generated
 */
public class EuzNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof EuzNavigatorItem) {
					selectedElement = ((EuzNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (ArgumentDiagramEditPart.MODEL_ID
							.equals(EuzVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, EuzDiagramEditor.ID);
