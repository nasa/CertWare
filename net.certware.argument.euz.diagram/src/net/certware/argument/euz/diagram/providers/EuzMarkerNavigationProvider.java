...
import net.certware.argument.euz.diagram.part.EuzDiagramEditorUtil;
 ...
 * @generated
 */
public class EuzMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = EuzDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			EuzDiagramEditorUtil.selectElementsInDiagram(editor,
