 ...
 * @generated
 */
public class EuzValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = EuzDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof EuzDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ArgumentDiagramEditPart.MODEL_ID.equals(EuzVisualIDRegistry
						.getModelID(view));
	}
