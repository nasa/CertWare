 ...
 * @generated
 */
public class EuzViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ArgumentDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& EuzVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EuzVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = EuzVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!EuzElementTypes.isKnownElementType(elementType)
				...
				if (!ArgumentDiagramEditPart.MODEL_ID
						.equals(EuzVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = EuzVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != EuzVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(ArgumentDiagramEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = EuzVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = EuzVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ArgumentEditPart.VISUAL_ID:
		...
		case SolutionEditPart.VISUAL_ID:
			return createSolution_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case EvidenceEditPart.VISUAL_ID:
			return createEvidence_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case StrategyEditPart.VISUAL_ID:
			return createStrategy_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case AssumptionEditPart.VISUAL_ID:
			return createAssumption_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case JustificationEditPart.VISUAL_ID:
			return createJustification_2006(domainElement, containerView,
					index, persisted, preferencesHint);
		case ContextEditPart.VISUAL_ID:
			return createContext_2007(domainElement, containerView, index,
					persisted, preferencesHint);
		case CriteriaEditPart.VISUAL_ID:
			return createCriteria_2008(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (EuzVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ArgumentArgumentStrategiesEditPart.VISUAL_ID:
			return createArgumentArgumentStrategies_4001(containerView, index,
					persisted, preferencesHint);
		case ArgumentArgumentAssumptionsEditPart.VISUAL_ID:
			return createArgumentArgumentAssumptions_4002(containerView, index,
					persisted, preferencesHint);
		case ArgumentArgumentContextsEditPart.VISUAL_ID:
			return createArgumentArgumentContexts_4003(containerView, index,
					persisted, preferencesHint);
		case ArgumentArgumentSolutionsEditPart.VISUAL_ID:
			return createArgumentArgumentSolutions_4004(containerView, index,
					persisted, preferencesHint);
		case ArgumentArgumentCriteriaEditPart.VISUAL_ID:
			return createArgumentArgumentCriteria_4005(containerView, index,
					persisted, preferencesHint);
		case ArgumentArgumentJustificationsEditPart.VISUAL_ID:
			return createArgumentArgumentJustifications_4006(containerView,
					index, persisted, preferencesHint);
		case ArgumentSubArgumentsEditPart.VISUAL_ID:
			return createArgumentSubArguments_4017(containerView, index,
					persisted, preferencesHint);
		case ContextContextAssumptionsEditPart.VISUAL_ID:
			return createContextContextAssumptions_4007(containerView, index,
					persisted, preferencesHint);
		case CriteriaCriteriaContextsEditPart.VISUAL_ID:
			return createCriteriaCriteriaContexts_4008(containerView, index,
					persisted, preferencesHint);
		case CriteriaCriteriaAssumptionsEditPart.VISUAL_ID:
			return createCriteriaCriteriaAssumptions_4009(containerView, index,
					persisted, preferencesHint);
		case StrategyStrategyArgumentsEditPart.VISUAL_ID:
			return createStrategyStrategyArguments_4010(containerView, index,
					persisted, preferencesHint);
		case StrategyStrategyJustificationsEditPart.VISUAL_ID:
			return createStrategyStrategyJustifications_4011(containerView,
					index, persisted, preferencesHint);
		case StrategyStrategyCriteriaEditPart.VISUAL_ID:
			return createStrategyStrategyCriteria_4012(containerView, index,
					persisted, preferencesHint);
		case StrategyStrategyAssumptionsEditPart.VISUAL_ID:
			return createStrategyStrategyAssumptions_4013(containerView, index,
					persisted, preferencesHint);
		case StrategyStrategyStrategiesEditPart.VISUAL_ID:
			return createStrategyStrategyStrategies_4018(containerView, index,
					persisted, preferencesHint);
		case StrategyStrategyContextsEditPart.VISUAL_ID:
			return createStrategyStrategyContexts_4019(containerView, index,
					persisted, preferencesHint);
		case SolutionSolutionContextsEditPart.VISUAL_ID:
			return createSolutionSolutionContexts_4014(containerView, index,
					persisted, preferencesHint);
		case SolutionSolutionEvidenceEditPart.VISUAL_ID:
			return createSolutionSolutionEvidence_4015(containerView, index,
					persisted, preferencesHint);
		case SolutionSolutionCriteriaEditPart.VISUAL_ID:
			return createSolutionSolutionCriteria_4016(containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createArgument_2001(EObject domainElement, View containerView,
		...
		Node label5002 = createLabel(node,
				EuzVisualIDRegistry.getType(ArgumentContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createSolution_2002(EObject domainElement, View containerView,
		...
		Node label5004 = createLabel(node,
				EuzVisualIDRegistry.getType(SolutionContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createEvidence_2003(EObject domainElement, View containerView,
		...
		Node label5006 = createLabel(node,
				EuzVisualIDRegistry.getType(EvidenceContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createStrategy_2004(EObject domainElement, View containerView,
		...
		Node label5008 = createLabel(node,
				EuzVisualIDRegistry.getType(StrategyContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createAssumption_2005(EObject domainElement,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EuzVisualIDRegistry.getType(AssumptionEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5010 = createLabel(node,
				EuzVisualIDRegistry
						.getType(AssumptionContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createJustification_2006(EObject domainElement,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EuzVisualIDRegistry
		...
		Node label5012 = createLabel(node,
				EuzVisualIDRegistry
						.getType(JustificationContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createContext_2007(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EuzVisualIDRegistry.getType(ContextEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5014 = createLabel(node,
				EuzVisualIDRegistry.getType(ContextContentEditPart.VISUAL_ID));
		return node;
	}
	...
	public Node createCriteria_2008(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EuzVisualIDRegistry.getType(CriteriaEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5016 = createLabel(node,
				EuzVisualIDRegistry.getType(CriteriaContentEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Edge createArgumentArgumentStrategies_4001(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		edge.setType(EuzVisualIDRegistry
		...
		Node label6001 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(ArgumentArgumentStrategiesExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createArgumentArgumentAssumptions_4002(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6002 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(ArgumentArgumentAssumptionsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createArgumentArgumentContexts_4003(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6003 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(ArgumentArgumentContextsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createArgumentArgumentSolutions_4004(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6004 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(ArgumentArgumentSolutionsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createArgumentArgumentCriteria_4005(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6005 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(ArgumentArgumentCriteriaExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createArgumentArgumentJustifications_4006(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6006 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(ArgumentArgumentJustificationsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createArgumentSubArguments_4017(View containerView, int index,
		...
		Node label6017 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(ArgumentSubArgumentsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createContextContextAssumptions_4007(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6007 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(ContextContextAssumptionsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createCriteriaCriteriaContexts_4008(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6008 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(CriteriaCriteriaContextsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createCriteriaCriteriaAssumptions_4009(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6009 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(CriteriaCriteriaAssumptionsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createStrategyStrategyArguments_4010(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6010 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(StrategyStrategyArgumentsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createStrategyStrategyJustifications_4011(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6011 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(StrategyStrategyJustificationsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createStrategyStrategyCriteria_4012(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6012 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(StrategyStrategyCriteriaExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createStrategyStrategyAssumptions_4013(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6013 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(StrategyStrategyAssumptionsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createStrategyStrategyStrategies_4018(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6018 = createLabel(edge,
				EuzVisualIDRegistry.getType(WrappingLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createStrategyStrategyContexts_4019(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6019 = createLabel(edge,
				EuzVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createSolutionSolutionContexts_4014(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6014 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(SolutionSolutionContextsExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createSolutionSolutionEvidence_4015(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6015 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(SolutionSolutionEvidenceExternalLabelEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createSolutionSolutionCriteria_4016(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		Node label6016 = createLabel(
				edge,
				EuzVisualIDRegistry
						.getType(SolutionSolutionCriteriaExternalLabelEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ArgumentDiagramEditPart.MODEL_ID.equals(EuzVisualIDRegistry
