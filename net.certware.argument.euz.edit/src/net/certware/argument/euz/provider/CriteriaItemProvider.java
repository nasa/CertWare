...
/**
 * This is the item provider adapter for a {@link net.certware.argument.euz.Criteria} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CriteriaItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EuzPackage.Literals.CRITERIA__CRITERIA_CONTEXTS);
			childrenFeatures.add(EuzPackage.Literals.CRITERIA__CRITERIA_ASSUMPTIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Criteria")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((Criteria)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_Criteria_type") : //$NON-NLS-1$
			getString("_UI_Criteria_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EuzPackage.Literals.CRITERIA__CRITERIA_CONTEXTS,
				 EuzFactory.eINSTANCE.createContext()));

		newChildDescriptors.add
			(createChildParameter
				(EuzPackage.Literals.CRITERIA__CRITERIA_ASSUMPTIONS,
