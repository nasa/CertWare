...
/**
 * This is the item provider adapter for a {@link net.certware.argument.euz.Solution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolutionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EuzPackage.Literals.SOLUTION__SOLUTION_CONTEXTS);
			childrenFeatures.add(EuzPackage.Literals.SOLUTION__SOLUTION_EVIDENCE);
			childrenFeatures.add(EuzPackage.Literals.SOLUTION__SOLUTION_CRITERIA);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EuzPackage.Literals.SOLUTION__SOLUTION_CONTEXTS,
				 EuzFactory.eINSTANCE.createContext()));

		newChildDescriptors.add
			(createChildParameter
				(EuzPackage.Literals.SOLUTION__SOLUTION_EVIDENCE,
				 EuzFactory.eINSTANCE.createEvidence()));

		newChildDescriptors.add
			(createChildParameter
				(EuzPackage.Literals.SOLUTION__SOLUTION_CRITERIA,
