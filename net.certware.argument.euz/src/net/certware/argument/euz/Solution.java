 ...
 * <ul>
 *   <li>{@link net.certware.argument.euz.Solution#getSolutionContexts <em>Solution Contexts</em>}</li>
 *   <li>{@link net.certware.argument.euz.Solution#getSolutionEvidence <em>Solution Evidence</em>}</li>
 *   <li>{@link net.certware.argument.euz.Solution#getSolutionCriteria <em>Solution Criteria</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.argument.euz.EuzPackage#getSolution()
...
public interface Solution extends AssertedEvidence {
	 ...
	 * @see net.certware.argument.euz.EuzPackage#getSolution_SolutionContexts()
	 ...
	 * @see net.certware.argument.euz.EuzPackage#getSolution_SolutionEvidence()
	 ...
	 * @see net.certware.argument.euz.EuzPackage#getSolution_SolutionCriteria()
