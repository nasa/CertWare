 ...
 * <ul>
 *   <li>{@link net.certware.argument.euz.impl.ArgumentDiagramImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link net.certware.argument.euz.impl.ArgumentDiagramImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link net.certware.argument.euz.impl.ArgumentDiagramImpl#getStrategies <em>Strategies</em>}</li>
 *   <li>{@link net.certware.argument.euz.impl.ArgumentDiagramImpl#getSolutions <em>Solutions</em>}</li>
 *   <li>{@link net.certware.argument.euz.impl.ArgumentDiagramImpl#getAssumptions <em>Assumptions</em>}</li>
 *   <li>{@link net.certware.argument.euz.impl.ArgumentDiagramImpl#getJustifications <em>Justifications</em>}</li>
 *   <li>{@link net.certware.argument.euz.impl.ArgumentDiagramImpl#getContexts <em>Contexts</em>}</li>
 *   <li>{@link net.certware.argument.euz.impl.ArgumentDiagramImpl#getCriteria <em>Criteria</em>}</li>
 *   <li>{@link net.certware.argument.euz.impl.ArgumentDiagramImpl#getEvidence <em>Evidence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArgumentDiagramImpl extends EObjectImpl implements ArgumentDiagram {
	...
	protected EClass eStaticClass() {
		return EuzPackage.Literals.ARGUMENT_DIAGRAM;
	}
	...
	public void setVersion(String newVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EuzPackage.ARGUMENT_DIAGRAM__VERSION, oldVersion, version));
	}
	...
	public EList<Argument> getArguments() {
		if (arguments == null) {
			arguments = new EObjectContainmentEList<Argument>(Argument.class, this, EuzPackage.ARGUMENT_DIAGRAM__ARGUMENTS);
		}
		return arguments;
	}
	...
	public EList<Strategy> getStrategies() {
		if (strategies == null) {
			strategies = new EObjectContainmentEList<Strategy>(Strategy.class, this, EuzPackage.ARGUMENT_DIAGRAM__STRATEGIES);
		}
		return strategies;
	}
	...
	public EList<Solution> getSolutions() {
		if (solutions == null) {
			solutions = new EObjectContainmentEList<Solution>(Solution.class, this, EuzPackage.ARGUMENT_DIAGRAM__SOLUTIONS);
		}
		return solutions;
	}
	...
	public EList<Assumption> getAssumptions() {
		if (assumptions == null) {
			assumptions = new EObjectContainmentEList<Assumption>(Assumption.class, this, EuzPackage.ARGUMENT_DIAGRAM__ASSUMPTIONS);
		}
		return assumptions;
	}
	...
	public EList<Justification> getJustifications() {
		if (justifications == null) {
			justifications = new EObjectContainmentEList<Justification>(Justification.class, this, EuzPackage.ARGUMENT_DIAGRAM__JUSTIFICATIONS);
		}
	...
	public EList<Context> getContexts() {
		if (contexts == null) {
			contexts = new EObjectContainmentEList<Context>(Context.class, this, EuzPackage.ARGUMENT_DIAGRAM__CONTEXTS);
		}
		return contexts;
	}
	...
	public EList<Criteria> getCriteria() {
		if (criteria == null) {
			criteria = new EObjectContainmentEList<Criteria>(Criteria.class, this, EuzPackage.ARGUMENT_DIAGRAM__CRITERIA);
		}
		return criteria;
	}
	...
	public EList<Evidence> getEvidence() {
		if (evidence == null) {
			evidence = new EObjectContainmentEList<Evidence>(Evidence.class, this, EuzPackage.ARGUMENT_DIAGRAM__EVIDENCE);
		}
		return evidence;
	}
