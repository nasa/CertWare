...
public class EuzSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EuzPackage.CRITERIA: {
				Criteria criteria = (Criteria)theEObject;
				T result = caseCriteria(criteria);
				if (result == null) result = caseInformationElement(criteria);
				if (result == null) result = caseArgumentElement(criteria);
				if (result == null) result = caseModelElement(criteria);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EuzPackage.STRATEGY: {
				Strategy strategy = (Strategy)theEObject;
				T result = caseStrategy(strategy);
				if (result == null) result = caseReasoningElement(strategy);
				if (result == null) result = caseArgumentElement(strategy);
				if (result == null) result = caseModelElement(strategy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EuzPackage.SOLUTION: {
