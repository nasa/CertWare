 ...
 * @generated
 */
public class StrategyGoalCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StrategyGoalCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GsnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateStrategyGoal_4002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getGoal().add(getTarget());
		}
