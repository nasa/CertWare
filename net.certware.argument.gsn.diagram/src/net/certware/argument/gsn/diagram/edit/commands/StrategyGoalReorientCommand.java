 ...
 * @generated
 */
public class StrategyGoalReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StrategyGoalReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Goal && newEnd instanceof Strategy)) {
			return false;
		}
		return GsnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistStrategyGoal_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GsnBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistStrategyGoal_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getGoal().remove(getOldTarget());
		getNewSource().getGoal().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getGoal().remove(getOldTarget());
		getOldSource().getGoal().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
