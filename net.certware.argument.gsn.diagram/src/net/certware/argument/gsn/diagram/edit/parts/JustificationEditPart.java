...
import net.certware.argument.gsn.diagram.edit.policies.JustificationCanonicalEditPolicy;
import net.certware.argument.gsn.diagram.edit.policies.JustificationItemSemanticEditPolicy;
...
public class JustificationEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new JustificationCanonicalEditPolicy());
