...
public class WrappingLabel2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				GsnVisualIDRegistry
						.getType(net.certware.argument.gsn.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GsnParserProvider.getParser(
					GsnElementTypes.StrategyGoal_4002, getParserElement(),
