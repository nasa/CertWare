 ...
 * @generated
 */
public class GsnDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public GsnDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof GsnDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((GsnDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new GsnDomainNavigatorItem((EObject) objects[i],
