...
public class GsnNavigatorContentProvider implements ICommonContentProvider {
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case ArgumentDiagramEditPart.VISUAL_ID: {
			...
			GsnNavigatorGroup links = new GsnNavigatorGroup(
			...
			connectedViews = getDiagramLinksByType(Collections.singleton(sv),
					GsnVisualIDRegistry.getType(StrategyGoalEditPart.VISUAL_ID));
		...
		case JustificationEditPart.VISUAL_ID: {
			...
			GsnNavigatorGroup incominglinks = new GsnNavigatorGroup(
					Messages.NavigatorGroupName_Justification_2008_incominglinks,
		...
		case GoalEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			GsnNavigatorGroup incominglinks = new GsnNavigatorGroup(
					Messages.NavigatorGroupName_Goal_2009_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					GsnVisualIDRegistry.getType(StrategyGoalEditPart.VISUAL_ID));
		...
		case StrategyJustificationEditPart.VISUAL_ID: {
			LinkedList<GsnAbstractNavigatorItem> result = new LinkedList<GsnAbstractNavigatorItem>();
			Edge sv = (Edge) view;
			GsnNavigatorGroup target = new GsnNavigatorGroup(
					Messages.NavigatorGroupName_StrategyJustification_4001_target,
		...
		case StrategyGoalEditPart.VISUAL_ID: {
			...
			Edge sv = (Edge) view;
			GsnNavigatorGroup target = new GsnNavigatorGroup(
					Messages.NavigatorGroupName_StrategyGoal_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getLinksTargetByType(Collections.singleton(sv),
					GsnVisualIDRegistry.getType(GoalEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	private Collection<GsnNavigatorItem> createNavigatorItems(
	 ...
	 * @generated
	 */
	private Collection<GsnNavigatorItem> getForeignShortcuts(Diagram diagram,
			Object parent) {
		LinkedList<View> result = new LinkedList<View>();
