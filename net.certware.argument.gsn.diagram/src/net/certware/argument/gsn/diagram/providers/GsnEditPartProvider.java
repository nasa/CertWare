...
import net.certware.argument.gsn.diagram.edit.parts.GsnEditPartFactory;
 ...
 * @generated
 */
public class GsnEditPartProvider extends AbstractEditPartProvider {
	...
	public GsnEditPartProvider() {
		setFactory(new GsnEditPartFactory());
