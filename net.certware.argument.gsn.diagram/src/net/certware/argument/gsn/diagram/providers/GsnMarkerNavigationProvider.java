...
import net.certware.argument.gsn.diagram.part.GsnDiagramEditorUtil;
 ...
 * @generated
 */
public class GsnMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = GsnDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			GsnDiagramEditorUtil.selectElementsInDiagram(editor,
