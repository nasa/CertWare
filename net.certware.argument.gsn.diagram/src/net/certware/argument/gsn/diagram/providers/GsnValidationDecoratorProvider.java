 ...
 * @generated
 */
public class GsnValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = GsnDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof GsnDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ArgumentDiagramEditPart.MODEL_ID.equals(GsnVisualIDRegistry
						.getModelID(view));
	}
