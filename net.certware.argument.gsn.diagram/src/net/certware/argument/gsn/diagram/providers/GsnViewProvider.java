 ...
 * @generated
 */
public class GsnViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return ArgumentDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& GsnVisualIDRegistry.getDiagramVisualID(getSemanticElement(op
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = GsnVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = GsnVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!GsnElementTypes.isKnownElementType(elementType)
				...
				if (!ArgumentDiagramEditPart.MODEL_ID
						.equals(GsnVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = GsnVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != GsnVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = GsnVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = GsnVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case GoalEditPart.VISUAL_ID:
		...
		case JustificationEditPart.VISUAL_ID:
			return createJustification_2008(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (GsnVisualIDRegistry.getVisualID(elementTypeHint)) {
		case StrategyGoalEditPart.VISUAL_ID:
			return createStrategyGoal_4002(containerView, index, persisted,
					preferencesHint);
		case StrategyJustificationEditPart.VISUAL_ID:
			return createStrategyJustification_4001(containerView, index,
					persisted, preferencesHint);
		}
	...
	public Node createGoal_2009(EObject domainElement, View containerView,
		...
		node.setType(GsnVisualIDRegistry.getType(GoalEditPart.VISUAL_ID));
		...
		Node label5012 = createLabel(node,
				GsnVisualIDRegistry.getType(GoalAssumedEditPart.VISUAL_ID));
		Node label5013 = createLabel(node,
				GsnVisualIDRegistry
						.getType(GoalToBeSupportedEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createJustification_2008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(GsnVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createStrategyGoal_4002(View containerView, int index,
		...
		edge.setType(GsnVisualIDRegistry
				.getType(StrategyGoalEditPart.VISUAL_ID));
		...
		Node label6002 = createLabel(edge,
				GsnVisualIDRegistry.getType(WrappingLabel2EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createStrategyJustification_4001(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(GsnVisualIDRegistry
				.getType(StrategyJustificationEditPart.VISUAL_ID));
		edge.setElement(null);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	...
	private void stampShortcut(View containerView, Node target) {
		if (!ArgumentDiagramEditPart.MODEL_ID.equals(GsnVisualIDRegistry
