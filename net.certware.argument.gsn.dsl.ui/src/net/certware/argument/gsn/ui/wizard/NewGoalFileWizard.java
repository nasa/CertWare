 ...
 * @since 1.1.3
 */
public class NewGoalFileWizard extends Wizard implements INewWizard {
	/** initial selection, presumably a container */
	private IStructuredSelection selection;
	/** wizard page for file specifics */
	private NewGoalFileWizardPage newFileWizardPage;
	...
	public void addPages() {
		newFileWizardPage = new NewGoalFileWizardPage(selection);
