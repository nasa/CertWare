...
public class AssumptionPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return GsnViewsRepository.Assumption.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (assumption != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (AssumptionPropertiesEditionPart)provider.getPropertiesEditionPart(GsnViewsRepository.Assumption.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (basePart != null && key == GsnViewsRepository.Assumption.class) {
	...
	public void firePropertiesChanged(IPropertiesEditionEvent event) {
		if (!isInitializing()) {
			...
			if (GsnViewsRepository.Assumption.identifier == event.getAffectedEditor()) {
			...
			if (GsnViewsRepository.Assumption.description == event.getAffectedEditor()) {
			...
			if (GsnViewsRepository.Assumption.content == event.getAffectedEditor()) {
			...
			if (GsnViewsRepository.Assumption.isTagged == event.getAffectedEditor()) {
