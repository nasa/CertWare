...
public class AssumptionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public AssumptionPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject assumption, String editing_mode) {
		...
		partKey = GsnViewsRepository.Assumption.class;
	}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == GsnViewsRepository.Assumption.Properties.identifier) {
			return ArmPackage.eINSTANCE.getModelElement_Identifier();
		}
		if (editorKey == GsnViewsRepository.Assumption.Properties.description) {
			return ArmPackage.eINSTANCE.getModelElement_Description();
		}
		if (editorKey == GsnViewsRepository.Assumption.Properties.content) {
			return ArmPackage.eINSTANCE.getModelElement_Content();
		}
		if (editorKey == GsnViewsRepository.Assumption.Properties.isTagged) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (GsnViewsRepository.Assumption.Properties.identifier == event.getAffectedEditor()) {
		...
		if (GsnViewsRepository.Assumption.Properties.description == event.getAffectedEditor()) {
		...
		if (GsnViewsRepository.Assumption.Properties.content == event.getAffectedEditor()) {
		...
		if (GsnViewsRepository.Assumption.Properties.isTagged == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Identifier().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(GsnViewsRepository.Assumption.Properties.identifier)) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Description().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(GsnViewsRepository.Assumption.Properties.description)) {
				if (msg.getNewValue() != null) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Content().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(GsnViewsRepository.Assumption.Properties.content)) {
				if (msg.getNewValue() != null) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_IsTagged().equals(msg.getFeature()) && isAccessible(GsnViewsRepository.Assumption.Properties.isTagged))
