...
public class AssumptionPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (assumption.getIdentifier() != null && isAccessible(GsnViewsRepository.Assumption.Properties.identifier))
				basePart.setIdentifier(EEFConverterUtil.convertToString(ArmPackage.eINSTANCE.getString(), assumption.getIdentifier()));
			
			if (assumption.getDescription() != null && isAccessible(GsnViewsRepository.Assumption.Properties.description))
				basePart.setDescription(EEFConverterUtil.convertToString(ArmPackage.eINSTANCE.getString(), assumption.getDescription()));
			
			if (assumption.getContent() != null && isAccessible(GsnViewsRepository.Assumption.Properties.content))
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (ArmPackage.eINSTANCE.getModelElement_Identifier().equals(msg.getFeature()) && basePart != null && isAccessible(GsnViewsRepository.Assumption.Properties.identifier)) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Description().equals(msg.getFeature()) && basePart != null && isAccessible(GsnViewsRepository.Assumption.Properties.description)) {
				if (msg.getNewValue() != null) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Content().equals(msg.getFeature()) && basePart != null && isAccessible(GsnViewsRepository.Assumption.Properties.content)) {
				if (msg.getNewValue() != null) {
