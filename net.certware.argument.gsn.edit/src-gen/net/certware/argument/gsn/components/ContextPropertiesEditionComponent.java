...
public class ContextPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public ContextPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject context, String editing_mode) {
		...
		partKey = GsnViewsRepository.Context.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (context.getIdentifier() != null && isAccessible(GsnViewsRepository.Context.Properties.identifier))
				basePart.setIdentifier(EEFConverterUtil.convertToString(ArmPackage.eINSTANCE.getString(), context.getIdentifier()));
			
			if (context.getDescription() != null && isAccessible(GsnViewsRepository.Context.Properties.description))
				basePart.setDescription(EEFConverterUtil.convertToString(ArmPackage.eINSTANCE.getString(), context.getDescription()));
			
			if (context.getContent() != null && isAccessible(GsnViewsRepository.Context.Properties.content))
				basePart.setContent(EEFConverterUtil.convertToString(ArmPackage.eINSTANCE.getString(), context.getContent()));
			
			if (isAccessible(GsnViewsRepository.Context.Properties.isTagged)) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == GsnViewsRepository.Context.Properties.identifier) {
			return ArmPackage.eINSTANCE.getModelElement_Identifier();
		}
		if (editorKey == GsnViewsRepository.Context.Properties.description) {
			return ArmPackage.eINSTANCE.getModelElement_Description();
		}
		if (editorKey == GsnViewsRepository.Context.Properties.content) {
			return ArmPackage.eINSTANCE.getModelElement_Content();
		}
		if (editorKey == GsnViewsRepository.Context.Properties.isTagged) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (GsnViewsRepository.Context.Properties.identifier == event.getAffectedEditor()) {
			context.setIdentifier((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
		if (GsnViewsRepository.Context.Properties.description == event.getAffectedEditor()) {
			context.setDescription((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
		if (GsnViewsRepository.Context.Properties.content == event.getAffectedEditor()) {
			context.setContent((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.eINSTANCE.getString(), (String)event.getNewValue()));
		}
		if (GsnViewsRepository.Context.Properties.isTagged == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				EReferencePropertiesEditionContext context1 = new EReferencePropertiesEditionContext(editingContext, this, isTaggedSettings, editingContext.getAdapterFactory());
				PropertiesEditingProvider provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(semanticObject, PropertiesEditingProvider.class);
				if (provider != null) {
					PropertiesEditingPolicy policy = provider.getPolicy(context1);
					if (policy instanceof CreateEditingPolicy) {
						policy.execute();
					}
				}
			} else if (event.getKind() == PropertiesEditionEvent.EDIT) {
				EObjectPropertiesEditionContext context1 = new EObjectPropertiesEditionContext(editingContext, this, (EObject) event.getNewValue(), editingContext.getAdapterFactory());
				PropertiesEditingProvider provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt((EObject) event.getNewValue(), PropertiesEditingProvider.class);
				if (provider != null) {
					PropertiesEditingPolicy editionPolicy = provider.getPolicy(context1);
	...
	public void updatePart(Notification msg) {
		if (editingPart.isVisible()) {	
			...
			if (ArmPackage.eINSTANCE.getModelElement_Identifier().equals(msg.getFeature()) && basePart != null && isAccessible(GsnViewsRepository.Context.Properties.identifier)) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Description().equals(msg.getFeature()) && basePart != null && isAccessible(GsnViewsRepository.Context.Properties.description)) {
				if (msg.getNewValue() != null) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Content().equals(msg.getFeature()) && basePart != null && isAccessible(GsnViewsRepository.Context.Properties.content)) {
				if (msg.getNewValue() != null) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_IsTagged().equals(msg.getFeature()) && isAccessible(GsnViewsRepository.Context.Properties.isTagged))
