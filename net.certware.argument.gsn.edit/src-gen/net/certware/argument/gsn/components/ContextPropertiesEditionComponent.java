...
public class ContextPropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return GsnViewsRepository.Context.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (context != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ContextPropertiesEditionPart)provider.getPropertiesEditionPart(GsnViewsRepository.Context.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (basePart != null && key == GsnViewsRepository.Context.class) {
	...
	public void firePropertiesChanged(IPropertiesEditionEvent event) {
		if (!isInitializing()) {
			...
			if (GsnViewsRepository.Context.identifier == event.getAffectedEditor()) {
			...
			if (GsnViewsRepository.Context.description == event.getAffectedEditor()) {
			...
			if (GsnViewsRepository.Context.content == event.getAffectedEditor()) {
			...
			if (GsnViewsRepository.Context.isTagged == event.getAffectedEditor()) {
