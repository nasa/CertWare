...
public class GoalPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(GsnViewsRepository.Goal.Properties.identifier))
				basePart.setIdentifier(EEFConverterUtil.convertToString(ArmPackage.Literals.STRING, goal.getIdentifier()));
			
			if (isAccessible(GsnViewsRepository.Goal.Properties.description))
				basePart.setDescription(EEFConverterUtil.convertToString(ArmPackage.Literals.STRING, goal.getDescription()));
			
			if (isAccessible(GsnViewsRepository.Goal.Properties.content))
				basePart.setContent(EEFConverterUtil.convertToString(ArmPackage.Literals.STRING, goal.getContent()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (GsnViewsRepository.Goal.Properties.identifier == event.getAffectedEditor()) {
			goal.setIdentifier((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (GsnViewsRepository.Goal.Properties.description == event.getAffectedEditor()) {
			goal.setDescription((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (GsnViewsRepository.Goal.Properties.content == event.getAffectedEditor()) {
			goal.setContent((java.lang.String)EEFConverterUtil.createFromString(ArmPackage.Literals.STRING, (String)event.getNewValue()));
		}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Identifier().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(GsnViewsRepository.Goal.Properties.identifier)) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Description().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(GsnViewsRepository.Goal.Properties.description)) {
				if (msg.getNewValue() != null) {
			...
			if (ArmPackage.eINSTANCE.getModelElement_Content().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(GsnViewsRepository.Goal.Properties.content)) {
				if (msg.getNewValue() != null) {
			...
			if (ArmPackage.eINSTANCE.getClaim_Assumed().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(GsnViewsRepository.Goal.Properties.assumed))
				basePart.setAssumed((Boolean)msg.getNewValue());
			
			if (ArmPackage.eINSTANCE.getClaim_ToBeSupported().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(GsnViewsRepository.Goal.Properties.toBeSupported))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			GsnPackage.eINSTANCE.getGoal_SubGoals(),
			GsnPackage.eINSTANCE.getGoal_Strategies(),
			GsnPackage.eINSTANCE.getGoal_GoalContexts(),
			GsnPackage.eINSTANCE.getGoal_Assumptions(),
			GsnPackage.eINSTANCE.getGoal_GoalSolutions()		);
