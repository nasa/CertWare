...
public class AssumptionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, AssumptionPropertiesEditionPart {
	...
	protected Composite createIdentifierText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, GsnViewsRepository.Assumption.Properties.identifier, GsnMessages.AssumptionPropertiesEditionPart_IdentifierLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							GsnViewsRepository.Assumption.Properties.identifier,
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, GsnViewsRepository.Assumption.Properties.description, GsnMessages.AssumptionPropertiesEditionPart_DescriptionLabel);
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AssumptionPropertiesEditionPartForm.this,
							GsnViewsRepository.Assumption.Properties.description,
	...
	protected Composite createContentText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, GsnViewsRepository.Assumption.Properties.content, GsnMessages.AssumptionPropertiesEditionPart_ContentLabel);
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AssumptionPropertiesEditionPartForm.this,
							GsnViewsRepository.Assumption.Properties.content,
	...
	protected Composite createIsTaggedTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.isTagged = new ReferencesTable(getDescription(GsnViewsRepository.Assumption.Properties.isTagged, GsnMessages.AssumptionPropertiesEditionPart_IsTaggedLabel), new ReferencesTableListener() {
	...
	public void setIdentifier(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Assumption.Properties.identifier);
		if (eefElementEditorReadOnlyState && identifier.isEnabled()) {
			identifier.setEnabled(false);
			identifier.setToolTipText(GsnMessages.Assumption_ReadOnly);
	...
	public void setDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Assumption.Properties.description);
		if (eefElementEditorReadOnlyState && description.isEnabled()) {
			description.setEnabled(false);
			description.setToolTipText(GsnMessages.Assumption_ReadOnly);
	...
	public void setContent(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Assumption.Properties.content);
		if (eefElementEditorReadOnlyState && content.isEnabled()) {
			content.setEnabled(false);
			content.setToolTipText(GsnMessages.Assumption_ReadOnly);
	...
	public void initIsTagged(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Assumption.Properties.isTagged);
		if (eefElementEditorReadOnlyState && isTagged.isEnabled()) {
			isTagged.setEnabled(false);
			isTagged.setToolTipText(GsnMessages.Assumption_ReadOnly);
