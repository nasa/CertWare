...
public class EvidencePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EvidencePropertiesEditionPart {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							GsnViewsRepository.Evidence.Properties.identifier,
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EvidencePropertiesEditionPartForm.this,
							GsnViewsRepository.Evidence.Properties.description,
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EvidencePropertiesEditionPartForm.this,
							GsnViewsRepository.Evidence.Properties.content,
	...
	protected Composite createTargetReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.target = new ReferencesTable(getDescription(GsnViewsRepository.Evidence.Properties.target, GsnMessages.EvidencePropertiesEditionPart_TargetLabel), new ReferencesTableListener	() {
	...
	protected Composite createSourceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.source = new ReferencesTable(getDescription(GsnViewsRepository.Evidence.Properties.source, GsnMessages.EvidencePropertiesEditionPart_SourceLabel), new ReferencesTableListener	() {
