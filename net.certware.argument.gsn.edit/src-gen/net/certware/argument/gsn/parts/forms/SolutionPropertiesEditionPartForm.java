...
public class SolutionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SolutionPropertiesEditionPart {
	...
	protected Composite createIdentifierText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, GsnViewsRepository.Solution.Properties.identifier, GsnMessages.SolutionPropertiesEditionPart_IdentifierLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							GsnViewsRepository.Solution.Properties.identifier,
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, GsnViewsRepository.Solution.Properties.description, GsnMessages.SolutionPropertiesEditionPart_DescriptionLabel);
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SolutionPropertiesEditionPartForm.this,
							GsnViewsRepository.Solution.Properties.description,
	...
	protected Composite createContentText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, GsnViewsRepository.Solution.Properties.content, GsnMessages.SolutionPropertiesEditionPart_ContentLabel);
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SolutionPropertiesEditionPartForm.this,
							GsnViewsRepository.Solution.Properties.content,
	...
	protected Composite createIsTaggedTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.isTagged = new ReferencesTable(getDescription(GsnViewsRepository.Solution.Properties.isTagged, GsnMessages.SolutionPropertiesEditionPart_IsTaggedLabel), new ReferencesTableListener() {
	...
	protected Composite createTargetReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.target = new ReferencesTable(getDescription(GsnViewsRepository.Solution.Properties.target, GsnMessages.SolutionPropertiesEditionPart_TargetLabel), new ReferencesTableListener	() {
	...
	protected Composite createSourceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.source = new ReferencesTable(getDescription(GsnViewsRepository.Solution.Properties.source, GsnMessages.SolutionPropertiesEditionPart_SourceLabel), new ReferencesTableListener	() {
	...
	protected Composite createSolutionEvidenceTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.solutionEvidence = new ReferencesTable(getDescription(GsnViewsRepository.Solution.Properties.solutionEvidence, GsnMessages.SolutionPropertiesEditionPart_SolutionEvidenceLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		// Start of user code for createSolutionEvidenceTableComposition
	...
	protected Composite createSolutionContextsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.solutionContexts = new ReferencesTable(getDescription(GsnViewsRepository.Solution.Properties.solutionContexts, GsnMessages.SolutionPropertiesEditionPart_SolutionContextsLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		// Start of user code for createSolutionContextsTableComposition
	...
	public void setIdentifier(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Solution.Properties.identifier);
		if (eefElementEditorReadOnlyState && identifier.isEnabled()) {
			identifier.setEnabled(false);
			identifier.setToolTipText(GsnMessages.Solution_ReadOnly);
	...
	public void setDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Solution.Properties.description);
		if (eefElementEditorReadOnlyState && description.isEnabled()) {
			description.setEnabled(false);
			description.setToolTipText(GsnMessages.Solution_ReadOnly);
	...
	public void setContent(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Solution.Properties.content);
		if (eefElementEditorReadOnlyState && content.isEnabled()) {
			content.setEnabled(false);
			content.setToolTipText(GsnMessages.Solution_ReadOnly);
	...
	public void initIsTagged(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Solution.Properties.isTagged);
		if (eefElementEditorReadOnlyState && isTagged.isEnabled()) {
			isTagged.setEnabled(false);
			isTagged.setToolTipText(GsnMessages.Solution_ReadOnly);
	...
	public void initTarget(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Solution.Properties.target);
		if (eefElementEditorReadOnlyState && target.getTable().isEnabled()) {
			target.setEnabled(false);
			target.setToolTipText(GsnMessages.Solution_ReadOnly);
	...
	public void initSource(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Solution.Properties.source);
		if (eefElementEditorReadOnlyState && source.getTable().isEnabled()) {
			source.setEnabled(false);
			source.setToolTipText(GsnMessages.Solution_ReadOnly);
	...
	public void initSolutionEvidence(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Solution.Properties.solutionEvidence);
		if (eefElementEditorReadOnlyState && solutionEvidence.isEnabled()) {
			solutionEvidence.setEnabled(false);
			solutionEvidence.setToolTipText(GsnMessages.Solution_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !solutionEvidence.isEnabled()) {
			solutionEvidence.setEnabled(true);
		}	
	...
	public void initSolutionContexts(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Solution.Properties.solutionContexts);
		if (eefElementEditorReadOnlyState && solutionContexts.isEnabled()) {
			solutionContexts.setEnabled(false);
			solutionContexts.setToolTipText(GsnMessages.Solution_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !solutionContexts.isEnabled()) {
			solutionContexts.setEnabled(true);
		}	
