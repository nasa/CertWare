...
public class StrategyPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, StrategyPropertiesEditionPart {
	...
	protected Composite createIdentifierText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, GsnViewsRepository.Strategy.Properties.identifier, GsnMessages.StrategyPropertiesEditionPart_IdentifierLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							GsnViewsRepository.Strategy.Properties.identifier,
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, GsnViewsRepository.Strategy.Properties.description, GsnMessages.StrategyPropertiesEditionPart_DescriptionLabel);
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							StrategyPropertiesEditionPartForm.this,
							GsnViewsRepository.Strategy.Properties.description,
	...
	protected Composite createContentText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, GsnViewsRepository.Strategy.Properties.content, GsnMessages.StrategyPropertiesEditionPart_ContentLabel);
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							StrategyPropertiesEditionPartForm.this,
							GsnViewsRepository.Strategy.Properties.content,
	...
	protected Composite createIsTaggedTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.isTagged = new ReferencesTable(getDescription(GsnViewsRepository.Strategy.Properties.isTagged, GsnMessages.StrategyPropertiesEditionPart_IsTaggedLabel), new ReferencesTableListener() {
	...
	protected Composite createGoalsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.goals = new ReferencesTable(getDescription(GsnViewsRepository.Strategy.Properties.goals, GsnMessages.StrategyPropertiesEditionPart_GoalsLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		// Start of user code for createGoalsTableComposition
	...
	protected Composite createJustificationsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.justifications = new ReferencesTable(getDescription(GsnViewsRepository.Strategy.Properties.justifications, GsnMessages.StrategyPropertiesEditionPart_JustificationsLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		// Start of user code for createJustificationsTableComposition
	...
	protected Composite createStrategyContextsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.strategyContexts = new ReferencesTable(getDescription(GsnViewsRepository.Strategy.Properties.strategyContexts, GsnMessages.StrategyPropertiesEditionPart_StrategyContextsLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		// Start of user code for createStrategyContextsTableComposition
	...
	protected Composite createStrategySolutionsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.strategySolutions = new ReferencesTable(getDescription(GsnViewsRepository.Strategy.Properties.strategySolutions, GsnMessages.StrategyPropertiesEditionPart_StrategySolutionsLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		// Start of user code for createStrategySolutionsTableComposition
	...
	public void setIdentifier(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Strategy.Properties.identifier);
		if (eefElementEditorReadOnlyState && identifier.isEnabled()) {
			identifier.setEnabled(false);
			identifier.setToolTipText(GsnMessages.Strategy_ReadOnly);
	...
	public void setDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Strategy.Properties.description);
		if (eefElementEditorReadOnlyState && description.isEnabled()) {
			description.setEnabled(false);
			description.setToolTipText(GsnMessages.Strategy_ReadOnly);
	...
	public void setContent(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Strategy.Properties.content);
		if (eefElementEditorReadOnlyState && content.isEnabled()) {
			content.setEnabled(false);
			content.setToolTipText(GsnMessages.Strategy_ReadOnly);
	...
	public void initIsTagged(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Strategy.Properties.isTagged);
		if (eefElementEditorReadOnlyState && isTagged.isEnabled()) {
			isTagged.setEnabled(false);
			isTagged.setToolTipText(GsnMessages.Strategy_ReadOnly);
	...
	public void initGoals(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Strategy.Properties.goals);
		if (eefElementEditorReadOnlyState && goals.isEnabled()) {
			goals.setEnabled(false);
			goals.setToolTipText(GsnMessages.Strategy_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !goals.isEnabled()) {
	...
	public void initJustifications(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Strategy.Properties.justifications);
		if (eefElementEditorReadOnlyState && justifications.isEnabled()) {
			justifications.setEnabled(false);
			justifications.setToolTipText(GsnMessages.Strategy_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !justifications.isEnabled()) {
			justifications.setEnabled(true);
		}	
	...
	public void initStrategyContexts(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Strategy.Properties.strategyContexts);
		if (eefElementEditorReadOnlyState && strategyContexts.isEnabled()) {
			strategyContexts.setEnabled(false);
			strategyContexts.setToolTipText(GsnMessages.Strategy_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !strategyContexts.isEnabled()) {
			strategyContexts.setEnabled(true);
		}	
	...
	public void initStrategySolutions(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(GsnViewsRepository.Strategy.Properties.strategySolutions);
		if (eefElementEditorReadOnlyState && strategySolutions.isEnabled()) {
			strategySolutions.setEnabled(false);
			strategySolutions.setToolTipText(GsnMessages.Strategy_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !strategySolutions.isEnabled()) {
			strategySolutions.setEnabled(true);
		}	
