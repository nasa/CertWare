 ...
 * 
 */
public class ArgumentDiagramPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ArgumentDiagramPropertiesEditionPart {
	 ...
	 * 
	 */
	public ArgumentDiagramPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected void createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(GsnMessages.ArgumentDiagramPropertiesEditionPart_PropertiesGroupLabel);
		...
		createStrategiesAdvancedTableComposition(propertiesGroup);
		createAssumptionsAdvancedTableComposition(propertiesGroup);
		createSolutionsAdvancedTableComposition(propertiesGroup);
		createContextsAdvancedTableComposition(propertiesGroup);
	...
	protected void createGoalsAdvancedTableComposition(Composite parent) {
		...
		this.goals.setHelpText(propertiesEditionComponent.getHelpContent(GsnViewsRepository.ArgumentDiagram.goals, GsnViewsRepository.SWT_KIND));
	...
	protected void moveGoals(Goal element, int oldIndex, int newIndex) {
		...
		goals.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.goals, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToGoals() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						goals.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.goals, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromGoals(Goal element) {
		// Start of user code removeFromGoals() method body
				...
				goals.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.goals, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editGoals() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						goals.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.goals, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	 ...
	 * 
	 */
	protected void createStrategiesAdvancedTableComposition(Composite parent) {
		...
		this.strategies.setHelpText(propertiesEditionComponent.getHelpContent(GsnViewsRepository.ArgumentDiagram.strategies, GsnViewsRepository.SWT_KIND));
	...
	protected void moveStrategies(Strategy element, int oldIndex, int newIndex) {
		...
		strategies.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.strategies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToStrategies() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						strategies.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.strategies, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromStrategies(Strategy element) {
		// Start of user code removeFromStrategies() method body
				EObject editedElement = strategiesEditUtil.foundCorrespondingEObject(element);
				strategiesEditUtil.removeElement(element);
				strategies.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.strategies, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editStrategies() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						strategies.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.strategies, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	 ...
	 * 
	 */
	protected void createAssumptionsAdvancedTableComposition(Composite parent) {
		...
		this.assumptions.setHelpText(propertiesEditionComponent.getHelpContent(GsnViewsRepository.ArgumentDiagram.assumptions, GsnViewsRepository.SWT_KIND));
	...
	protected void moveAssumptions(Assumption element, int oldIndex, int newIndex) {
		...
		assumptions.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.assumptions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToAssumptions() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						assumptions.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.assumptions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromAssumptions(Assumption element) {
		// Start of user code removeFromAssumptions() method body
				EObject editedElement = assumptionsEditUtil.foundCorrespondingEObject(element);
				assumptionsEditUtil.removeElement(element);
				assumptions.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.assumptions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editAssumptions() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						assumptions.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.assumptions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	 ...
	 * 
	 */
	protected void createSolutionsAdvancedTableComposition(Composite parent) {
		...
		this.solutions.setHelpText(propertiesEditionComponent.getHelpContent(GsnViewsRepository.ArgumentDiagram.solutions, GsnViewsRepository.SWT_KIND));
		this.solutions.createControls(parent);
	...
	protected void moveSolutions(Solution element, int oldIndex, int newIndex) {
		...
		solutions.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.solutions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToSolutions() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						solutions.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.solutions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromSolutions(Solution element) {
		// Start of user code removeFromSolutions() method body
				EObject editedElement = solutionsEditUtil.foundCorrespondingEObject(element);
				solutionsEditUtil.removeElement(element);
				solutions.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.solutions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editSolutions() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						solutions.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.solutions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	 ...
	 * 
	 */
	protected void createContextsAdvancedTableComposition(Composite parent) {
		...
		this.contexts.setHelpText(propertiesEditionComponent.getHelpContent(GsnViewsRepository.ArgumentDiagram.contexts, GsnViewsRepository.SWT_KIND));
	...
	protected void moveContexts(Context element, int oldIndex, int newIndex) {
		...
		contexts.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.contexts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToContexts() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						contexts.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.contexts, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromContexts(Context element) {
		// Start of user code removeFromContexts() method body
				EObject editedElement = contextsEditUtil.foundCorrespondingEObject(element);
				contextsEditUtil.removeElement(element);
				contexts.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.contexts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editContexts() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						contexts.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.contexts, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	...
	protected void createJustificationsAdvancedTableComposition(Composite parent) {
		...
		this.justifications.setHelpText(propertiesEditionComponent.getHelpContent(GsnViewsRepository.ArgumentDiagram.justifications, GsnViewsRepository.SWT_KIND));
	...
	protected void moveJustifications(Justification element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.justifications, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	}
		...
		// Start of user code addToJustifications() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						justifications.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.justifications, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
					}
				}
	...
	protected void removeFromJustifications(Justification element) {
		// Start of user code removeFromJustifications() method body
				...
				justifications.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.justifications, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	}
		...
		// Start of user code editJustifications() method body
				...
				if (editionPolicy != null) {
					...
					if (propertiesEditionObject != null) {
						...
						justifications.refresh();
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.justifications, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
					}
				}
		// End of user code
	}
	...
	protected void createVersionText(Composite parent) {
		SWTUtils.createPartLabel(parent, GsnMessages.ArgumentDiagramPropertiesEditionPart_VersionLabel, propertiesEditionComponent.isRequired(GsnViewsRepository.ArgumentDiagram.version, GsnViewsRepository.SWT_KIND));
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentDiagramPropertiesEditionPartImpl.this, GsnViewsRepository.ArgumentDiagram.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(GsnViewsRepository.ArgumentDiagram.version, GsnViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
