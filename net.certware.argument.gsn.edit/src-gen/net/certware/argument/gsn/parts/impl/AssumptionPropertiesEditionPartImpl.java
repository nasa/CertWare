...
public class AssumptionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, AssumptionPropertiesEditionPart {
	...
	protected void createContentTextarea(Composite parent) {
		Label contentLabel = SWTUtils.createPartLabel(parent, GsnMessages.AssumptionPropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(GsnViewsRepository.Assumption.content, GsnViewsRepository.SWT_KIND));
