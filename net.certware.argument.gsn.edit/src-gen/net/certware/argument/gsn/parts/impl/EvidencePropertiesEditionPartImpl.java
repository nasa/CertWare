...
protected List<ViewerFilter> isTaggedFilters = new ArrayList<ViewerFilter>();
	...
	protected Composite createIdentifierText(Composite parent) {
		SWTUtils.createPartLabel(parent, GsnMessages.EvidencePropertiesEditionPart_IdentifierLabel, propertiesEditionComponent.isRequired(GsnViewsRepository.Evidence.Properties.identifier, GsnViewsRepository.SWT_KIND));
	...
	protected Composite createDescriptionText(Composite parent) {
		SWTUtils.createPartLabel(parent, GsnMessages.EvidencePropertiesEditionPart_DescriptionLabel, propertiesEditionComponent.isRequired(GsnViewsRepository.Evidence.Properties.description, GsnViewsRepository.SWT_KIND));
	...
	protected Composite createContentText(Composite parent) {
		SWTUtils.createPartLabel(parent, GsnMessages.EvidencePropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(GsnViewsRepository.Evidence.Properties.content, GsnViewsRepository.SWT_KIND));
