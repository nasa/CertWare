...
public class EvidencePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EvidencePropertiesEditionPart {
	...
	protected void createContentTextarea(Composite parent) {
		Label contentLabel = SWTUtils.createPartLabel(parent, GsnMessages.EvidencePropertiesEditionPart_ContentLabel, propertiesEditionComponent.isRequired(GsnViewsRepository.Evidence.content, GsnViewsRepository.SWT_KIND));
