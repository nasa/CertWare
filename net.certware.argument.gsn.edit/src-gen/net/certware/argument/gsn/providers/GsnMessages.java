 ...
 * 
 */
public class GsnMessages extends NLS {
	
	private static final String BUNDLE_NAME = "net.certware.argument.gsn.providers.gsnMessages"; //$NON-NLS-1$
	...
	public static String GoalPropertiesEditionPart_DescriptionLabel;

	
	public static String GoalPropertiesEditionPart_ContentLabel;

	
	public static String GoalPropertiesEditionPart_IsTaggedLabel;

	
	public static String GoalPropertiesEditionPart_AssumedLabel;
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, GsnMessages.class);
	}
