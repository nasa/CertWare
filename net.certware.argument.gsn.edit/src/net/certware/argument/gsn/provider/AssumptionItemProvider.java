...
/**
 * This is the item provider adapter for a {@link net.certware.argument.gsn.Assumption} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssumptionItemProvider
	...
	public String getText(Object object) {
		String label = ((Assumption)object).getIdentifier();
		return label == null || label.length() == 0 ?
			getString("_UI_Assumption_type") : //$NON-NLS-1$
			getString("_UI_Assumption_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
