 ...
 * <ul>
 *   <li>{@link net.certware.argument.gsn.Diagram#getGoals <em>Goals</em>}</li>
 *   <li>{@link net.certware.argument.gsn.Diagram#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.argument.gsn.GsnPackage#getDiagram()
...
public interface Diagram extends EObject {
	 ...
	 * @see net.certware.argument.gsn.GsnPackage#getDiagram_Goals()
	 * @model ordered="false"
	 * @generated
	 */
	EList<Goal> getGoals();
	 ...
	 * @see net.certware.argument.gsn.GsnPackage#getDiagram_Version()
	 * @model
	 * @generated
	 */
	String getVersion();
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.gsn.Diagram#getVersion <em>Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
