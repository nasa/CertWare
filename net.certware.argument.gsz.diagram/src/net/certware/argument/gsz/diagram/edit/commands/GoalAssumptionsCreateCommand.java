 ...
 * @generated
 */
public class GoalAssumptionsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalAssumptionsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGoalAssumptions_4004(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getAssumptions().add(getTarget());
		}
