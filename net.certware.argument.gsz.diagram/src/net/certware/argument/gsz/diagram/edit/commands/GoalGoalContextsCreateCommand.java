 ...
 * @generated
 */
public class GoalGoalContextsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalGoalContextsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGoalGoalContexts_4003(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getGoalContexts().add(getTarget());
		}
