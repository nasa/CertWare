 ...
 * @generated
 */
public class GoalGoalSolutionsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalGoalSolutionsCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGoalGoalSolutions_4005(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getGoalSolutions().add(getTarget());
		}
