 ...
 * @generated
 */
public class GoalGoalSolutionsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalGoalSolutionsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Solution && newEnd instanceof Goal)) {
			return false;
		}
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalGoalSolutions_4005(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalGoalSolutions_4005(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getGoalSolutions().remove(getOldTarget());
		getNewSource().getGoalSolutions().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getGoalSolutions().remove(getOldTarget());
		getOldSource().getGoalSolutions().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
