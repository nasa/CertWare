 ...
 * @generated
 */
public class GoalStrategiesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalStrategiesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGoalStrategies_4002(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getStrategies().add(getTarget());
		}
