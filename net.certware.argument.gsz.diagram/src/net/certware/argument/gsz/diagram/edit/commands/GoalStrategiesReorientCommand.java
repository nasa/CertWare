 ...
 * @generated
 */
public class GoalStrategiesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GoalStrategiesReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Strategy && newEnd instanceof Goal)) {
			return false;
		}
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalStrategies_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalStrategies_4002(getOldSource(), getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getStrategies().remove(getOldTarget());
		getNewSource().getStrategies().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getStrategies().remove(getOldTarget());
		getOldSource().getStrategies().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
