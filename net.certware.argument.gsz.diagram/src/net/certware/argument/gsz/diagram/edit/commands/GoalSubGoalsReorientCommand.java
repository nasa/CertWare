 ...
 * @generated
 */
public class GoalSubGoalsReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalSubGoals_4001(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return GszBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistGoalSubGoals_4001(getOldSource(), getNewTarget());
	}
