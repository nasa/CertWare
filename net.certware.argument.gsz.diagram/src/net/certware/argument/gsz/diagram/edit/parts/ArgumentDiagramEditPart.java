...
import net.certware.argument.gsz.diagram.edit.policies.ArgumentDiagramCanonicalEditPolicy;
import net.certware.argument.gsz.diagram.edit.policies.ArgumentDiagramItemSemanticEditPolicy;
...
public class ArgumentDiagramEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "gsz"; //$NON-NLS-1$
