...
import net.certware.argument.gsz.diagram.edit.policies.ContextItemSemanticEditPolicy;
...
public class ContextEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnTarget() {
		...
		types.add(GszElementTypes.SolutionSolutionContexts_4011);
		return types;
	}
	...
	public List<IElementType> getMATypesForSource(IElementType relationshipType) {
		...
		if (relationshipType == GszElementTypes.GoalGoalContexts_4003) {
		...
		} else if (relationshipType == GszElementTypes.SolutionSolutionContexts_4011) {
