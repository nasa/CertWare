...
import net.certware.argument.gsz.diagram.edit.policies.EvidenceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EvidenceEditPart extends AbstractBorderedShapeEditPart {
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		org.eclipse.gmf.runtime.diagram.ui.editpolicies.LayoutEditPolicy lep = new org.eclipse.gmf.runtime.diagram.ui.editpolicies.LayoutEditPolicy() {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				...
				switch (GszVisualIDRegistry.getVisualID(childView)) {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof EvidenceIdentifierEditPart) {
	 ...
	 * @generated
	 */
	public class EvidenceFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureModelElementContentLabelFigure
					.setText(Messages.EvidenceEditPart_0);
