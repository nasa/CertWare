...
public class EvidenceIdentifierEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				GszVisualIDRegistry
						.getType(net.certware.argument.gsz.diagram.edit.parts.EvidenceIdentifierEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public EvidenceIdentifierEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new EvidenceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EvidenceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EvidenceLabelFigure() {
