 ...
 * @generated
 */
public class GoalStrategiesExternalLabelEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				GszVisualIDRegistry
						.getType(net.certware.argument.gsz.diagram.edit.parts.GoalStrategiesExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public GoalStrategiesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GszParserProvider.getParser(
					GszElementTypes.GoalStrategies_4002, getParserElement(),
	...
	protected IFigure createFigurePrim() {
		return new GoalStrategiesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class GoalStrategiesExternalLabelFigure extends WrappingLabel {
