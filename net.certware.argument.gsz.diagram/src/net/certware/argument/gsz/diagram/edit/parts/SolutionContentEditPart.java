...
public class SolutionContentEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SolutionContentEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = GszParserProvider
					.getParser(
							...
							getParserElement(),
							GszVisualIDRegistry
									.getType(net.certware.argument.gsz.diagram.edit.parts.SolutionContentEditPart.VISUAL_ID));
		}
		return parser;
	}
