 ...
 * @generated
 */
public class SolutionIdentifierEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SolutionIdentifierEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = GszParserProvider
					.getParser(
							...
							getParserElement(),
							GszVisualIDRegistry
									.getType(net.certware.argument.gsz.diagram.edit.parts.SolutionIdentifierEditPart.VISUAL_ID));
		}
		return parser;
	}
