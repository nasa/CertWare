 ...
 * @generated
 */
public class SolutionSolutionContextsExternalLabelEditPart extends
	...
	static {
		registerSnapBackPosition(
				GszVisualIDRegistry
						.getType(net.certware.argument.gsz.diagram.edit.parts.SolutionSolutionContextsExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public SolutionSolutionContextsExternalLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new SolutionSolutionContextsExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SolutionSolutionContextsExternalLabelFigure extends
			WrappingLabel {
