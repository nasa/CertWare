 ...
 * @generated
 */
public class StrategyContentEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StrategyContentEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = GszParserProvider
					.getParser(
							...
							getParserElement(),
							GszVisualIDRegistry
									.getType(net.certware.argument.gsz.diagram.edit.parts.StrategyContentEditPart.VISUAL_ID));
		}
		return parser;
	}
