...
import net.certware.argument.gsz.diagram.part.GszDiagramEditor;
 ...
 * @generated
 */
public class GszNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof GszNavigatorItem) {
					selectedElement = ((GszNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (ArgumentDiagramEditPart.MODEL_ID
							.equals(GszVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, GszDiagramEditor.ID);
