...
public class GszElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Strategy_2008 = getElementType("net.certware.argument.gsz.diagram.Strategy_2008"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Strategy_2008, GszPackage.eINSTANCE.getStrategy());
