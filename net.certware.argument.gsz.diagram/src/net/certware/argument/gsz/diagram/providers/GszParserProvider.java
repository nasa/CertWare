...
public class GszParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser strategyIdentifier_5006Parser;

	/**
	 * @generated
	 */
	private IParser getStrategyIdentifier_5006Parser() {
		if (strategyIdentifier_5006Parser == null) {
			EAttribute[] features = new EAttribute[] { ArmPackage.eINSTANCE
					.getModelElement_Identifier() };
			MessageFormatParser parser = new MessageFormatParser(features);
			...
			strategyIdentifier_5006Parser = parser;
		}
		return strategyIdentifier_5006Parser;
	}

	/**
	 * @generated
	 */
	private IParser strategyContent_5012Parser;

	/**
	 * @generated
	 */
	private IParser getStrategyContent_5012Parser() {
		if (strategyContent_5012Parser == null) {
			EAttribute[] features = new EAttribute[] { ArmPackage.eINSTANCE
					.getModelElement_Content() };
			MessageFormatParser parser = new MessageFormatParser(features);
			strategyContent_5012Parser = parser;
		}
		return strategyContent_5012Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case StrategyIdentifierEditPart.VISUAL_ID:
			return getStrategyIdentifier_5006Parser();
		case StrategyContentEditPart.VISUAL_ID:
			return getStrategyContent_5012Parser();
