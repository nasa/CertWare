 ...
 * @generated
 */
public class GszValidationDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = GszDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof GszDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& ArgumentDiagramEditPart.MODEL_ID.equals(GszVisualIDRegistry
						.getModelID(view));
	}
