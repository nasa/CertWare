...
public class TypedVariableImpl extends BasicTermImpl implements TypedVariable
{
  ...
  {
    return LPackage.Literals.TYPED_VARIABLE;
  }
  ...
  public NotificationChain basicSetVar(Variable newVar, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LPackage.TYPED_VARIABLE__VAR, oldVar, newVar);
  ...
  public void setVar(Variable newVar)
  {
    if (newVar != var)
    {
      ...
      if (var != null)
        msgs = ((InternalEObject)var).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LPackage.TYPED_VARIABLE__VAR, null, msgs);
      if (newVar != null)
        msgs = ((InternalEObject)newVar).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LPackage.TYPED_VARIABLE__VAR, null, msgs);
      msgs = basicSetVar(newVar, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LPackage.TYPED_VARIABLE__VAR, newVar, newVar));
  }
