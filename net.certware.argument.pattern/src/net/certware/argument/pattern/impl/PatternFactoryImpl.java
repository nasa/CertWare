...
public class PatternFactoryImpl extends EFactoryImpl implements PatternFactory {
	...
	public static PatternFactory init() {
		try {
			PatternFactory thePatternFactory = (PatternFactory)EPackage.Registry.INSTANCE.getEFactory("pattern"); //$NON-NLS-1$ 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case PatternPackage.PARTICIPANT: return createParticipant();
			default:
