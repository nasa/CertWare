		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_StringToStringMap_key_description"), //$NON-NLS-1$
				 InstancePackage.Literals.STRING_TO_STRING_MAP__KEY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_StringToStringMap_value_description"), //$NON-NLS-1$
				 InstancePackage.Literals.STRING_TO_STRING_MAP__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
