		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDataItemListAccess().getAlternatives(), "rule__DataItemList__Alternatives");
					...
					put(grammarAccess.getUnstructuredDataListAccess().getGroup(), "rule__UnstructuredDataList__Group__0");
					...
					put(grammarAccess.getPotentialDataAttributeAccess().getItemsAssignment_4(), "rule__PotentialDataAttribute__ItemsAssignment_4");
					put(grammarAccess.getUnstructuredDataListAccess().getListAssignment_1(), "rule__UnstructuredDataList__ListAssignment_1");
