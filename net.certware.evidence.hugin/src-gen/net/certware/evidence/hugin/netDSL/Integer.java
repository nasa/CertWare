 ...
 * <ul>
 *   <li>{@link net.certware.evidence.hugin.netDSL.Integer#getI <em>I</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.evidence.hugin.netDSL.NetDSLPackage#getInteger()
 * @model
 * @generated
 */
public interface Integer extends EObject
{
   ...
   * @see #setI(int)
   * @see net.certware.evidence.hugin.netDSL.NetDSLPackage#getInteger_I()
   * @model
   * @generated
   */
  int getI();
  ...
  /**
   * Sets the value of the '{@link net.certware.evidence.hugin.netDSL.Integer#getI <em>I</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
