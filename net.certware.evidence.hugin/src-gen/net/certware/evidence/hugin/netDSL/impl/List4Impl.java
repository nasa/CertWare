 ...
 * <ul>
 *   <li>{@link net.certware.evidence.hugin.netDSL.impl.List4Impl#getList <em>List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class List4Impl extends MatrixRowImpl implements List4
{
  /**
  ...
  {
    return NetDSLPackage.Literals.LIST4;
  }
  ...
  public EList<MatrixRow> getList()
  {
    if (list == null)
    {
      list = new EObjectContainmentEList<MatrixRow>(MatrixRow.class, this, NetDSLPackage.LIST4__LIST);
    }
    return list;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case NetDSLPackage.LIST4__LIST:
