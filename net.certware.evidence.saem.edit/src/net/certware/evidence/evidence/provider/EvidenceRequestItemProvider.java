...
/**
 * This is the item provider adapter for a {@link net.certware.evidence.evidence.EvidenceRequest} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EvidenceRequestItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EvidencePackage.Literals.EVIDENCE_REQUEST__PROVENANCE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EvidenceRequest.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EvidencePackage.Literals.EVIDENCE_REQUEST__PROVENANCE,
