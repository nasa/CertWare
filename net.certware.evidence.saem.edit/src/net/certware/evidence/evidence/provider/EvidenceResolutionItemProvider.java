...
/**
 * This is the item provider adapter for a {@link net.certware.evidence.evidence.EvidenceResolution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EvidenceResolutionItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EvidencePackage.Literals.EVIDENCE_RESOLUTION__RATIONALE);
			childrenFeatures.add(EvidencePackage.Literals.EVIDENCE_RESOLUTION__CONTEXT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EvidencePackage.Literals.EVIDENCE_RESOLUTION__RATIONALE,
				 EvidenceFactory.eINSTANCE.createRationale()));

		newChildDescriptors.add
			(createChildParameter
				(EvidencePackage.Literals.EVIDENCE_RESOLUTION__CONTEXT,
