...
/**
 * This is the item provider adapter for a {@link net.certware.evidence.evidence.Meaning} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MeaningItemProvider
	...
	public String getText(Object object) {
		String label = ((Meaning)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Meaning_type") : //$NON-NLS-1$
			getString("_UI_Meaning_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
