...
/**
 * This is the item provider adapter for a {@link net.certware.evidence.evidence.Relevance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelevanceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Relevance_value_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Relevance_value_feature", "_UI_Relevance_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 EvidencePackage.Literals.RELEVANCE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Level labelValue = ((Relevance)object).getValue();
