...
/**
 * This is the item provider adapter for a {@link net.certware.evidence.evidence.Satisfies} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SatisfiesItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Satisfies_objective_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Satisfies_objective_feature", "_UI_Satisfies_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 EvidencePackage.Literals.SATISFIES__OBJECTIVE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_Satisfies_type"); //$NON-NLS-1$
	}
