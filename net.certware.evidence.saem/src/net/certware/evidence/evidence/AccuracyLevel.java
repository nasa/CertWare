 ...
 * <!-- end-user-doc -->
 * @see net.certware.evidence.evidence.EvidencePackage#getAccuracyLevel()
 * @model
 * @generated
 */
public enum AccuracyLevel implements Enumerator {
	 ...
	 * @ordered
	 */
	IMPROBABLE(1, "improbable", "improbable"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	DOUBTFUL(2, "doubtful", "doubtful"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	POSSIBLE(3, "possible", "possible"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	PROBABLE(4, "probable", "probable"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	CONFIRMED(5, "confirmed", "confirmed"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final int IMPROBABLE_VALUE = 1;
	 ...
	 * @ordered
	 */
	public static final int DOUBTFUL_VALUE = 2;
	...
	public static AccuracyLevel get(int value) {
		switch (value) {
			...
			case DOUBTFUL_VALUE: return DOUBTFUL;
