 ...
 * <!-- end-user-doc -->
 * @see net.certware.evidence.evidence.EvidencePackage#getCompletenessLevel()
 * @model
 * @generated
 */
public enum CompletenessLevel implements Enumerator {
	 ...
	 * @ordered
	 */
	INCOMPLETE(1, "incomplete", "incomplete"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	DRAFT(2, "draft", "draft"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	OBSOLETE(4, "obsolete", "obsolete"); //$NON-NLS-1$ //$NON-NLS-2$
