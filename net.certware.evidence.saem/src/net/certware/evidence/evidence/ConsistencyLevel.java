 ...
 * <!-- end-user-doc -->
 * @see net.certware.evidence.evidence.EvidencePackage#getConsistencyLevel()
 * @model
 * @generated
 */
public enum ConsistencyLevel implements Enumerator {
	 ...
	 * @ordered
	 */
	INFORMAL(1, "informal", "informal"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	SEMIFORMAL(2, "semiformal", "semiformal"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	FORMAL(3, "formal", "formal"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final int SEMIFORMAL_VALUE = 2;
	 ...
	 * @ordered
	 */
	public static final int FORMAL_VALUE = 3;
	...
	public static ConsistencyLevel get(int value) {
		switch (value) {
			...
			case SEMIFORMAL_VALUE: return SEMIFORMAL;
