 ...
 * <!-- end-user-doc -->
 * @see net.certware.evidence.evidence.EvidencePackage#getLevel()
 * @model
 * @generated
 */
public enum Level implements Enumerator {
	 ...
	 * @ordered
	 */
	MEDIUM_LOW(2, "mediumLow", "mediumLow"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	MEDIUM_HIGH(4, "mediumHigh", "mediumHigh"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	HIGH(5, "high", "high"); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public static Level get(int value) {
		switch (value) {
			...
			case MEDIUM_LOW_VALUE: return MEDIUM_LOW;
			case MEDIUM_VALUE: return MEDIUM;
			case MEDIUM_HIGH_VALUE: return MEDIUM_HIGH;
