 ...
 * <!-- end-user-doc -->
 * @see net.certware.evidence.evidence.EvidencePackage#getOriginalityLevel()
 * @model
 * @generated
 */
public enum OriginalityLevel implements Enumerator {
	 ...
	 * @ordered
	 */
	DERIVATIVE(1, "derivative", "derivative"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	ORIGINAL(2, "original", "original"); //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	public static final int DERIVATIVE_VALUE = 1;
