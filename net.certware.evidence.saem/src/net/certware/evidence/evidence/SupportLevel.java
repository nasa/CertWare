 ...
 * <!-- end-user-doc -->
 * @see net.certware.evidence.evidence.EvidencePackage#getSupportLevel()
 * @model
 * @generated
 */
public enum SupportLevel implements Enumerator {
	 ...
	 * @ordered
	 */
	INDIRECT(1, "indirect", "indirect"), //$NON-NLS-1$ //$NON-NLS-2$
	 ...
	 * @ordered
	 */
	DIRECT(2, "direct", "direct"); //$NON-NLS-1$ //$NON-NLS-2$
