 ...
 * <ul>
 *   <li>{@link net.certware.evidence.evidence.impl.EvidenceItemImpl#getEvent <em>Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class EvidenceItemImpl extends EvidenceElementImpl implements EvidenceItem {
	/**
	...
	protected EClass eStaticClass() {
		return EvidencePackage.Literals.EVIDENCE_ITEM;
	}
	...
	public EList<EvidenceEvent> getEvent() {
		if (event == null) {
			event = new EObjectContainmentEList<EvidenceEvent>(EvidenceEvent.class, this, EvidencePackage.EVIDENCE_ITEM__EVENT);
		}
		return event;
	}
