 ...
 * <ul>
 *   <li>{@link net.certware.evidence.evidence.impl.HasRoleInImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.certware.evidence.evidence.impl.HasRoleInImpl#getOrganization <em>Organization</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HasRoleInImpl extends EvidencePropertyImpl implements HasRoleIn {
	/**
