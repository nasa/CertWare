 ...
 * <ul>
 *   <li>{@link net.certware.evidence.evidence.impl.RationaleImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RationaleImpl extends ElementImpl implements Rationale {
	/**
	...
	protected EClass eStaticClass() {
		return EvidencePackage.Literals.RATIONALE;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvidencePackage.RATIONALE__TEXT, oldText, text));
	}
