 ...
 * "pat". If a sample multi-page editor (also available
...
public class PatternWizard extends Wizard implements INewWizard {
	...
	private InputStream openContentStream() {
		String contents =
			"This is the initial file contents for *.pat file that should be word-sorted in the Preview page of the multi-page editor";
