 ...
 * <ul>
 *   <li>{@link net.certware.hazard.hazard.impl.ReferenceImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceImpl extends EObjectImpl implements Reference {
	...
	protected EClass eStaticClass() {
		return HazardPackage.Literals.REFERENCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HazardPackage.REFERENCE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HazardPackage.REFERENCE__NAME:
				return getName();
		}
