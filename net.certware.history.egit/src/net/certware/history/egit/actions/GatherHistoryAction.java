...
/**
 * An action to gather statistics from the repository and create an SCO file.
 * Presumes the history is provided by a Git team provider and uses the {@code GatherHistory} class for processing.
 * @author mrb
 * @since 1.1.0
 */
public class GatherHistoryAction implements IObjectActionDelegate {
