 ...
 * @since 2.0.1
 */
public class NewIntentStateFileWizard extends Wizard implements INewWizard {
	/** initial selection, presumably a container */
	private IStructuredSelection selection;
	/** wizard page for file specifics */
	private NewIntentStateFileWizardPage newFileWizardPage;
	 ...
	 */
	public NewIntentStateFileWizard() {
		setWindowTitle("New Intent Specification State Model File");
	...
	public void addPages() {
		newFileWizardPage = new NewIntentStateFileWizardPage(selection);
