...
public interface StateValue extends EObject
{
   ...
   * @see #setValue(String)
   * @see net.certware.intent.state.stateSpecification.StateSpecificationPackage#getStateValue_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link net.certware.intent.state.stateSpecification.StateValue#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
