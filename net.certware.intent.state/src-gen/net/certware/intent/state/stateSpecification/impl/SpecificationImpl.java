...
public class SpecificationImpl extends MinimalEObjectImpl.Container implements Specification
{
  ...
  {
    return StateSpecificationPackage.Literals.SPECIFICATION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StateSpecificationPackage.SPECIFICATION__NAME, oldName, name));
  }
  ...
  public EList<Device> getDevices()
  {
    if (devices == null)
    {
      devices = new EObjectContainmentEList<Device>(Device.class, this, StateSpecificationPackage.SPECIFICATION__DEVICES);
    }
    return devices;
  }
  ...
  public EList<Component> getComponents()
  {
    if (components == null)
    {
      components = new EObjectContainmentEList<Component>(Component.class, this, StateSpecificationPackage.SPECIFICATION__COMPONENTS);
    }
    return components;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case StateSpecificationPackage.SPECIFICATION__DEVICES:
        return ((InternalEList<?>)getDevices()).basicRemove(otherEnd, msgs);
      case StateSpecificationPackage.SPECIFICATION__COMPONENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case StateSpecificationPackage.SPECIFICATION__NAME:
        return getName();
      case StateSpecificationPackage.SPECIFICATION__DEVICES:
        return getDevices();
      case StateSpecificationPackage.SPECIFICATION__COMPONENTS:
