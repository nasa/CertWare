...
public class StateVariableImpl extends MinimalEObjectImpl.Container implements StateVariable
{
  ...
  {
    return StateSpecificationPackage.Literals.STATE_VARIABLE;
  }
  ...
  public void setDesc(String newDesc)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StateSpecificationPackage.STATE_VARIABLE__DESC, oldDesc, desc));
  }
  ...
  public EList<State> getState()
  {
    if (state == null)
    {
      state = new EObjectContainmentEList<State>(State.class, this, StateSpecificationPackage.STATE_VARIABLE__STATE);
    }
    return state;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case StateSpecificationPackage.STATE_VARIABLE__STATE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case StateSpecificationPackage.STATE_VARIABLE__DESC:
        return getDesc();
      case StateSpecificationPackage.STATE_VARIABLE__STATE:
        return getState();
    }
