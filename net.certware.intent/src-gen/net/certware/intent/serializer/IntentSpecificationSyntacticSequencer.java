...
public class IntentSpecificationSyntacticSequencer extends AbstractSyntacticSequencer {
	 ...
	 *     desc=STRING (ambiguity) '[' models+=ModelItem
	 *     desc=STRING (ambiguity) ('[' ']')? '(' items+=ListItem
	 ...
	 * This ambiguous syntax occurs at:
	 *     desc=STRING ('{' '}')? ('[' ']')? (ambiguity) (rule end)
	 *     documents+=Document '}' ('[' ']')? (ambiguity) (rule end)
	 *     models+=ModelItem ']' (ambiguity) (rule end)
	 */
	 ...
	 *     desc=STRING ('{' '}')? (ambiguity) '(' items+=ListItem
	 *     desc=STRING ('{' '}')? (ambiguity) ('(' ')')? (rule end)
	 *     documents+=Document '}' (ambiguity) '(' items+=ListItem
	 *     documents+=Document '}' (ambiguity) ('(' ')')? (rule end)
	 */
