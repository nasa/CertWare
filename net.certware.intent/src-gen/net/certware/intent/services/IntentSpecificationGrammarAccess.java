...
public class IntentSpecificationGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class SpecificationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.Specification");
	...
	public class RefinementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.Refinement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IntentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.Intent");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IntentTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.IntentType");
	...
	public class DecompositionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.Decomposition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cTypeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		...
		//	name=ID
		//	desc=STRING ('{' documents+=Document* '}')? ('[' models+=ModelItem* ']')? ('(' items+=ListItem* ')')?;
		@Override public ParserRule getRule() { return rule; }
	...
	public class DecompositionTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.DecompositionType");
		private final Assignment cTypeNameAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cTypeNameAlternatives_0 = (Alternatives)cTypeNameAssignment.eContents().get(0);
	...
	public class DocumentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.Document");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DocItemTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.DocItemType");
		private final Assignment cTypeNameAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cTypeNameAlternatives_0 = (Alternatives)cTypeNameAssignment.eContents().get(0);
	...
	public class DocItemElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.DocItem");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cTypeAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class ModelTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.ModelType");
		private final Assignment cTypeNameAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cTypeNameAlternatives_0 = (Alternatives)cTypeNameAssignment.eContents().get(0);
	...
	public class ModelItemElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.ModelItem");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cTypeAssignment_0 = (Assignment)cGroup.eContents().get(0);
	...
	public class ListItemTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.ListItemType");
		private final Assignment cTypeNameAssignment = (Assignment)rule.eContents().get(1);
		private final Alternatives cTypeNameAlternatives_0 = (Alternatives)cTypeNameAssignment.eContents().get(0);
	...
	public class ListItemElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "net.certware.intent.IntentSpecification.ListItem");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cTypeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		...
		//	type=ListItemType
		//	name=ID
		//	desc=STRING ('{' docReferences+=[DocItem]+ '}')? ('(' itemReferences+=[ListItem]+ ')')? ('['
	...
	private final IntentTypeElements pIntentType;
	private final DecompositionElements pDecomposition;
	private final DecompositionTypeElements pDecompositionType;
	private final DocumentElements pDocument;
	private final DocItemTypeElements pDocItemType;
	private final DocItemElements pDocItem;
	private final ModelTypeElements pModelType;
	private final ModelItemElements pModelItem;
	private final ListItemTypeElements pListItemType;
	...
	public IntentSpecificationGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pIntentType = new IntentTypeElements();
		this.pDecomposition = new DecompositionElements();
		this.pDecompositionType = new DecompositionTypeElements();
		this.pDocument = new DocumentElements();
		this.pDocItemType = new DocItemTypeElements();
		this.pDocItem = new DocItemElements();
		this.pModelType = new ModelTypeElements();
		this.pModelItem = new ModelItemElements();
		this.pListItemType = new ListItemTypeElements();
