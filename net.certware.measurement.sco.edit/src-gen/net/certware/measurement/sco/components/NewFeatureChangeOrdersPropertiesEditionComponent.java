...
public class NewFeatureChangeOrdersPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, newFeatureChangeOrders.getName()));
			
			if (isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.value)) {
				basePart.setValue(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, newFeatureChangeOrders.getValue()));
			}
			
			if (isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.type)) {
				basePart.initType(EEFUtils.choiceOfValues(newFeatureChangeOrders, ScoPackage.eINSTANCE.getChangeOrderCount_Type()), newFeatureChangeOrders.getType());
			}
			if (isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.brokenLines)) {
				basePart.setBrokenLines(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, newFeatureChangeOrders.getBrokenLines()));
			}
			
			if (isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.fixedLines)) {
				basePart.setFixedLines(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, newFeatureChangeOrders.getFixedLines()));
			}
			
			if (isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.repairEffort)) {
				basePart.setRepairEffort(EEFConverterUtil.convertToString(EcorePackage.Literals.EDOUBLE, newFeatureChangeOrders.getRepairEffort()));
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (ScoViewsRepository.NewFeatureChangeOrders.Properties.name == event.getAffectedEditor()) {
			newFeatureChangeOrders.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (ScoViewsRepository.NewFeatureChangeOrders.Properties.value == event.getAffectedEditor()) {
			newFeatureChangeOrders.setValue((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		...
		if (ScoViewsRepository.NewFeatureChangeOrders.Properties.brokenLines == event.getAffectedEditor()) {
			newFeatureChangeOrders.setBrokenLines((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (ScoViewsRepository.NewFeatureChangeOrders.Properties.fixedLines == event.getAffectedEditor()) {
			newFeatureChangeOrders.setFixedLines((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (ScoViewsRepository.NewFeatureChangeOrders.Properties.repairEffort == event.getAffectedEditor()) {
			newFeatureChangeOrders.setRepairEffort((EEFConverterUtil.createDoubleFromString(EcorePackage.Literals.EDOUBLE, (String)event.getNewValue())));
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (ScoPackage.eINSTANCE.getChangeOrderCount_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.name)) {
			...
			if (ScoPackage.eINSTANCE.getChangeOrderCount_Value().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.value)) {
				if (msg.getNewValue() != null) {
			...
			if (ScoPackage.eINSTANCE.getChangeOrderCount_Type().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.type))
				basePart.setType((ChangeOrderType)msg.getNewValue());
			
			if (ScoPackage.eINSTANCE.getChangeOrderCount_BrokenLines().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.brokenLines)) {
				if (msg.getNewValue() != null) {
			...
			if (ScoPackage.eINSTANCE.getChangeOrderCount_FixedLines().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.fixedLines)) {
				if (msg.getNewValue() != null) {
			...
			if (ScoPackage.eINSTANCE.getChangeOrderCount_RepairEffort().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(ScoViewsRepository.NewFeatureChangeOrders.Properties.repairEffort)) {
				if (msg.getNewValue() != null) {
