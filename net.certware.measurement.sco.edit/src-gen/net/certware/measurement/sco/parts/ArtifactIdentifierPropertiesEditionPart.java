...
public interface ArtifactIdentifierPropertiesEditionPart {
	...
	/**
	 * Defines a new resourceName
	 * @param newValue the new resourceName to set
	 * 
	 */
	...
	/**
	 * @return the baselinedLineCount
	 * 
	 */
	public String getBaselinedLineCount();

	/**
	 * Defines a new baselinedLineCount
	 * @param newValue the new baselinedLineCount to set
	 * 
	 */
	...
	/**
	 * Defines a new currentLineCount
	 * @param newValue the new currentLineCount to set
	 * 
	 */
