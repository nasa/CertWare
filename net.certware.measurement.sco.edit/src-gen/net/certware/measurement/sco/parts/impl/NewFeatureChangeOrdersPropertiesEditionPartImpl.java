...
public class NewFeatureChangeOrdersPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, NewFeatureChangeOrdersPropertiesEditionPart {
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, ScoMessages.NewFeatureChangeOrdersPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(ScoViewsRepository.NewFeatureChangeOrders.name, ScoViewsRepository.SWT_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NewFeatureChangeOrdersPropertiesEditionPartImpl.this, ScoViewsRepository.NewFeatureChangeOrders.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ScoViewsRepository.NewFeatureChangeOrders.name, ScoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createValueText(Composite parent) {
		SWTUtils.createPartLabel(parent, ScoMessages.NewFeatureChangeOrdersPropertiesEditionPart_ValueLabel, propertiesEditionComponent.isRequired(ScoViewsRepository.NewFeatureChangeOrders.value, ScoViewsRepository.SWT_KIND));
		...
		value.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NewFeatureChangeOrdersPropertiesEditionPartImpl.this, ScoViewsRepository.NewFeatureChangeOrders.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, value.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ScoViewsRepository.NewFeatureChangeOrders.value, ScoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createTypeEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, ScoMessages.NewFeatureChangeOrdersPropertiesEditionPart_TypeLabel, propertiesEditionComponent.isRequired(ScoViewsRepository.NewFeatureChangeOrders.type, ScoViewsRepository.SWT_KIND));
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ScoViewsRepository.NewFeatureChangeOrders.type, ScoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createBrokenLinesText(Composite parent) {
		SWTUtils.createPartLabel(parent, ScoMessages.NewFeatureChangeOrdersPropertiesEditionPart_BrokenLinesLabel, propertiesEditionComponent.isRequired(ScoViewsRepository.NewFeatureChangeOrders.brokenLines, ScoViewsRepository.SWT_KIND));
		...
		brokenLines.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NewFeatureChangeOrdersPropertiesEditionPartImpl.this, ScoViewsRepository.NewFeatureChangeOrders.brokenLines, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, brokenLines.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ScoViewsRepository.NewFeatureChangeOrders.brokenLines, ScoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createFixedLinesText(Composite parent) {
		SWTUtils.createPartLabel(parent, ScoMessages.NewFeatureChangeOrdersPropertiesEditionPart_FixedLinesLabel, propertiesEditionComponent.isRequired(ScoViewsRepository.NewFeatureChangeOrders.fixedLines, ScoViewsRepository.SWT_KIND));
		...
		fixedLines.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NewFeatureChangeOrdersPropertiesEditionPartImpl.this, ScoViewsRepository.NewFeatureChangeOrders.fixedLines, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, fixedLines.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ScoViewsRepository.NewFeatureChangeOrders.fixedLines, ScoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	
	protected void createRepairEffortText(Composite parent) {
		SWTUtils.createPartLabel(parent, ScoMessages.NewFeatureChangeOrdersPropertiesEditionPart_RepairEffortLabel, propertiesEditionComponent.isRequired(ScoViewsRepository.NewFeatureChangeOrders.repairEffort, ScoViewsRepository.SWT_KIND));
		...
		repairEffort.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NewFeatureChangeOrdersPropertiesEditionPartImpl.this, ScoViewsRepository.NewFeatureChangeOrders.repairEffort, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, repairEffort.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ScoViewsRepository.NewFeatureChangeOrders.repairEffort, ScoViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
