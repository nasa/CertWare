...
import net.certware.measurement.sco.util.ScoResourceFactoryImpl;
...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>sco</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class ScoExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new ScoResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(ScoPackage.eNS_URI, 
			 ScoPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.sco")); //$NON-NLS-1$
				TotalChangeOrders root = ScoFactory.eINSTANCE.createTotalChangeOrders();
