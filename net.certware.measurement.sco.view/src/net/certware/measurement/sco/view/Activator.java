...
public class Activator extends AbstractUIPlugin implements BundleActivator {
	...
	public static String PLUGIN_ID = "net.certware.measurement.sco.view"; //$NON-NLS-1$
	...
	public static final String SCO_IMAGE = "sco.image"; //$NON-NLS-1$
    ...
    protected void initializeImageRegistry(ImageRegistry registry) {
        ...
        initializeImage(registry,bundle,"icons/obj16/sco.gif",SCO_IMAGE);
