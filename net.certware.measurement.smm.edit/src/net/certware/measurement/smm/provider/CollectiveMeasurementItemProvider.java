...
public class CollectiveMeasurementItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SmmPackage.Literals.COLLECTIVE_MEASUREMENT__ACCUMULATOR);
			childrenFeatures.add(SmmPackage.Literals.COLLECTIVE_MEASUREMENT__BASE_MEASUREMENT);
		}
