...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.smm.RatioMeasure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RatioMeasureItemProvider
	 ...
	 * @generated
	 */
	public RatioMeasureItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RatioMeasure")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((RatioMeasure)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RatioMeasure_type") : //$NON-NLS-1$
			getString("_UI_RatioMeasure_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
