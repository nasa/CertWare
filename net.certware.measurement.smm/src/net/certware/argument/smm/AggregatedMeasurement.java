 ...
 * <ul>
 *   <li>{@link net.certware.argument.smm.AggregatedMeasurement#isIsBaseSuppled <em>Is Base Suppled</em>}</li>
 *   <li>{@link net.certware.argument.smm.AggregatedMeasurement#getBaseMeasurement <em>Base Measurement</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.argument.smm.SmmPackage#getAggregatedMeasurement()
 * @model
 * @generated
 */
public interface AggregatedMeasurement extends DimensionalMeasurement {
	 ...
	 * @see net.certware.argument.smm.SmmPackage#getAggregatedMeasurement_IsBaseSuppled()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.smm.AggregatedMeasurement#isIsBaseSuppled <em>Is Base Suppled</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.certware.argument.smm.SmmPackage#getAggregatedMeasurement_BaseMeasurement()
	 * @model
	 * @generated
	 */
