 ...
 * <ul>
 *   <li>{@link net.certware.argument.smm.BinaryMeasure#getFunctor <em>Functor</em>}</li>
 *   <li>{@link net.certware.argument.smm.BinaryMeasure#getBaseMeasure1 <em>Base Measure1</em>}</li>
 *   <li>{@link net.certware.argument.smm.BinaryMeasure#getBaseMeasure2 <em>Base Measure2</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.argument.smm.SmmPackage#getBinaryMeasure()
 * @model
 * @generated
 */
public interface BinaryMeasure extends DimensionalMeasure {
	 ...
	 * @see net.certware.argument.smm.SmmPackage#getBinaryMeasure_Functor()
	 * @model required="true"
	 * @generated
	 */
	String getFunctor();
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.smm.BinaryMeasure#getFunctor <em>Functor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.certware.argument.smm.SmmPackage#getBinaryMeasure_BaseMeasure1()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.smm.BinaryMeasure#getBaseMeasure1 <em>Base Measure1</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.certware.argument.smm.SmmPackage#getBinaryMeasure_BaseMeasure2()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.smm.BinaryMeasure#getBaseMeasure2 <em>Base Measure2</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
