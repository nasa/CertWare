 ...
 * <ul>
 *   <li>{@link net.certware.argument.smm.Grade#getBaseMeasurement <em>Base Measurement</em>}</li>
 *   <li>{@link net.certware.argument.smm.Grade#isIsBaseSupplied <em>Is Base Supplied</em>}</li>
 *   <li>{@link net.certware.argument.smm.Grade#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.argument.smm.SmmPackage#getGrade()
 * @model
 * @generated
 */
public interface Grade extends Measurement {
	 ...
	 * @see net.certware.argument.smm.SmmPackage#getGrade_BaseMeasurement()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.smm.Grade#getBaseMeasurement <em>Base Measurement</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.certware.argument.smm.SmmPackage#getGrade_IsBaseSupplied()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.smm.Grade#isIsBaseSupplied <em>Is Base Supplied</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setValue(String)
	 * @see net.certware.argument.smm.SmmPackage#getGrade_Value()
	 * @model
	 * @generated
	 */
	String getValue();
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.smm.Grade#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
