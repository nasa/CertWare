 ...
 * <ul>
 *   <li>{@link net.certware.argument.smm.Observation#getObserver <em>Observer</em>}</li>
 *   <li>{@link net.certware.argument.smm.Observation#getTool <em>Tool</em>}</li>
 *   <li>{@link net.certware.argument.smm.Observation#getWhenObserved <em>When Observed</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.argument.smm.SmmPackage#getObservation()
 * @model
 * @generated
 */
public interface Observation extends SmmElement {
	 ...
	 * @see net.certware.argument.smm.SmmPackage#getObservation_Observer()
	 * @model
	 * @generated
	 */
	String getObserver();
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.smm.Observation#getObserver <em>Observer</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTool(String)
	 * @see net.certware.argument.smm.SmmPackage#getObservation_Tool()
	 * @model
	 * @generated
	 */
	String getTool();
	...
	/**
	 * Sets the value of the '{@link net.certware.argument.smm.Observation#getTool <em>Tool</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.certware.argument.smm.SmmPackage#getObservation_WhenObserved()
	 * @model dataType="net.certware.argument.smm.Date"
	 * @generated
	 */
	Date getWhenObserved();

	/**
	 * Sets the value of the '{@link net.certware.argument.smm.Observation#getWhenObserved <em>When Observed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
