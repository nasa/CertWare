 ...
 * <ul>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getLibrary <em>Library</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getEquivalentFrom <em>Equivalent From</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getEquivalentTo <em>Equivalent To</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getRefinement <em>Refinement</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getMeasurement <em>Measurement</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getOutMeasure <em>Out Measure</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getInMeasure <em>In Measure</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getTrait <em>Trait</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasureImpl#getScope <em>Scope</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
