 ...
 * <ul>
 *   <li>{@link net.certware.argument.smm.impl.MeasurementImpl#getMeasure <em>Measure</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasurementImpl#getObservation <em>Observation</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasurementImpl#getError <em>Error</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasurementImpl#getOutMeasurement <em>Out Measurement</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.MeasurementImpl#getInMeasurement <em>In Measurement</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
