 ...
 * <ul>
 *   <li>{@link net.certware.argument.smm.impl.RankingIntervalImpl#getRank <em>Rank</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.RankingIntervalImpl#getMaximumEndpoint <em>Maximum Endpoint</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.RankingIntervalImpl#isMaximumOpen <em>Maximum Open</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.RankingIntervalImpl#getMinimumEndpoint <em>Minimum Endpoint</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.RankingIntervalImpl#isMinimumOpen <em>Minimum Open</em>}</li>
 *   <li>{@link net.certware.argument.smm.impl.RankingIntervalImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
