...
import net.certware.measurement.smm.provider.CollectiveMeasureItemProvider;
...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.spm.AdditiveMeasure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AdditiveMeasureItemProvider
	extends CollectiveMeasureItemProvider
	implements
	 ...
	 * @generated
	 */
	public AdditiveMeasureItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns AdditiveMeasure.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AdditiveMeasure")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((AdditiveMeasure)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AdditiveMeasure_type") : //$NON-NLS-1$
			getString("_UI_AdditiveMeasure_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
