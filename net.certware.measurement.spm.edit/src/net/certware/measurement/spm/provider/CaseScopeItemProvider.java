...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.spm.CaseScope} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CaseScopeItemProvider
	 ...
	 * @generated
	 */
	public CaseScopeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CaseScope")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((CaseScope)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CaseScope_type") : //$NON-NLS-1$
			getString("_UI_CaseScope_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
