...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.spm.ChangeScope} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChangeScopeItemProvider
	 ...
	 * @generated
	 */
	public ChangeScopeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ChangeScope")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ChangeScope)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ChangeScope_type") : //$NON-NLS-1$
			getString("_UI_ChangeScope_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
