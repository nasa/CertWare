...
import net.certware.measurement.smm.provider.BinaryMeasureItemProvider;
...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.spm.CriticalAndNormalChangeOrderCount} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CriticalAndNormalChangeOrderCountItemProvider
	extends BinaryMeasureItemProvider
	implements
	 ...
	 * @generated
	 */
	public CriticalAndNormalChangeOrderCountItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns CriticalAndNormalChangeOrderCount.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CriticalAndNormalChangeOrderCount")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((CriticalAndNormalChangeOrderCount)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CriticalAndNormalChangeOrderCount_type") : //$NON-NLS-1$
			getString("_UI_CriticalAndNormalChangeOrderCount_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
