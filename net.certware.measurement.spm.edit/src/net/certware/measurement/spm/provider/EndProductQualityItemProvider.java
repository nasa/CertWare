...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.spm.EndProductQuality} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EndProductQualityItemProvider
	 ...
	 * @generated
	 */
	public EndProductQualityItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns EndProductQuality.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EndProductQuality")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((EndProductQuality)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EndProductQuality_type") : //$NON-NLS-1$
			getString("_UI_EndProductQuality_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
