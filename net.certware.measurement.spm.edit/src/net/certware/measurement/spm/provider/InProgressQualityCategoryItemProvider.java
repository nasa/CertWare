...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.spm.InProgressQualityCategory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InProgressQualityCategoryItemProvider
	 ...
	 * @generated
	 */
	public InProgressQualityCategoryItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns InProgressQualityCategory.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InProgressQualityCategory")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((InProgressQualityCategory)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_InProgressQualityCategory_type") : //$NON-NLS-1$
			getString("_UI_InProgressQualityCategory_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
