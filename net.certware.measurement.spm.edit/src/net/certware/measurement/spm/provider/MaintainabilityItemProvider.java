...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.spm.Maintainability} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MaintainabilityItemProvider
	 ...
	 * @generated
	 */
	public MaintainabilityItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns Maintainability.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Maintainability")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((Maintainability)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Maintainability_type") : //$NON-NLS-1$
			getString("_UI_Maintainability_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
