...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.spm.ProjectSize} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectSizeItemProvider
	 ...
	 * @generated
	 */
	public ProjectSizeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProjectSize")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((ProjectSize)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ProjectSize_type") : //$NON-NLS-1$
			getString("_UI_ProjectSize_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
