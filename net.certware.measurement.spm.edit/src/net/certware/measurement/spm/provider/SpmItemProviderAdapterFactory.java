...
public class SpmItemProviderAdapterFactory extends SpmAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * A child creation extender for the {@link SmmPackage}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static class SmmChildCreationExtender implements IChildCreationExtender {
		/**
		 ...
		 * @generated
		 */
		protected static class CreationSwitch extends SmmSwitch<Object> {
			/**
			 ...
			 */
			@Override
			public Object caseSmmModel(SmmModel object) {
