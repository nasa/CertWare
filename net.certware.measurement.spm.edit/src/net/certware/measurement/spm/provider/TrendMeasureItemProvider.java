...
/**
 * This is the item provider adapter for a {@link net.certware.measurement.spm.TrendMeasure} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TrendMeasureItemProvider
	 ...
	 * @generated
	 */
	public TrendMeasureItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TrendMeasure")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((TrendMeasure)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TrendMeasure_type") : //$NON-NLS-1$
			getString("_UI_TrendMeasure_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
