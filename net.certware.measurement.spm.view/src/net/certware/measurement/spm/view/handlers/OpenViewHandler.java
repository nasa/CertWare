...
public class OpenViewHandler extends AbstractHandler {
	...
	static private final String PROJECT_VIEW_ID = "net.certware.measurement.spm.view.detailsview"; //$NON-NLS-1$
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			if ( structured.getFirstElement() instanceof IFile) {
				...
				SpmViewMasterDetails view = (SpmViewMasterDetails)viewPart;
