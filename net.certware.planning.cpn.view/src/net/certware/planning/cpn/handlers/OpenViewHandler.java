...
public class OpenViewHandler extends AbstractHandler {
	...
	static private final String PROJECT_VIEW_ID = "net.certware.planning.cpn.view.masterdetailsview"; //$NON-NLS-1$
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			if ( structured.getFirstElement() instanceof IFile) {
				...
				CpnViewMasterDetails view = (CpnViewMasterDetails)viewPart;
				view.setSelectedFile(ifile);
			}
		} catch (PartInitException e) {
			CertWareLog.logError("Opening CPN view", e);
