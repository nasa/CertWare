...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Baseline For Earned Value Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getBaselineForEarnedValueType()
 * @model extendedMetaData="name='BaselineForEarnedValue_._type'"
 * @generated
 */
public enum BaselineForEarnedValueType implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int _9_VALUE = 9;
	 ...
	 * @ordered
	 */
	public static final int _10_VALUE = 10;

	/**
	 * An array of all the '<em><b>Baseline For Earned Value Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final BaselineForEarnedValueType[] VALUES_ARRAY =
		new BaselineForEarnedValueType[] {
			_0,
			_1,
			_2,
			_3,
	...
	/**
	 * A public read-only list of all the '<em><b>Baseline For Earned Value Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<BaselineForEarnedValueType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Baseline For Earned Value Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static BaselineForEarnedValueType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BaselineForEarnedValueType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Baseline For Earned Value Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static BaselineForEarnedValueType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BaselineForEarnedValueType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Baseline For Earned Value Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static BaselineForEarnedValueType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private BaselineForEarnedValueType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
