...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Constraint Type Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getConstraintTypeType()
 * @model extendedMetaData="name='ConstraintType_._type'"
 * @generated
 */
public enum ConstraintTypeType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Constraint Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ConstraintTypeType[] VALUES_ARRAY =
		new ConstraintTypeType[] {
			_0,
			_1,
			_2,
			_3,
	...
	/**
	 * A public read-only list of all the '<em><b>Constraint Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ConstraintTypeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Constraint Type Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConstraintTypeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConstraintTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Constraint Type Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConstraintTypeType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ConstraintTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Constraint Type Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static ConstraintTypeType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ConstraintTypeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
