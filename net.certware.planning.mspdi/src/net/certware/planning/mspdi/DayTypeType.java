...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Day Type Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getDayTypeType()
 * @model extendedMetaData="name='DayType_._type'"
 * @generated
 */
public enum DayTypeType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Day Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DayTypeType[] VALUES_ARRAY =
		new DayTypeType[] {
			_0,
			_1,
			_2,
	...
	/**
	 * A public read-only list of all the '<em><b>Day Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DayTypeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Day Type Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DayTypeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DayTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Day Type Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DayTypeType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DayTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Day Type Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DayTypeType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DayTypeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
