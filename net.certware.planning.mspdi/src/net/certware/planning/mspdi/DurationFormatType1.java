...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Duration Format Type1</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getDurationFormatType1()
 * @model extendedMetaData="name='DurationFormat_._1_._type'"
 * @generated
 */
public enum DurationFormatType1 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Duration Format Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DurationFormatType1[] VALUES_ARRAY =
		new DurationFormatType1[] {
			_3,
			_4,
			_5,
			_6,
	...
	/**
	 * A public read-only list of all the '<em><b>Duration Format Type1</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DurationFormatType1> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Duration Format Type1</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DurationFormatType1 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DurationFormatType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Duration Format Type1</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DurationFormatType1 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DurationFormatType1 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Duration Format Type1</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DurationFormatType1 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DurationFormatType1(int value, String name, String literal) {
		this.value = value;
		this.name = name;
