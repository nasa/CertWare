...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Duration Format Type2</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getDurationFormatType2()
 * @model extendedMetaData="name='DurationFormat_._2_._type'"
 * @generated
 */
public enum DurationFormatType2 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Duration Format Type2</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DurationFormatType2[] VALUES_ARRAY =
		new DurationFormatType2[] {
			_3,
			_4,
			_5,
			_6,
	...
	/**
	 * A public read-only list of all the '<em><b>Duration Format Type2</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DurationFormatType2> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Duration Format Type2</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DurationFormatType2 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DurationFormatType2 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Duration Format Type2</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DurationFormatType2 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DurationFormatType2 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Duration Format Type2</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DurationFormatType2 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DurationFormatType2(int value, String name, String literal) {
		this.value = value;
		this.name = name;
