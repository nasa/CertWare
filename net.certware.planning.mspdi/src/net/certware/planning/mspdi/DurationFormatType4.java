...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Duration Format Type4</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getDurationFormatType4()
 * @model extendedMetaData="name='DurationFormat_._4_._type'"
 * @generated
 */
public enum DurationFormatType4 implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Duration Format Type4</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final DurationFormatType4[] VALUES_ARRAY =
		new DurationFormatType4[] {
			_3,
			_4,
			_5,
			_6,
	...
	/**
	 * A public read-only list of all the '<em><b>Duration Format Type4</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<DurationFormatType4> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Duration Format Type4</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DurationFormatType4 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DurationFormatType4 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Duration Format Type4</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DurationFormatType4 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			DurationFormatType4 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Duration Format Type4</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static DurationFormatType4 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private DurationFormatType4(int value, String name, String literal) {
		this.value = value;
		this.name = name;
