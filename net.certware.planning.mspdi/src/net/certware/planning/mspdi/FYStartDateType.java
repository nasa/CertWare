...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>FY Start Date Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getFYStartDateType()
 * @model extendedMetaData="name='FYStartDate_._type'"
 * @generated
 */
public enum FYStartDateType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>FY Start Date Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final FYStartDateType[] VALUES_ARRAY =
		new FYStartDateType[] {
			_1,
			_2,
			_3,
	...
	/**
	 * A public read-only list of all the '<em><b>FY Start Date Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FYStartDateType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>FY Start Date Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static FYStartDateType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FYStartDateType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>FY Start Date Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static FYStartDateType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FYStartDateType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>FY Start Date Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static FYStartDateType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FYStartDateType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
