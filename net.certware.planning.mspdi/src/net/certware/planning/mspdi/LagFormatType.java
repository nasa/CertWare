...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Lag Format Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getLagFormatType()
 * @model extendedMetaData="name='LagFormat_._type'"
 * @generated
 */
public enum LagFormatType implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int _35_VALUE = 12;
	 ...
	 * @ordered
	 */
	public static final int _36_VALUE = 13;
	 ...
	 * @ordered
	 */
	public static final int _37_VALUE = 14;
	 ...
	 * @ordered
	 */
	public static final int _38_VALUE = 15;
	 ...
	 * @ordered
	 */
	public static final int _39_VALUE = 16;
	 ...
	 * @ordered
	 */
	public static final int _40_VALUE = 17;
	 ...
	 * @ordered
	 */
	public static final int _41_VALUE = 18;
	 ...
	 * @ordered
	 */
	public static final int _42_VALUE = 19;
	 ...
	 * @ordered
	 */
	public static final int _43_VALUE = 20;
	 ...
	 * @ordered
	 */
	public static final int _44_VALUE = 21;
	 ...
	 * @ordered
	 */
	public static final int _51_VALUE = 22;
	 ...
	 * @ordered
	 */
	public static final int _52_VALUE = 23;
	 ...
	 * @ordered
	 */
	public static final int _53_VALUE = 24;

	/**
	 * An array of all the '<em><b>Lag Format Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final LagFormatType[] VALUES_ARRAY =
		new LagFormatType[] {
			_3,
			_4,
			_5,
	...
	/**
	 * A public read-only list of all the '<em><b>Lag Format Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<LagFormatType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Lag Format Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static LagFormatType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			LagFormatType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Lag Format Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static LagFormatType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			LagFormatType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Lag Format Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static LagFormatType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private LagFormatType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
