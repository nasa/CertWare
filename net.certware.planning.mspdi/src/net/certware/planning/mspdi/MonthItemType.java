...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Month Item Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getMonthItemType()
 * @model extendedMetaData="name='MonthItem_._type'"
 * @generated
 */
public enum MonthItemType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Month Item Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final MonthItemType[] VALUES_ARRAY =
		new MonthItemType[] {
			_0,
			_1,
			_2,
	...
	/**
	 * A public read-only list of all the '<em><b>Month Item Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<MonthItemType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Month Item Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static MonthItemType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MonthItemType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Month Item Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static MonthItemType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			MonthItemType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Month Item Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static MonthItemType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private MonthItemType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
