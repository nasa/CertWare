...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Outline Code Type1</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link net.certware.planning.mspdi.OutlineCodeType1#getFieldID <em>Field ID</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.OutlineCodeType1#getValueID <em>Value ID</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.OutlineCodeType1#getValueGUID <em>Value GUID</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.planning.mspdi.MspdiPackage#getOutlineCodeType1()
 * @model extendedMetaData="name='OutlineCode_._1_._type' kind='elementOnly'"
 * @generated
 */
public interface OutlineCodeType1 extends EObject {
	/**
	 ...
	 * @see net.certware.planning.mspdi.MspdiPackage#getOutlineCodeType1_FieldID()
	...
	/**
	 * Sets the value of the '{@link net.certware.planning.mspdi.OutlineCodeType1#getFieldID <em>Field ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.certware.planning.mspdi.MspdiPackage#getOutlineCodeType1_ValueID()
	...
	/**
	 * Sets the value of the '{@link net.certware.planning.mspdi.OutlineCodeType1#getValueID <em>Value ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.certware.planning.mspdi.MspdiPackage#getOutlineCodeType1_ValueGUID()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.Integer"
	...
	/**
	 * Sets the value of the '{@link net.certware.planning.mspdi.OutlineCodeType1#getValueGUID <em>Value GUID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
