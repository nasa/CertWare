...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Rollup Type Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getRollupTypeType()
 * @model extendedMetaData="name='RollupType_._type'"
 * @generated
 */
public enum RollupTypeType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Rollup Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final RollupTypeType[] VALUES_ARRAY =
		new RollupTypeType[] {
			_0,
			_1,
			_2,
	...
	/**
	 * A public read-only list of all the '<em><b>Rollup Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<RollupTypeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Rollup Type Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RollupTypeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RollupTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Rollup Type Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RollupTypeType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			RollupTypeType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Rollup Type Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static RollupTypeType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private RollupTypeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
