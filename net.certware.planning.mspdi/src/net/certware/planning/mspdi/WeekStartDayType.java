...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Week Start Day Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getWeekStartDayType()
 * @model extendedMetaData="name='WeekStartDay_._type'"
 * @generated
 */
public enum WeekStartDayType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Week Start Day Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final WeekStartDayType[] VALUES_ARRAY =
		new WeekStartDayType[] {
			_0,
			_1,
			_2,
			_3,
	...
	/**
	 * A public read-only list of all the '<em><b>Week Start Day Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<WeekStartDayType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Week Start Day Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static WeekStartDayType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			WeekStartDayType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Week Start Day Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static WeekStartDayType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			WeekStartDayType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Week Start Day Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static WeekStartDayType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private WeekStartDayType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
