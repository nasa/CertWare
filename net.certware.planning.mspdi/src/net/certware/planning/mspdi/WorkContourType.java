...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Work Contour Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.certware.planning.mspdi.MspdiPackage#getWorkContourType()
 * @model extendedMetaData="name='WorkContour_._type'"
 * @generated
 */
public enum WorkContourType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Work Contour Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final WorkContourType[] VALUES_ARRAY =
		new WorkContourType[] {
			_0,
			_1,
			_2,
	...
	/**
	 * A public read-only list of all the '<em><b>Work Contour Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<WorkContourType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Work Contour Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static WorkContourType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			WorkContourType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Work Contour Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static WorkContourType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			WorkContourType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Work Contour Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static WorkContourType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private WorkContourType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
