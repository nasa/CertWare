...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Working Time Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link net.certware.planning.mspdi.WorkingTimeType#getFromTime <em>From Time</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.WorkingTimeType#getToTime <em>To Time</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.certware.planning.mspdi.MspdiPackage#getWorkingTimeType()
 * @model extendedMetaData="name='WorkingTime_._type' kind='elementOnly'"
 * @generated
 */
public interface WorkingTimeType extends EObject {
	/**
	 ...
	 * @see net.certware.planning.mspdi.MspdiPackage#getWorkingTimeType_FromTime()
	...
	/**
	 * Sets the value of the '{@link net.certware.planning.mspdi.WorkingTimeType#getFromTime <em>From Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.certware.planning.mspdi.MspdiPackage#getWorkingTimeType_ToTime()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.Time"
	...
	/**
	 * Sets the value of the '{@link net.certware.planning.mspdi.WorkingTimeType#getToTime <em>To Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
