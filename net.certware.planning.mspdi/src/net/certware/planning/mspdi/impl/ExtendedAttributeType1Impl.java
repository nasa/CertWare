...
import net.certware.planning.mspdi.DurationFormatType1;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Extended Attribute Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.certware.planning.mspdi.impl.ExtendedAttributeType1Impl#getFieldID <em>Field ID</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.impl.ExtendedAttributeType1Impl#getValue <em>Value</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.impl.ExtendedAttributeType1Impl#getValueGUID <em>Value GUID</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.impl.ExtendedAttributeType1Impl#getDurationFormat <em>Duration Format</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExtendedAttributeType1Impl extends EObjectImpl implements ExtendedAttributeType1 {
	/**
	 ...
	 * @ordered
	 */
	protected static final DurationFormatType1 DURATION_FORMAT_EDEFAULT = DurationFormatType1._3;
	 ...
	 * @ordered
	 */
	protected DurationFormatType1 durationFormat = DURATION_FORMAT_EDEFAULT;
	 ...
	 * @generated
	 */
	protected ExtendedAttributeType1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MspdiPackage.Literals.EXTENDED_ATTRIBUTE_TYPE1;
	}
	...
	public void setFieldID(String newFieldID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.EXTENDED_ATTRIBUTE_TYPE1__FIELD_ID, oldFieldID, fieldID));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.EXTENDED_ATTRIBUTE_TYPE1__VALUE, oldValue, value));
	}
	...
	public void setValueGUID(BigInteger newValueGUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.EXTENDED_ATTRIBUTE_TYPE1__VALUE_GUID, oldValueGUID, valueGUID));
	}
	 ...
	 * @generated
	 */
	public DurationFormatType1 getDurationFormat() {
	 ...
	 * @generated
	 */
	public void setDurationFormat(DurationFormatType1 newDurationFormat) {
		DurationFormatType1 oldDurationFormat = durationFormat;
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.EXTENDED_ATTRIBUTE_TYPE1__DURATION_FORMAT, oldDurationFormat, durationFormat, !oldDurationFormatESet));
	}
	...
	public void unsetDurationFormat() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, MspdiPackage.EXTENDED_ATTRIBUTE_TYPE1__DURATION_FORMAT, oldDurationFormat, DURATION_FORMAT_EDEFAULT, oldDurationFormatESet));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MspdiPackage.EXTENDED_ATTRIBUTE_TYPE1__VALUE_GUID:
				...
				return;
			case MspdiPackage.EXTENDED_ATTRIBUTE_TYPE1__DURATION_FORMAT:
				setDurationFormat((DurationFormatType1)newValue);
				return;
		}
