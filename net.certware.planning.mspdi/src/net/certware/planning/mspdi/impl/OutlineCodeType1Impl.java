...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Outline Code Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.certware.planning.mspdi.impl.OutlineCodeType1Impl#getFieldID <em>Field ID</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.impl.OutlineCodeType1Impl#getValueID <em>Value ID</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.impl.OutlineCodeType1Impl#getValueGUID <em>Value GUID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutlineCodeType1Impl extends EObjectImpl implements OutlineCodeType1 {
	/**
	 ...
	 * @generated
	 */
	protected OutlineCodeType1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MspdiPackage.Literals.OUTLINE_CODE_TYPE1;
	}
	...
	public void setFieldID(String newFieldID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.OUTLINE_CODE_TYPE1__FIELD_ID, oldFieldID, fieldID));
	}
	...
	public void setValueID(BigInteger newValueID) {
		...
		valueID = newValueID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.OUTLINE_CODE_TYPE1__VALUE_ID, oldValueID, valueID));
	}
	...
	public void setValueGUID(BigInteger newValueGUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.OUTLINE_CODE_TYPE1__VALUE_GUID, oldValueGUID, valueGUID));
	}
