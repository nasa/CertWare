...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Time Period Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.certware.planning.mspdi.impl.TimePeriodType1Impl#getFromDate <em>From Date</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.impl.TimePeriodType1Impl#getToDate <em>To Date</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TimePeriodType1Impl extends EObjectImpl implements TimePeriodType1 {
	/**
	...
	protected EClass eStaticClass() {
		return MspdiPackage.Literals.TIME_PERIOD_TYPE1;
	}
	...
	public void setFromDate(XMLGregorianCalendar newFromDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.TIME_PERIOD_TYPE1__FROM_DATE, oldFromDate, fromDate));
	}
	...
	public void setToDate(XMLGregorianCalendar newToDate) {
		...
		toDate = newToDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.TIME_PERIOD_TYPE1__TO_DATE, oldToDate, toDate));
	}
