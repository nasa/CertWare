...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Time Period Type2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.certware.planning.mspdi.impl.TimePeriodType2Impl#getFromDate <em>From Date</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.impl.TimePeriodType2Impl#getToDate <em>To Date</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TimePeriodType2Impl extends EObjectImpl implements TimePeriodType2 {
	/**
	...
	protected EClass eStaticClass() {
		return MspdiPackage.Literals.TIME_PERIOD_TYPE2;
	}
	...
	public void setFromDate(XMLGregorianCalendar newFromDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.TIME_PERIOD_TYPE2__FROM_DATE, oldFromDate, fromDate));
	}
	...
	public void setToDate(XMLGregorianCalendar newToDate) {
		...
		toDate = newToDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.TIME_PERIOD_TYPE2__TO_DATE, oldToDate, toDate));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MspdiPackage.TIME_PERIOD_TYPE2__FROM_DATE:
				return getFromDate();
			case MspdiPackage.TIME_PERIOD_TYPE2__TO_DATE:
				return getToDate();
		}
