...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Working Time Type1</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link net.certware.planning.mspdi.impl.WorkingTimeType1Impl#getFromTime <em>From Time</em>}</li>
 *   <li>{@link net.certware.planning.mspdi.impl.WorkingTimeType1Impl#getToTime <em>To Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class WorkingTimeType1Impl extends EObjectImpl implements WorkingTimeType1 {
	/**
	 ...
	 * @generated
	 */
	protected WorkingTimeType1Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MspdiPackage.Literals.WORKING_TIME_TYPE1;
	}
	...
	public void setFromTime(XMLGregorianCalendar newFromTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.WORKING_TIME_TYPE1__FROM_TIME, oldFromTime, fromTime));
	}
	...
	public void setToTime(XMLGregorianCalendar newToTime) {
		...
		toTime = newToTime;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MspdiPackage.WORKING_TIME_TYPE1__TO_TIME, oldToTime, toTime));
	}
