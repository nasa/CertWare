...
public abstract class MydiagramAddAnnotationFeatureBase extends AbstractAddFeature {
    protected final static String typeOrAliasName = "Annotation";
    protected Diagram             targetDiagram   = null;

    public MydiagramAddAnnotationFeatureBase(final IFeatureProvider fp) {
        super(fp);
    ...
    public boolean canAdd(final IAddContext context) {
        ...
        if (newObject instanceof net.certware.sacm.SACM.Annotation) {
    ...
    public PictogramElement add(final IAddContext context) {
        final net.certware.sacm.SACM.Annotation addedModelElement = (net.certware.sacm.SACM.Annotation) context.getNewObject();
        // NEW stuff
        ...
        final ISprayShape shape = new AnnotationShapeShape(getFeatureProvider());
    ...
    protected void linkShapes(ContainerShape conShape, net.certware.sacm.SACM.Annotation addedModelElement) {
        link(conShape, addedModelElement);
