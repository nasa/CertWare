...
public abstract class ClaimIdSectionBase extends GFPropertySection implements ITabbedPropertyConstants {

    protected net.certware.sacm.SACM.ModelElement bc = null;
    ...
    public void refresh() {
        ...
        if (pe != null) {
            ...
            if (bo == null)
                return;
            bc = (net.certware.sacm.SACM.ModelElement) bo;
            String value = "";
            value = "unknown";
