...
public class AssertedEvidencePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(ArgumentationViewsRepository.AssertedEvidence.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(assertedEvidence, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(ArgumentationViewsRepository.AssertedEvidence.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(assertedEvidence, SACMPackage.eINSTANCE.getModelElement_Annotation());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == ArgumentationViewsRepository.AssertedEvidence.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == ArgumentationViewsRepository.AssertedEvidence.Properties.annotation) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (ArgumentationViewsRepository.AssertedEvidence.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (ArgumentationViewsRepository.AssertedEvidence.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(ArgumentationViewsRepository.AssertedEvidence.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(ArgumentationViewsRepository.AssertedEvidence.Properties.annotation))
