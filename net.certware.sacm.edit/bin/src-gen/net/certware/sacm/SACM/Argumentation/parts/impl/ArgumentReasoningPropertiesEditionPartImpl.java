...
public class ArgumentReasoningPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ArgumentReasoningPropertiesEditionPart {
	...
	public void createControls(Composite view) { 
		...
		propertiesStep.addStep(ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue);
		propertiesStep.addStep(ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation);
		...
		composer = new PartComposer(argumentReasoningStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue) {
					return createTaggedValueAdvancedTableComposition(parent);
				}
				if (key == ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation) {
				...
				if (key == ArgumentationViewsRepository.ArgumentReasoning.Properties.structure) {
					return createStructureAdvancedReferencesTable(parent);
				}
				if (key == ArgumentationViewsRepository.ArgumentReasoning.Properties.describedInference) {
					return createDescribedInferenceAdvancedReferencesTable(parent);
				}
				if (key == ArgumentationViewsRepository.ArgumentReasoning.Properties.describedChallenge) {
					return createDescribedChallengeAdvancedReferencesTable(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(ArgumentationMessages.ArgumentReasoningPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createTaggedValueAdvancedTableComposition(Composite parent) {
		this.taggedValue = new ReferencesTable(getDescription(ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue, ArgumentationMessages.ArgumentReasoningPropertiesEditionPart_TaggedValueLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				taggedValue.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				taggedValue.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				taggedValue.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				taggedValue.refresh();
			}
		...
		this.taggedValue.setHelpText(propertiesEditionComponent.getHelpContent(ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue, ArgumentationViewsRepository.SWT_KIND));
		this.taggedValue.createControls(parent);
		this.taggedValue.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		taggedValue.setID(ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue);
	...
	protected Composite createAnnotationAdvancedTableComposition(Composite parent) {
		this.annotation = new ReferencesTable(getDescription(ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation, ArgumentationMessages.ArgumentReasoningPropertiesEditionPart_AnnotationLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				annotation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				annotation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				annotation.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				annotation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.annotation.setHelpText(propertiesEditionComponent.getHelpContent(ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation, ArgumentationViewsRepository.SWT_KIND));
		this.annotation.createControls(parent);
		this.annotation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		annotation.setID(ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation);
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArgumentationViewsRepository.ArgumentReasoning.Properties.id, ArgumentationViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArgumentationViewsRepository.ArgumentReasoning.Properties.description, ArgumentationViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createContentText(Composite parent) {
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.content, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, content.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(ArgumentationViewsRepository.ArgumentReasoning.Properties.content, ArgumentationViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	 ...
	 * 
	 */
	protected Composite createStructureAdvancedReferencesTable(Composite parent) {
		String label = getDescription(ArgumentationViewsRepository.ArgumentReasoning.Properties.structure, ArgumentationMessages.ArgumentReasoningPropertiesEditionPart_StructureLabel);		 
		this.structure = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.structure.setHelpText(propertiesEditionComponent.getHelpContent(ArgumentationViewsRepository.ArgumentReasoning.Properties.structure, ArgumentationViewsRepository.SWT_KIND));
		this.structure.createControls(parent);
		this.structure.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.structure, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"structure", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.structure,
	...
	protected void moveStructure(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.structure, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		structure.refresh();
	}
	...
	protected void removeFromStructure(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.structure, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		structure.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createDescribedInferenceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(ArgumentationViewsRepository.ArgumentReasoning.Properties.describedInference, ArgumentationMessages.ArgumentReasoningPropertiesEditionPart_DescribedInferenceLabel);		 
		this.describedInference = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.describedInference.setHelpText(propertiesEditionComponent.getHelpContent(ArgumentationViewsRepository.ArgumentReasoning.Properties.describedInference, ArgumentationViewsRepository.SWT_KIND));
		this.describedInference.createControls(parent);
		this.describedInference.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.describedInference, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDescribedInference() {
		...
		"describedInference", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.describedInference,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveDescribedInference(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.describedInference, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		describedInference.refresh();
	}
	...
	protected void removeFromDescribedInference(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.describedInference, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		describedInference.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createDescribedChallengeAdvancedReferencesTable(Composite parent) {
		String label = getDescription(ArgumentationViewsRepository.ArgumentReasoning.Properties.describedChallenge, ArgumentationMessages.ArgumentReasoningPropertiesEditionPart_DescribedChallengeLabel);		 
		this.describedChallenge = new ReferencesTable(label, new ReferencesTableListener() {
		...
		this.describedChallenge.setHelpText(propertiesEditionComponent.getHelpContent(ArgumentationViewsRepository.ArgumentReasoning.Properties.describedChallenge, ArgumentationViewsRepository.SWT_KIND));
		this.describedChallenge.createControls(parent);
		this.describedChallenge.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.describedChallenge, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addDescribedChallenge() {
		...
		"describedChallenge", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.describedChallenge,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveDescribedChallenge(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.describedChallenge, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		describedChallenge.refresh();
	}
	...
	protected void removeFromDescribedChallenge(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArgumentReasoningPropertiesEditionPartImpl.this, ArgumentationViewsRepository.ArgumentReasoning.Properties.describedChallenge, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		describedChallenge.refresh();
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#initTaggedValue(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initTaggedValue(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(ArgumentationViewsRepository.ArgumentReasoning.Properties.taggedValue);
		if (eefElementEditorReadOnlyState && taggedValue.isEnabled()) {
			taggedValue.setEnabled(false);
			taggedValue.setToolTipText(ArgumentationMessages.ArgumentReasoning_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#updateTaggedValue()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#addFilterTaggedValue(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#addBusinessFilterTaggedValue(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#isContainedInTaggedValueTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#initAnnotation(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initAnnotation(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(ArgumentationViewsRepository.ArgumentReasoning.Properties.annotation);
		if (eefElementEditorReadOnlyState && annotation.isEnabled()) {
			annotation.setEnabled(false);
			annotation.setToolTipText(ArgumentationMessages.ArgumentReasoning_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#updateAnnotation()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#addFilterAnnotation(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#addBusinessFilterAnnotation(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Argumentation.parts.ArgumentReasoningPropertiesEditionPart#isContainedInAnnotationTable(EObject element)
	 * 
	 */
