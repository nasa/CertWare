 ...
 * 
 */
public class ArgumentationMessages extends NLS {
	
	private static final String BUNDLE_NAME = "net.certware.sacm.SACM.Argumentation.providers.argumentationMessages"; //$NON-NLS-1$
	...
	public static String CitationElementPropertiesEditionPart_ArgumentElementReferenceLabel;
	...
	public static String InformationElementPropertiesEditionPart_EvidenceLabel;
	...
	public static String ArgumentReasoningPropertiesEditionPart_StructureLabel;

	
	public static String ArgumentReasoningPropertiesEditionPart_DescribedInferenceLabel;
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, ArgumentationMessages.class);
	}

	
	private ArgumentationMessages() {
