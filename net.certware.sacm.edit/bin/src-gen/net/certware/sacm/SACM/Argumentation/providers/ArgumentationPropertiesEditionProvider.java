 ...
 * 
 */
public class ArgumentationPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public ArgumentationPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public ArgumentationPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Argumentation) 
					&& (ArgumentationPackage.Literals.ARGUMENTATION == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && ArgumentationPackage.Literals.ARGUMENTATION == eObj.eClass();
		}
