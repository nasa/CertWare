 ...
 * 
 */
public class ChallengesBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ChallengesBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject challenges, String editing_mode) {
		super(editingContext, challenges, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.Challenges.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final Challenges challenges = (Challenges)elt;
			final ChallengesPropertiesEditionPart basePart = (ChallengesPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(challenges, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(challenges, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, challenges.getId()));
			
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(challenges, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(challenges, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(challenges, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.event)) {
				eventSettings = new ReferencesTableSettings(challenges, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.attribute)) {
				attributeSettings = new ReferencesTableSettings(challenges, EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute());
				basePart.initAttribute(attributeSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.assertion)) {
				// init part
				assertionSettings = new EObjectFlatComboSettings(challenges, EvidencePackage.eINSTANCE.getEvidenceRelation_Assertion());
				basePart.initAssertion(assertionSettings);
				// set the button mode
				basePart.setAssertionButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.subject)) {
				// init part
				subjectSettings = new EObjectFlatComboSettings(challenges, EvidencePackage.eINSTANCE.getEvidenceRelation_Subject());
			...
			if (isAccessible(EvidenceViewsRepository.Challenges.Properties.subject)) {
				basePart.addFilterToSubject(new ViewerFilter() {
					 ...
					 */
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						return (element instanceof EvidenceItem);
					}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.attribute) {
			return EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute();
		}
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.assertion) {
			return EvidencePackage.eINSTANCE.getEvidenceRelation_Assertion();
		}
		if (editorKey == EvidenceViewsRepository.Challenges.Properties.subject) {
			return EvidencePackage.eINSTANCE.getEvidenceRelation_Subject();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		Challenges challenges = (Challenges)semanticObject;
		if (EvidenceViewsRepository.Challenges.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.Challenges.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Challenges.Properties.id == event.getAffectedEditor()) {
			challenges.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.Challenges.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Challenges.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Challenges.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Challenges.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Challenges.Properties.attribute == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Challenges.Properties.assertion == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.Challenges.Properties.subject == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				subjectSettings.setToReference((EvidenceItem)event.getNewValue());
			} else if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			ChallengesPropertiesEditionPart basePart = (ChallengesPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Challenges.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Challenges.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.Challenges.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Challenges.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Challenges.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Challenges.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Challenges.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Challenges.Properties.attribute))
				basePart.updateAttribute();
			if (EvidencePackage.eINSTANCE.getEvidenceRelation_Assertion().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.Challenges.Properties.assertion))
				basePart.setAssertion((EObject)msg.getNewValue());
			if (EvidencePackage.eINSTANCE.getEvidenceRelation_Subject().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.Challenges.Properties.subject))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getEvidenceRelation_Assertion(),
			EvidencePackage.eINSTANCE.getEvidenceRelation_Subject()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.Challenges.Properties.id || key == EvidenceViewsRepository.Challenges.Properties.assertion || key == EvidenceViewsRepository.Challenges.Properties.subject;
	}
