 ...
 * 
 */
public class CompliesToBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public CompliesToBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject compliesTo, String editing_mode) {
		super(editingContext, compliesTo, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.CompliesTo.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final CompliesTo compliesTo = (CompliesTo)elt;
			final CompliesToPropertiesEditionPart basePart = (CompliesToPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.CompliesTo.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(compliesTo, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompliesTo.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(compliesTo, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompliesTo.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, compliesTo.getId()));
			
			if (isAccessible(EvidenceViewsRepository.CompliesTo.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(compliesTo, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompliesTo.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(compliesTo, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompliesTo.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(compliesTo, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompliesTo.Properties.event)) {
				eventSettings = new ReferencesTableSettings(compliesTo, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompliesTo.Properties.criteria)) {
				basePart.initCriteria(EEFUtils.choiceOfValues(compliesTo, EvidencePackage.eINSTANCE.getCompliesTo_Criteria()), compliesTo.getCriteria());
			}
			// init filters
			if (isAccessible(EvidenceViewsRepository.CompliesTo.Properties.taggedValue)) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.CompliesTo.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.CompliesTo.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.CompliesTo.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.CompliesTo.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.CompliesTo.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.CompliesTo.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.CompliesTo.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.CompliesTo.Properties.criteria) {
			return EvidencePackage.eINSTANCE.getCompliesTo_Criteria();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		CompliesTo compliesTo = (CompliesTo)semanticObject;
		if (EvidenceViewsRepository.CompliesTo.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.CompliesTo.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompliesTo.Properties.id == event.getAffectedEditor()) {
			compliesTo.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.CompliesTo.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompliesTo.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompliesTo.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompliesTo.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompliesTo.Properties.criteria == event.getAffectedEditor()) {
			compliesTo.setCriteria((StandardOfProof)event.getNewValue());
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			CompliesToPropertiesEditionPart basePart = (CompliesToPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompliesTo.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompliesTo.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.CompliesTo.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompliesTo.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompliesTo.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompliesTo.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompliesTo.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getCompliesTo_Criteria().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(EvidenceViewsRepository.CompliesTo.Properties.criteria))
				basePart.setCriteria((StandardOfProof)msg.getNewValue());
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getCompliesTo_Criteria()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.CompliesTo.Properties.id || key == EvidenceViewsRepository.CompliesTo.Properties.criteria;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (EvidenceViewsRepository.CompliesTo.Properties.criteria == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(EvidencePackage.eINSTANCE.getCompliesTo_Criteria().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(EvidencePackage.eINSTANCE.getCompliesTo_Criteria().getEAttributeType(), newValue);
				}
