 ...
 * 
 */
public class CompositeObjectBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public CompositeObjectBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject compositeObject, String editing_mode) {
		super(editingContext, compositeObject, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.CompositeObject.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final CompositeObject compositeObject = (CompositeObject)elt;
			final CompositeObjectPropertiesEditionPart basePart = (CompositeObjectPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.CompositeObject.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(compositeObject, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompositeObject.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(compositeObject, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompositeObject.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, compositeObject.getId()));
			
			if (isAccessible(EvidenceViewsRepository.CompositeObject.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(compositeObject, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompositeObject.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(compositeObject, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompositeObject.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(compositeObject, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompositeObject.Properties.event)) {
				eventSettings = new ReferencesTableSettings(compositeObject, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CompositeObject.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, compositeObject.getName()));
			
			if (isAccessible(EvidenceViewsRepository.CompositeObject.Properties.element)) {
				elementSettings = new ReferencesTableSettings(compositeObject, EvidencePackage.eINSTANCE.getCompositeObject_Element());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.CompositeObject.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.CompositeObject.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.CompositeObject.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.CompositeObject.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.CompositeObject.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.CompositeObject.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.CompositeObject.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.CompositeObject.Properties.name) {
			return EvidencePackage.eINSTANCE.getFormalObject_Name();
		}
		if (editorKey == EvidenceViewsRepository.CompositeObject.Properties.element) {
			return EvidencePackage.eINSTANCE.getCompositeObject_Element();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		CompositeObject compositeObject = (CompositeObject)semanticObject;
		if (EvidenceViewsRepository.CompositeObject.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.CompositeObject.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompositeObject.Properties.id == event.getAffectedEditor()) {
			compositeObject.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.CompositeObject.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompositeObject.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompositeObject.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompositeObject.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CompositeObject.Properties.name == event.getAffectedEditor()) {
			compositeObject.setName((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.CompositeObject.Properties.element == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				...
				elementSettings.move(event.getNewIndex(), (FormalObject) event.getNewValue());
			}
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			CompositeObjectPropertiesEditionPart basePart = (CompositeObjectPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompositeObject.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompositeObject.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.CompositeObject.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompositeObject.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompositeObject.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompositeObject.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompositeObject.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getFormalObject_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.CompositeObject.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (EvidencePackage.eINSTANCE.getCompositeObject_Element().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CompositeObject.Properties.element))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getCompositeObject_Element()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.CompositeObject.Properties.id || key == EvidenceViewsRepository.CompositeObject.Properties.name;
	}
