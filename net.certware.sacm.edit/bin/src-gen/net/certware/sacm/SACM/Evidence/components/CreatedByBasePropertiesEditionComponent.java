 ...
 * 
 */
public class CreatedByBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public CreatedByBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject createdBy, String editing_mode) {
		super(editingContext, createdBy, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.CreatedBy.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final CreatedBy createdBy = (CreatedBy)elt;
			final CreatedByPropertiesEditionPart basePart = (CreatedByPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.CreatedBy.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(createdBy, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CreatedBy.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(createdBy, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CreatedBy.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, createdBy.getId()));
			
			if (isAccessible(EvidenceViewsRepository.CreatedBy.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(createdBy, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CreatedBy.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(createdBy, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.CreatedBy.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(createdBy, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CreatedBy.Properties.event)) {
				eventSettings = new ReferencesTableSettings(createdBy, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.CreatedBy.Properties.source)) {
				// init part
				sourceSettings = new EObjectFlatComboSettings(createdBy, EvidencePackage.eINSTANCE.getCreatedBy_Source());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.CreatedBy.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.CreatedBy.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.CreatedBy.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.CreatedBy.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.CreatedBy.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.CreatedBy.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.CreatedBy.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.CreatedBy.Properties.source) {
			return EvidencePackage.eINSTANCE.getCreatedBy_Source();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		CreatedBy createdBy = (CreatedBy)semanticObject;
		if (EvidenceViewsRepository.CreatedBy.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.CreatedBy.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CreatedBy.Properties.id == event.getAffectedEditor()) {
			createdBy.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.CreatedBy.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CreatedBy.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CreatedBy.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CreatedBy.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.CreatedBy.Properties.source == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				sourceSettings.setToReference((Stakeholder)event.getNewValue());
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			CreatedByPropertiesEditionPart basePart = (CreatedByPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CreatedBy.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CreatedBy.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.CreatedBy.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CreatedBy.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CreatedBy.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CreatedBy.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.CreatedBy.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getCreatedBy_Source().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.CreatedBy.Properties.source))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getCreatedBy_Source()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.CreatedBy.Properties.id || key == EvidenceViewsRepository.CreatedBy.Properties.source;
	}
