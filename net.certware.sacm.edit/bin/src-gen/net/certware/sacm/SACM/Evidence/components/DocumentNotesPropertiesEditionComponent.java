 ...
 * 
 */
public class DocumentNotesPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public DocumentNotesPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject document, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EvidenceViewsRepository.Notes.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(document, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				notesPart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Notes.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(document, SACMPackage.eINSTANCE.getModelElement_Annotation());
