 ...
 * 
 */
public class ExtendedDocumentPropertyBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ExtendedDocumentPropertyBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject extendedDocumentProperty, String editing_mode) {
		super(editingContext, extendedDocumentProperty, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.ExtendedDocumentProperty.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ExtendedDocumentProperty extendedDocumentProperty = (ExtendedDocumentProperty)elt;
			final ExtendedDocumentPropertyPropertiesEditionPart basePart = (ExtendedDocumentPropertyPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(extendedDocumentProperty, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(extendedDocumentProperty, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, extendedDocumentProperty.getId()));
			
			if (isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(extendedDocumentProperty, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(extendedDocumentProperty, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(extendedDocumentProperty, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.event)) {
				eventSettings = new ReferencesTableSettings(extendedDocumentProperty, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.ExtendedDocumentProperty.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.ExtendedDocumentProperty.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.ExtendedDocumentProperty.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.ExtendedDocumentProperty.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.ExtendedDocumentProperty.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.ExtendedDocumentProperty.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.ExtendedDocumentProperty.Properties.event) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		ExtendedDocumentProperty extendedDocumentProperty = (ExtendedDocumentProperty)semanticObject;
		if (EvidenceViewsRepository.ExtendedDocumentProperty.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.ExtendedDocumentProperty.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.ExtendedDocumentProperty.Properties.id == event.getAffectedEditor()) {
			extendedDocumentProperty.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.ExtendedDocumentProperty.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.ExtendedDocumentProperty.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.ExtendedDocumentProperty.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.ExtendedDocumentProperty.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			ExtendedDocumentPropertyPropertiesEditionPart basePart = (ExtendedDocumentPropertyPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ExtendedDocumentProperty.Properties.event))
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.ExtendedDocumentProperty.Properties.id;
	}
