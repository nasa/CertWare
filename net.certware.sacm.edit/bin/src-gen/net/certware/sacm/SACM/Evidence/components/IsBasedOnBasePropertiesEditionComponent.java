 ...
 * 
 */
public class IsBasedOnBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public IsBasedOnBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject isBasedOn, String editing_mode) {
		super(editingContext, isBasedOn, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.IsBasedOn.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final IsBasedOn isBasedOn = (IsBasedOn)elt;
			final IsBasedOnPropertiesEditionPart basePart = (IsBasedOnPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(isBasedOn, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(isBasedOn, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, isBasedOn.getId()));
			
			if (isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(isBasedOn, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(isBasedOn, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(isBasedOn, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.event)) {
				eventSettings = new ReferencesTableSettings(isBasedOn, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.source)) {
				// init part
				sourceSettings = new EObjectFlatComboSettings(isBasedOn, EvidencePackage.eINSTANCE.getIsBasedOn_Source());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.IsBasedOn.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.IsBasedOn.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.IsBasedOn.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.IsBasedOn.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.IsBasedOn.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.IsBasedOn.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.IsBasedOn.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.IsBasedOn.Properties.source) {
			return EvidencePackage.eINSTANCE.getIsBasedOn_Source();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		IsBasedOn isBasedOn = (IsBasedOn)semanticObject;
		if (EvidenceViewsRepository.IsBasedOn.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.IsBasedOn.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsBasedOn.Properties.id == event.getAffectedEditor()) {
			isBasedOn.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.IsBasedOn.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsBasedOn.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsBasedOn.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsBasedOn.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsBasedOn.Properties.source == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				sourceSettings.setToReference((EvidenceItem)event.getNewValue());
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			IsBasedOnPropertiesEditionPart basePart = (IsBasedOnPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getIsBasedOn_Source().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.IsBasedOn.Properties.source))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getIsBasedOn_Source()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.IsBasedOn.Properties.id || key == EvidenceViewsRepository.IsBasedOn.Properties.source;
	}
