 ...
 * 
 */
public class IsCharacterizedByBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public IsCharacterizedByBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject isCharacterizedBy, String editing_mode) {
		super(editingContext, isCharacterizedBy, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.IsCharacterizedBy.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final IsCharacterizedBy isCharacterizedBy = (IsCharacterizedBy)elt;
			final IsCharacterizedByPropertiesEditionPart basePart = (IsCharacterizedByPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(isCharacterizedBy, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(isCharacterizedBy, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, isCharacterizedBy.getId()));
			
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(isCharacterizedBy, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(isCharacterizedBy, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(isCharacterizedBy, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.event)) {
				eventSettings = new ReferencesTableSettings(isCharacterizedBy, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.attribute)) {
				attributeSettings = new ReferencesTableSettings(isCharacterizedBy, EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute());
				basePart.initAttribute(attributeSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.subject)) {
				// init part
				subjectSettings = new EObjectFlatComboSettings(isCharacterizedBy, EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject());
				basePart.initSubject(subjectSettings);
				// set the button mode
				basePart.setSubjectButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.assertion)) {
				// init part
				assertionSettings = new EObjectFlatComboSettings(isCharacterizedBy, EvidencePackage.eINSTANCE.getIsCharacterizedBy_Assertion());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.attribute) {
			return EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute();
		}
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.subject) {
			return EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject();
		}
		if (editorKey == EvidenceViewsRepository.IsCharacterizedBy.Properties.assertion) {
			return EvidencePackage.eINSTANCE.getIsCharacterizedBy_Assertion();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		IsCharacterizedBy isCharacterizedBy = (IsCharacterizedBy)semanticObject;
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.id == event.getAffectedEditor()) {
			isCharacterizedBy.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.attribute == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.subject == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				subjectSettings.setToReference((EvidenceElement)event.getNewValue());
		...
		if (EvidenceViewsRepository.IsCharacterizedBy.Properties.assertion == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			IsCharacterizedByPropertiesEditionPart basePart = (IsCharacterizedByPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.attribute))
				basePart.updateAttribute();
			if (EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.subject))
				basePart.setSubject((EObject)msg.getNewValue());
			if (EvidencePackage.eINSTANCE.getIsCharacterizedBy_Assertion().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.IsCharacterizedBy.Properties.assertion))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject(),
			EvidencePackage.eINSTANCE.getIsCharacterizedBy_Assertion()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.IsCharacterizedBy.Properties.id || key == EvidenceViewsRepository.IsCharacterizedBy.Properties.subject || key == EvidenceViewsRepository.IsCharacterizedBy.Properties.assertion;
	}
