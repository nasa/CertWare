 ...
 * 
 */
public class IsPartOfBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	/**
	 * Settings for whole EObjectFlatComboViewer
	 */
	private EObjectFlatComboSettings wholeSettings;
	 ...
	 * 
	 */
	public IsPartOfBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject isPartOf, String editing_mode) {
		super(editingContext, isPartOf, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.IsPartOf.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final IsPartOf isPartOf = (IsPartOf)elt;
			final IsPartOfPropertiesEditionPart basePart = (IsPartOfPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(isPartOf, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(isPartOf, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, isPartOf.getId()));
			
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(isPartOf, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(isPartOf, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(isPartOf, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.event)) {
				eventSettings = new ReferencesTableSettings(isPartOf, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.whole)) {
				// init part
				wholeSettings = new EObjectFlatComboSettings(isPartOf, EvidencePackage.eINSTANCE.getIsPartOf_Whole());
				basePart.initWhole(wholeSettings);
				// set the button mode
				basePart.setWholeButtonMode(ButtonsModeEnum.BROWSE);
			}
			// init filters
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.taggedValue)) {
			...
			if (isAccessible(EvidenceViewsRepository.IsPartOf.Properties.whole)) {
				basePart.addFilterToWhole(new ViewerFilter() {
					 ...
					 */
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						return (element instanceof Exhibit);
					}
					
				});
				// Start of user code for additional businessfilters for whole
				// End of user code
			}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.IsPartOf.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.IsPartOf.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.IsPartOf.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.IsPartOf.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.IsPartOf.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.IsPartOf.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.IsPartOf.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.IsPartOf.Properties.whole) {
			return EvidencePackage.eINSTANCE.getIsPartOf_Whole();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		IsPartOf isPartOf = (IsPartOf)semanticObject;
		if (EvidenceViewsRepository.IsPartOf.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.IsPartOf.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsPartOf.Properties.id == event.getAffectedEditor()) {
			isPartOf.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.IsPartOf.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsPartOf.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsPartOf.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsPartOf.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsPartOf.Properties.whole == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				wholeSettings.setToReference((Exhibit)event.getNewValue());
			} else if (event.getKind() == PropertiesEditionEvent.ADD) {
				Exhibit eObject = EvidenceFactory.eINSTANCE.createExhibit();
				...
				wholeSettings.setToReference(eObject);
			}
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			IsPartOfPropertiesEditionPart basePart = (IsPartOfPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsPartOf.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsPartOf.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.IsPartOf.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsPartOf.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsPartOf.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsPartOf.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsPartOf.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getIsPartOf_Whole().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.IsPartOf.Properties.whole))
				basePart.setWhole((EObject)msg.getNewValue());
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getIsPartOf_Whole()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.IsPartOf.Properties.id || key == EvidenceViewsRepository.IsPartOf.Properties.whole;
	}
