 ...
 * 
 */
public class IsScopedByBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public IsScopedByBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject isScopedBy, String editing_mode) {
		super(editingContext, isScopedBy, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.IsScopedBy.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final IsScopedBy isScopedBy = (IsScopedBy)elt;
			final IsScopedByPropertiesEditionPart basePart = (IsScopedByPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(isScopedBy, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(isScopedBy, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, isScopedBy.getId()));
			
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(isScopedBy, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(isScopedBy, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(isScopedBy, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.event)) {
				eventSettings = new ReferencesTableSettings(isScopedBy, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.attribute)) {
				attributeSettings = new ReferencesTableSettings(isScopedBy, EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute());
				basePart.initAttribute(attributeSettings);
			}
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.subject)) {
				// init part
				subjectSettings = new EObjectFlatComboSettings(isScopedBy, EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject());
				basePart.initSubject(subjectSettings);
				// set the button mode
				basePart.setSubjectButtonMode(ButtonsModeEnum.BROWSE);
			}
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.scope)) {
				// init part
				scopeSettings = new EObjectFlatComboSettings(isScopedBy, EvidencePackage.eINSTANCE.getIsScopedBy_Scope());
			...
			if (isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.scope)) {
				basePart.addFilterToScope(new ViewerFilter() {
					 ...
					 */
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						return (element instanceof FormalElement);
					}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.attribute) {
			return EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute();
		}
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.subject) {
			return EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject();
		}
		if (editorKey == EvidenceViewsRepository.IsScopedBy.Properties.scope) {
			return EvidencePackage.eINSTANCE.getIsScopedBy_Scope();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		IsScopedBy isScopedBy = (IsScopedBy)semanticObject;
		if (EvidenceViewsRepository.IsScopedBy.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.IsScopedBy.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsScopedBy.Properties.id == event.getAffectedEditor()) {
			isScopedBy.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.IsScopedBy.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsScopedBy.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsScopedBy.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsScopedBy.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsScopedBy.Properties.attribute == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.IsScopedBy.Properties.subject == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.IsScopedBy.Properties.scope == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				scopeSettings.setToReference((FormalElement)event.getNewValue());
			} else if (event.getKind() == PropertiesEditionEvent.ADD) {
				EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext, this, scopeSettings, editingContext.getAdapterFactory());
				PropertiesEditingProvider provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(semanticObject, PropertiesEditingProvider.class);
				if (provider != null) {
					PropertiesEditingPolicy policy = provider.getPolicy(context);
					if (policy instanceof CreateEditingPolicy) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			IsScopedByPropertiesEditionPart basePart = (IsScopedByPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.attribute))
				basePart.updateAttribute();
			if (EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.subject))
				basePart.setSubject((EObject)msg.getNewValue());
			if (EvidencePackage.eINSTANCE.getIsScopedBy_Scope().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.IsScopedBy.Properties.scope))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getIsScopedBy_Scope()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.IsScopedBy.Properties.id || key == EvidenceViewsRepository.IsScopedBy.Properties.subject || key == EvidenceViewsRepository.IsScopedBy.Properties.scope;
	}
