 ...
 * 
 */
public class MeansThatBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	/**
	 * Settings for meaning EObjectFlatComboViewer
	 */
	private EObjectFlatComboSettings meaningSettings;
	 ...
	 * 
	 */
	public MeansThatBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject meansThat, String editing_mode) {
		super(editingContext, meansThat, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.MeansThat.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(meansThat, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(meansThat, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, meansThat.getId()));
			
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(meansThat, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(meansThat, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(meansThat, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.event)) {
				eventSettings = new ReferencesTableSettings(meansThat, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.attribute)) {
				attributeSettings = new ReferencesTableSettings(meansThat, EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute());
				basePart.initAttribute(attributeSettings);
			}
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.subject)) {
				// init part
				subjectSettings = new EObjectFlatComboSettings(meansThat, EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject());
			...
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.meaning)) {
				// init part
				meaningSettings = new EObjectFlatComboSettings(meansThat, EvidencePackage.eINSTANCE.getMeansThat_Meaning());
			...
			if (isAccessible(EvidenceViewsRepository.MeansThat.Properties.meaning)) {
				basePart.addFilterToMeaning(new ViewerFilter() {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.attribute) {
			return EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute();
		}
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.subject) {
			return EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject();
		}
		if (editorKey == EvidenceViewsRepository.MeansThat.Properties.meaning) {
			return EvidencePackage.eINSTANCE.getMeansThat_Meaning();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		MeansThat meansThat = (MeansThat)semanticObject;
		if (EvidenceViewsRepository.MeansThat.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.MeansThat.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.MeansThat.Properties.attribute == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.MeansThat.Properties.meaning == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				meaningSettings.setToReference((FormalAssertion)event.getNewValue());
			} else if (event.getKind() == PropertiesEditionEvent.ADD) {
				EReferencePropertiesEditionContext context = new EReferencePropertiesEditionContext(editingContext, this, meaningSettings, editingContext.getAdapterFactory());
				PropertiesEditingProvider provider = (PropertiesEditingProvider)editingContext.getAdapterFactory().adapt(semanticObject, PropertiesEditingProvider.class);
				if (provider != null) {
					PropertiesEditingPolicy policy = provider.getPolicy(context);
					if (policy instanceof CreateEditingPolicy) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.MeansThat.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.MeansThat.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.MeansThat.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.MeansThat.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.MeansThat.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.MeansThat.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.MeansThat.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getEvidenceEvaluation_Attribute().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.MeansThat.Properties.attribute))
				basePart.updateAttribute();
			if (EvidencePackage.eINSTANCE.getEvidenceInterpretation_Subject().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.MeansThat.Properties.subject))
				basePart.setSubject((EObject)msg.getNewValue());
			if (EvidencePackage.eINSTANCE.getMeansThat_Meaning().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.MeansThat.Properties.meaning))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getMeansThat_Meaning()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.MeansThat.Properties.id || key == EvidenceViewsRepository.MeansThat.Properties.subject || key == EvidenceViewsRepository.MeansThat.Properties.meaning;
	}
