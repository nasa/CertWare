 ...
 * 
 */
public class ObjectBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ObjectBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject object, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EvidenceViewsRepository.Object.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, object.getId()));
			...
			if (isAccessible(EvidenceViewsRepository.Object.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, object.getName()));
			
			if (isAccessible(EvidenceViewsRepository.Object.Properties.concept))
				basePart.setConcept(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, object.getConcept()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		net.certware.sacm.SACM.Evidence.Object object = (net.certware.sacm.SACM.Evidence.Object)semanticObject;
		if (EvidenceViewsRepository.Object.Properties.id == event.getAffectedEditor()) {
			object.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		...
		if (EvidenceViewsRepository.Object.Properties.name == event.getAffectedEditor()) {
			object.setName((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.Object.Properties.concept == event.getAffectedEditor()) {
			object.setConcept((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
