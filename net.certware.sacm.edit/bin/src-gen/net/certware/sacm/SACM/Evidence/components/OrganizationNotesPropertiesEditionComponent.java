 ...
 * 
 */
public class OrganizationNotesPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public OrganizationNotesPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject organization, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EvidenceViewsRepository.Notes.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(organization, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				notesPart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Notes.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(organization, SACMPackage.eINSTANCE.getModelElement_Annotation());
