 ...
 * 
 */
public class ProjectObjectiveBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ProjectObjectiveBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject projectObjective, String editing_mode) {
		super(editingContext, projectObjective, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.ProjectObjective.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ProjectObjective projectObjective = (ProjectObjective)elt;
			final ProjectObjectivePropertiesEditionPart basePart = (ProjectObjectivePropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(projectObjective, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(projectObjective, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, projectObjective.getId()));
			
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(projectObjective, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(projectObjective, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(projectObjective, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.event)) {
				eventSettings = new ReferencesTableSettings(projectObjective, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, projectObjective.getName()));
			
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.content))
				basePart.setContent(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, projectObjective.getContent()));
			
			if (isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.property)) {
				propertySettings = new ReferencesTableSettings(projectObjective, EvidencePackage.eINSTANCE.getProjectElement_Property());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.name) {
			return EvidencePackage.eINSTANCE.getProjectElement_Name();
		}
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.content) {
			return EvidencePackage.eINSTANCE.getProjectElement_Content();
		}
		if (editorKey == EvidenceViewsRepository.ProjectObjective.Properties.property) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		ProjectObjective projectObjective = (ProjectObjective)semanticObject;
		if (EvidenceViewsRepository.ProjectObjective.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.ProjectObjective.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.ProjectObjective.Properties.id == event.getAffectedEditor()) {
			projectObjective.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.ProjectObjective.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.ProjectObjective.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.ProjectObjective.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.ProjectObjective.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.ProjectObjective.Properties.name == event.getAffectedEditor()) {
			projectObjective.setName((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.ProjectObjective.Properties.content == event.getAffectedEditor()) {
			projectObjective.setContent((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.ProjectObjective.Properties.property == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			ProjectObjectivePropertiesEditionPart basePart = (ProjectObjectivePropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getProjectElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.name)) {
				if (msg.getNewValue() != null) {
			...
			if (EvidencePackage.eINSTANCE.getProjectElement_Content().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.content)) {
				if (msg.getNewValue() != null) {
			...
			if (EvidencePackage.eINSTANCE.getProjectElement_Property().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.ProjectObjective.Properties.property))
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.ProjectObjective.Properties.id || key == EvidenceViewsRepository.ProjectObjective.Properties.name || key == EvidenceViewsRepository.ProjectObjective.Properties.content;
	}
