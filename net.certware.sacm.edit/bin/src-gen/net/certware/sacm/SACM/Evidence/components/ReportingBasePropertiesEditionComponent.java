 ...
 * 
 */
public class ReportingBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ReportingBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject reporting, String editing_mode) {
		super(editingContext, reporting, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.Reporting.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final Reporting reporting = (Reporting)elt;
			final ReportingPropertiesEditionPart basePart = (ReportingPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.Reporting.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(reporting, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Reporting.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(reporting, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Reporting.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, reporting.getId()));
			
			if (isAccessible(EvidenceViewsRepository.Reporting.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(reporting, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Reporting.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(reporting, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.Reporting.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(reporting, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Reporting.Properties.event)) {
				eventSettings = new ReferencesTableSettings(reporting, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Reporting.Properties.value)) {
				basePart.initValue(EEFUtils.choiceOfValues(reporting, EvidencePackage.eINSTANCE.getReporting_Value()), reporting.getValue());
			}
			// init filters
			if (isAccessible(EvidenceViewsRepository.Reporting.Properties.taggedValue)) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.Reporting.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.Reporting.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.Reporting.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.Reporting.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.Reporting.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.Reporting.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.Reporting.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.Reporting.Properties.value) {
			return EvidencePackage.eINSTANCE.getReporting_Value();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		Reporting reporting = (Reporting)semanticObject;
		if (EvidenceViewsRepository.Reporting.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.Reporting.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Reporting.Properties.id == event.getAffectedEditor()) {
			reporting.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.Reporting.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Reporting.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Reporting.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Reporting.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Reporting.Properties.value == event.getAffectedEditor()) {
			reporting.setValue((ReportingLevel)event.getNewValue());
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			ReportingPropertiesEditionPart basePart = (ReportingPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Reporting.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Reporting.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.Reporting.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Reporting.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Reporting.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Reporting.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Reporting.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getReporting_Value().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(EvidenceViewsRepository.Reporting.Properties.value))
				basePart.setValue((ReportingLevel)msg.getNewValue());
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getReporting_Value()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.Reporting.Properties.id || key == EvidenceViewsRepository.Reporting.Properties.value;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (EvidenceViewsRepository.Reporting.Properties.value == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(EvidencePackage.eINSTANCE.getReporting_Value().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(EvidencePackage.eINSTANCE.getReporting_Value().getEAttributeType(), newValue);
				}
