 ...
 * 
 */
public class SatisfiesBasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public SatisfiesBasePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject satisfies, String editing_mode) {
		super(editingContext, satisfies, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = EvidenceViewsRepository.class;
		partKey = EvidenceViewsRepository.Satisfies.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final Satisfies satisfies = (Satisfies)elt;
			final SatisfiesPropertiesEditionPart basePart = (SatisfiesPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(EvidenceViewsRepository.Satisfies.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(satisfies, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Satisfies.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(satisfies, SACMPackage.eINSTANCE.getModelElement_Annotation());
				basePart.initAnnotation(annotationSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Satisfies.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, satisfies.getId()));
			
			if (isAccessible(EvidenceViewsRepository.Satisfies.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(satisfies, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Satisfies.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(satisfies, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.Satisfies.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(satisfies, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Satisfies.Properties.event)) {
				eventSettings = new ReferencesTableSettings(satisfies, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
				basePart.initEvent(eventSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Satisfies.Properties.element)) {
				// init part
				elementSettings = new EObjectFlatComboSettings(satisfies, EvidencePackage.eINSTANCE.getSatisfies_Element());
			...
			if (isAccessible(EvidenceViewsRepository.Satisfies.Properties.element)) {
				basePart.addFilterToElement(new ViewerFilter() {
					 ...
					 */
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						return (element instanceof ProjectElement);
					}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == EvidenceViewsRepository.Satisfies.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == EvidenceViewsRepository.Satisfies.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == EvidenceViewsRepository.Satisfies.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == EvidenceViewsRepository.Satisfies.Properties.timing) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Timing();
		}
		if (editorKey == EvidenceViewsRepository.Satisfies.Properties.custody) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Custody();
		}
		if (editorKey == EvidenceViewsRepository.Satisfies.Properties.provenance) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Provenance();
		}
		if (editorKey == EvidenceViewsRepository.Satisfies.Properties.event) {
			return EvidencePackage.eINSTANCE.getEvidenceElement_Event();
		}
		if (editorKey == EvidenceViewsRepository.Satisfies.Properties.element) {
			return EvidencePackage.eINSTANCE.getSatisfies_Element();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		Satisfies satisfies = (Satisfies)semanticObject;
		if (EvidenceViewsRepository.Satisfies.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (EvidenceViewsRepository.Satisfies.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Satisfies.Properties.id == event.getAffectedEditor()) {
			satisfies.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (EvidenceViewsRepository.Satisfies.Properties.timing == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Satisfies.Properties.custody == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Satisfies.Properties.provenance == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Satisfies.Properties.event == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (EvidenceViewsRepository.Satisfies.Properties.element == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				elementSettings.setToReference((ProjectElement)event.getNewValue());
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			SatisfiesPropertiesEditionPart basePart = (SatisfiesPropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Satisfies.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Satisfies.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(EvidenceViewsRepository.Satisfies.Properties.id)) {
			...
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Timing().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Satisfies.Properties.timing))
				basePart.updateTiming();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Custody().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Satisfies.Properties.custody))
				basePart.updateCustody();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Provenance().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Satisfies.Properties.provenance))
				basePart.updateProvenance();
			if (EvidencePackage.eINSTANCE.getEvidenceElement_Event().equals(msg.getFeature()) && isAccessible(EvidenceViewsRepository.Satisfies.Properties.event))
				basePart.updateEvent();
			if (EvidencePackage.eINSTANCE.getSatisfies_Element().equals(msg.getFeature()) && basePart != null && isAccessible(EvidenceViewsRepository.Satisfies.Properties.element))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			EvidencePackage.eINSTANCE.getSatisfies_Element()		);
	...
	public boolean isRequired(Object key, int kind) {
		return key == EvidenceViewsRepository.Satisfies.Properties.id || key == EvidenceViewsRepository.Satisfies.Properties.element;
	}
