 ...
 * 
 */
public class ToolNotesPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ToolNotesPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject tool, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(EvidenceViewsRepository.Notes.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(tool, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				notesPart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Notes.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(tool, SACMPackage.eINSTANCE.getModelElement_Annotation());
