 ...
 * 
 */
public interface AtTimePropertiesEditionPart {
	...
	/**
	 * Defines a new dateTtime
	 * @param newValue the new dateTtime to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the dateTtime edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
