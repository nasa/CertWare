 ...
 * 
 */
public interface CareOfPropertiesEditionPart {
	...
	/**
	 * Defines a new custodian
	 * @param newValue the new custodian to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the custodian edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
