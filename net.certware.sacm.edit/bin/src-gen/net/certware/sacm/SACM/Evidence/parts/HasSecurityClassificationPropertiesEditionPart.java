 ...
 * 
 */
public interface HasSecurityClassificationPropertiesEditionPart {
	...
	/**
	 * Defines a new securityClassification
	 * @param newValue the new securityClassification to set
	 * 
	 */
