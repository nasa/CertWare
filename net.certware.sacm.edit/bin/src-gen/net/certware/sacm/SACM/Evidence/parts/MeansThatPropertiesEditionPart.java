 ...
 * 
 */
public interface MeansThatPropertiesEditionPart {
	...
	/**
	 * Defines a new meaning
	 * @param newValue the new meaning to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the meaning edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
