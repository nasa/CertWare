 ...
 * 
 */
public interface ObjectifiedAssertionPropertiesEditionPart {
	 ...
	 * @param newValue the new assertion to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the assertion edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
