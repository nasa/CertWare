 ...
 * 
 */
public class ProjectObjectivePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ProjectObjectivePropertiesEditionPart {
	 ...
	 */
	public ProjectObjectivePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ProjectObjectivePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(EvidenceViewsRepository.ProjectObjective.Properties.taggedValue);
		propertiesStep.addStep(EvidenceViewsRepository.ProjectObjective.Properties.annotation);
		...
		composer = new PartComposer(projectObjectiveStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == EvidenceViewsRepository.ProjectObjective.Properties.taggedValue) {
					return createTaggedValueTableComposition(widgetFactory, parent);
				}
				if (key == EvidenceViewsRepository.ProjectObjective.Properties.annotation) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EvidenceMessages.ProjectObjectivePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createTaggedValueTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.taggedValue = new ReferencesTable(getDescription(EvidenceViewsRepository.ProjectObjective.Properties.taggedValue, EvidenceMessages.ProjectObjectivePropertiesEditionPart_TaggedValueLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				taggedValue.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				taggedValue.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				taggedValue.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				taggedValue.refresh();
			}
		...
		this.taggedValue.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.taggedValue, EvidenceViewsRepository.FORM_KIND));
		...
		this.taggedValue.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.taggedValue, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		taggedValue.setID(EvidenceViewsRepository.ProjectObjective.Properties.taggedValue);
	...
	protected Composite createAnnotationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.annotation = new ReferencesTable(getDescription(EvidenceViewsRepository.ProjectObjective.Properties.annotation, EvidenceMessages.ProjectObjectivePropertiesEditionPart_AnnotationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				annotation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				annotation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				annotation.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				annotation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.annotation.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.annotation, EvidenceViewsRepository.FORM_KIND));
		this.annotation.createControls(parent, widgetFactory);
		this.annotation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.annotation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		annotation.setID(EvidenceViewsRepository.ProjectObjective.Properties.annotation);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProjectObjectivePropertiesEditionPartForm.this,
							EvidenceViewsRepository.ProjectObjective.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, EvidenceViewsRepository.ProjectObjective.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.id, EvidenceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTimingTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.timing = new ReferencesTable(getDescription(EvidenceViewsRepository.ProjectObjective.Properties.timing, EvidenceMessages.ProjectObjectivePropertiesEditionPart_TimingLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.timing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				timing.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.timing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				timing.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.timing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				timing.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.timing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				timing.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.timing.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.timing, EvidenceViewsRepository.FORM_KIND));
		this.timing.createControls(parent, widgetFactory);
		this.timing.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.timing, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createCustodyTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.custody = new ReferencesTable(getDescription(EvidenceViewsRepository.ProjectObjective.Properties.custody, EvidenceMessages.ProjectObjectivePropertiesEditionPart_CustodyLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.custody, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				custody.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.custody, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				custody.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.custody, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				custody.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.custody, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				custody.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.custody.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.custody, EvidenceViewsRepository.FORM_KIND));
		this.custody.createControls(parent, widgetFactory);
		this.custody.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.custody, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createProvenanceTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.provenance = new ReferencesTable(getDescription(EvidenceViewsRepository.ProjectObjective.Properties.provenance, EvidenceMessages.ProjectObjectivePropertiesEditionPart_ProvenanceLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.provenance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				provenance.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.provenance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				provenance.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.provenance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				provenance.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.provenance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				provenance.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.provenance.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.provenance, EvidenceViewsRepository.FORM_KIND));
		this.provenance.createControls(parent, widgetFactory);
		this.provenance.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.provenance, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createEventTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.event = new ReferencesTable(getDescription(EvidenceViewsRepository.ProjectObjective.Properties.event, EvidenceMessages.ProjectObjectivePropertiesEditionPart_EventLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.event, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				event.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.event, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				event.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.event, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				event.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.event, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				event.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.event.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.event, EvidenceViewsRepository.FORM_KIND));
		this.event.createControls(parent, widgetFactory);
		this.event.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.event, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProjectObjectivePropertiesEditionPartForm.this,
							EvidenceViewsRepository.ProjectObjective.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, EvidenceViewsRepository.ProjectObjective.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.name, EvidenceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createContentText(FormToolkit widgetFactory, Composite parent) {
		...
		content.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProjectObjectivePropertiesEditionPartForm.this,
							EvidenceViewsRepository.ProjectObjective.Properties.content,
		...
		content.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.content, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, content.getText()));
				}
			}
		});
		EditingUtils.setID(content, EvidenceViewsRepository.ProjectObjective.Properties.content);
		EditingUtils.setEEFtype(content, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.content, EvidenceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.property = new ReferencesTable(getDescription(EvidenceViewsRepository.ProjectObjective.Properties.property, EvidenceMessages.ProjectObjectivePropertiesEditionPart_PropertyLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.property, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				property.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.property, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				property.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.property, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				property.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.property, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				property.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.property.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.ProjectObjective.Properties.property, EvidenceViewsRepository.FORM_KIND));
		this.property.createControls(parent, widgetFactory);
		this.property.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProjectObjectivePropertiesEditionPartForm.this, EvidenceViewsRepository.ProjectObjective.Properties.property, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#initTaggedValue(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initTaggedValue(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EvidenceViewsRepository.ProjectObjective.Properties.taggedValue);
		if (eefElementEditorReadOnlyState && taggedValue.isEnabled()) {
			taggedValue.setEnabled(false);
			taggedValue.setToolTipText(EvidenceMessages.ProjectObjective_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#updateTaggedValue()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#addFilterTaggedValue(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#addBusinessFilterTaggedValue(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#isContainedInTaggedValueTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#initAnnotation(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initAnnotation(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EvidenceViewsRepository.ProjectObjective.Properties.annotation);
		if (eefElementEditorReadOnlyState && annotation.isEnabled()) {
			annotation.setEnabled(false);
			annotation.setToolTipText(EvidenceMessages.ProjectObjective_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#updateAnnotation()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#addFilterAnnotation(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#addBusinessFilterAnnotation(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.ProjectObjectivePropertiesEditionPart#isContainedInAnnotationTable(EObject element)
	 * 
	 */
