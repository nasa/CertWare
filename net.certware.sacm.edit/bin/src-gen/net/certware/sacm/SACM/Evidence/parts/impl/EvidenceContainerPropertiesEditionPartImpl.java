	...
	protected Composite createElementAdvancedTableComposition(Composite parent) {
		this.element = new ReferencesTable(getDescription(EvidenceViewsRepository.EvidenceContainer.Properties.element, EvidenceMessages.EvidenceContainerPropertiesEditionPart_ElementLabel), new ReferencesTableListener() {
			...
			public void handleEdit(EObject eo) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.element, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, eo));
				element.refresh();
			}
			public void handleMove(EObject eo, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.element, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, eo, newIndex));
				element.refresh();
			}
			public void handleRemove(EObject eo) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.element, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, eo));
				element.refresh();
			}
			public void navigateTo(EObject element) { }
		});
