 ...
 * 
 */
public class AtLocationPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public AtLocationPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public AtLocationPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof AtLocation) 
					&& (EvidencePackage.Literals.AT_LOCATION == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.AT_LOCATION == eObj.eClass();
		}
