 ...
 * 
 */
public class ContainerCompletenessPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public ContainerCompletenessPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public ContainerCompletenessPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ContainerCompleteness) 
					&& (EvidencePackage.Literals.CONTAINER_COMPLETENESS == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.CONTAINER_COMPLETENESS == eObj.eClass();
		}
