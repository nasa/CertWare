 ...
 * 
 */
public class EvidenceRequestPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public EvidenceRequestPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public EvidenceRequestPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof EvidenceRequest) 
					&& (EvidencePackage.Literals.EVIDENCE_REQUEST == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.EVIDENCE_REQUEST == eObj.eClass();
		}
