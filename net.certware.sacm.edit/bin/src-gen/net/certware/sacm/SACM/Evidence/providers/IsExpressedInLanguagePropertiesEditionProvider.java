 ...
 * 
 */
public class IsExpressedInLanguagePropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public IsExpressedInLanguagePropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public IsExpressedInLanguagePropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof IsExpressedInLanguage) 
					&& (EvidencePackage.Literals.IS_EXPRESSED_IN_LANGUAGE == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.IS_EXPRESSED_IN_LANGUAGE == eObj.eClass();
		}
