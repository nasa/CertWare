 ...
 * 
 */
public class OrganizationPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public OrganizationPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public OrganizationPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Organization) 
					&& (EvidencePackage.Literals.ORGANIZATION == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.ORGANIZATION == eObj.eClass();
		}
