 ...
 * 
 */
public class ProjectObjectivePropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public ProjectObjectivePropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public ProjectObjectivePropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ProjectObjective) 
					&& (EvidencePackage.Literals.PROJECT_OBJECTIVE == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.PROJECT_OBJECTIVE == eObj.eClass();
		}
