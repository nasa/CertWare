 ...
 * 
 */
public class RoleBindingPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public RoleBindingPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public RoleBindingPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof RoleBinding) 
					&& (EvidencePackage.Literals.ROLE_BINDING == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.ROLE_BINDING == eObj.eClass();
		}
