 ...
 * 
 */
public class UnknownObjectPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public UnknownObjectPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public UnknownObjectPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof UnknownObject) 
					&& (EvidencePackage.Literals.UNKNOWN_OBJECT == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.UNKNOWN_OBJECT == eObj.eClass();
		}
