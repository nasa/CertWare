...
public class AssuranceCasePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(SACMViewsRepository.AssuranceCase.Properties.taggedValue)) {
			...
			if (isAccessible(SACMViewsRepository.AssuranceCase.Properties.annotation)) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == SACMViewsRepository.AssuranceCase.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == SACMViewsRepository.AssuranceCase.Properties.annotation) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SACMViewsRepository.AssuranceCase.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (SACMViewsRepository.AssuranceCase.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(SACMViewsRepository.AssuranceCase.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(SACMViewsRepository.AssuranceCase.Properties.annotation))
