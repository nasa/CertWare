 ...
 * 
 */
public class DatetimePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DatetimePropertiesEditionPart {
	 ...
	 * 
	 */
	public DatetimePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(datetimeStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == SACMViewsRepository.Datetime.Properties.datetime_) {
					return createDatetimeText(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(SACMMessages.DatetimePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createDatetimeText(Composite parent) {
		...
		datetime = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		datetime.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DatetimePropertiesEditionPartImpl.this, SACMViewsRepository.Datetime.Properties.datetime_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, datetime.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(SACMViewsRepository.Datetime.Properties.datetime_, SACMViewsRepository.SWT_KIND), null); //$NON-NLS-1$
