...
/**
 * This is the item provider adapter for a {@link net.certware.sacm.SACM.Evidence.IsCharacterizedBy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IsCharacterizedBy_assertion_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_IsCharacterizedBy_assertion_feature", "_UI_IsCharacterizedBy_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 EvidencePackage.Literals.IS_CHARACTERIZED_BY__ASSERTION,
				 true,
				 false,
				 true,
				 null,
