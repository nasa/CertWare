...
/**
 * This is the item provider adapter for a {@link net.certware.sacm.SACM.Evidence.Stakeholder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StakeholderItemProvider
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Stakeholder_type") : //$NON-NLS-1$
			getString("_UI_Stakeholder_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
