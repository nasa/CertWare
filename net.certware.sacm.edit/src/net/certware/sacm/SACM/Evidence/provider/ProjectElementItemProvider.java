...
/**
 * This is the item provider adapter for a {@link net.certware.sacm.SACM.Evidence.ProjectElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectElementItemProvider
	extends EvidenceElementItemProvider
	implements
	 ...
	 * @generated
	 */
	public ProjectElementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EvidencePackage.Literals.PROJECT_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProjectElement_content_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_ProjectElement_content_feature", "_UI_ProjectElement_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 EvidencePackage.Literals.PROJECT_ELEMENT__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EvidencePackage.Literals.PROJECT_ELEMENT__PROPERTY);
		}
	...
	public String getText(Object object) {
		String label = ((ProjectElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ProjectElement_type") : //$NON-NLS-1$
			getString("_UI_ProjectElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProjectElement.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EvidencePackage.Literals.PROJECT_ELEMENT__PROPERTY,
