...
/**
 * This is the item provider adapter for a {@link net.certware.sacm.SACM.ModelElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelElementItemProvider
	extends SACMElementItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SACMPackage.Literals.MODEL_ELEMENT__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SACMPackage.Literals.MODEL_ELEMENT__TAGGED_VALUE);
			childrenFeatures.add(SACMPackage.Literals.MODEL_ELEMENT__ANNOTATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SACMPackage.Literals.MODEL_ELEMENT__TAGGED_VALUE,
				 SACMFactory.eINSTANCE.createTaggedValue()));

		newChildDescriptors.add
			(createChildParameter
				(SACMPackage.Literals.MODEL_ELEMENT__ANNOTATION,
				 SACMFactory.eINSTANCE.createAnnotation()));
	}
