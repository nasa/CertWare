 ...
 * 
 */
public class AssertedCounterEvidencePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public AssertedCounterEvidencePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject assertedCounterEvidence, String editing_mode) {
		...
		partKey = ArgumentationViewsRepository.AssertedCounterEvidence.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final AssertedCounterEvidencePropertiesEditionPart basePart = (AssertedCounterEvidencePropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.taggedValue)) {
			...
			if (isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.annotation)) {
			...
			if (isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.id))
				basePart.setId(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, assertedCounterEvidence.getId()));
			
			if (isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.description))
				basePart.setDescription(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, assertedCounterEvidence.getDescription()));
			
			if (isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.content))
				basePart.setContent(EEFConverterUtil.convertToString(SACMPackage.Literals.STRING, assertedCounterEvidence.getContent()));
			
			if (isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.source)) {
				sourceSettings = new ReferencesTableSettings(assertedCounterEvidence, ArgumentationPackage.eINSTANCE.getAssertedRelationship_Source());
				basePart.initSource(sourceSettings);
			}
			if (isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.target)) {
				targetSettings = new ReferencesTableSettings(assertedCounterEvidence, ArgumentationPackage.eINSTANCE.getAssertedRelationship_Target());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == ArgumentationViewsRepository.AssertedCounterEvidence.Properties.taggedValue) {
			return SACMPackage.eINSTANCE.getModelElement_TaggedValue();
		}
		if (editorKey == ArgumentationViewsRepository.AssertedCounterEvidence.Properties.annotation) {
			return SACMPackage.eINSTANCE.getModelElement_Annotation();
		}
		if (editorKey == ArgumentationViewsRepository.AssertedCounterEvidence.Properties.id) {
			return SACMPackage.eINSTANCE.getModelElement_Id();
		}
		if (editorKey == ArgumentationViewsRepository.AssertedCounterEvidence.Properties.description) {
			return ArgumentationPackage.eINSTANCE.getArgumentationElement_Description();
		}
		if (editorKey == ArgumentationViewsRepository.AssertedCounterEvidence.Properties.content) {
			return ArgumentationPackage.eINSTANCE.getArgumentationElement_Content();
		}
		if (editorKey == ArgumentationViewsRepository.AssertedCounterEvidence.Properties.source) {
			return ArgumentationPackage.eINSTANCE.getAssertedRelationship_Source();
		}
		if (editorKey == ArgumentationViewsRepository.AssertedCounterEvidence.Properties.target) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (ArgumentationViewsRepository.AssertedCounterEvidence.Properties.taggedValue == event.getAffectedEditor()) {
		...
		if (ArgumentationViewsRepository.AssertedCounterEvidence.Properties.annotation == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (ArgumentationViewsRepository.AssertedCounterEvidence.Properties.id == event.getAffectedEditor()) {
			assertedCounterEvidence.setId((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (ArgumentationViewsRepository.AssertedCounterEvidence.Properties.description == event.getAffectedEditor()) {
			assertedCounterEvidence.setDescription((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (ArgumentationViewsRepository.AssertedCounterEvidence.Properties.content == event.getAffectedEditor()) {
			assertedCounterEvidence.setContent((java.lang.String)EEFConverterUtil.createFromString(SACMPackage.Literals.STRING, (String)event.getNewValue()));
		}
		if (ArgumentationViewsRepository.AssertedCounterEvidence.Properties.source == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
		...
		if (ArgumentationViewsRepository.AssertedCounterEvidence.Properties.target == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				if (event.getNewValue() instanceof ArgumentElement) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			AssertedCounterEvidencePropertiesEditionPart basePart = (AssertedCounterEvidencePropertiesEditionPart)editingPart;
			if (SACMPackage.eINSTANCE.getModelElement_TaggedValue().equals(msg.getFeature()) && isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.taggedValue))
				basePart.updateTaggedValue();
			if (SACMPackage.eINSTANCE.getModelElement_Annotation().equals(msg.getFeature()) && isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.annotation))
				basePart.updateAnnotation();
			if (SACMPackage.eINSTANCE.getModelElement_Id().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.id)) {
			...
			if (ArgumentationPackage.eINSTANCE.getArgumentationElement_Description().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.description)) {
				if (msg.getNewValue() != null) {
			...
			if (ArgumentationPackage.eINSTANCE.getArgumentationElement_Content().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.content)) {
				if (msg.getNewValue() != null) {
			...
			if (ArgumentationPackage.eINSTANCE.getAssertedRelationship_Source().equals(msg.getFeature())  && isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.source))
				basePart.updateSource();
			if (ArgumentationPackage.eINSTANCE.getAssertedRelationship_Target().equals(msg.getFeature())  && isAccessible(ArgumentationViewsRepository.AssertedCounterEvidence.Properties.target))
