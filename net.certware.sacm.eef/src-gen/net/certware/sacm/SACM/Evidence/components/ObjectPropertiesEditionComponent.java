...
public class ObjectPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final Object object = (Object)elt;
			...
			if (isAccessible(EvidenceViewsRepository.Object.Properties.taggedValue)) {
				taggedValueSettings = new ReferencesTableSettings(elt, SACMPackage.eINSTANCE.getModelElement_TaggedValue());
				basePart.initTaggedValue(taggedValueSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Object.Properties.annotation)) {
				annotationSettings = new ReferencesTableSettings(elt, SACMPackage.eINSTANCE.getModelElement_Annotation());
			...
			if (isAccessible(EvidenceViewsRepository.Object.Properties.timing)) {
				timingSettings = new ReferencesTableSettings(elt, EvidencePackage.eINSTANCE.getEvidenceElement_Timing());
				basePart.initTiming(timingSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Object.Properties.custody)) {
				custodySettings = new ReferencesTableSettings(elt, EvidencePackage.eINSTANCE.getEvidenceElement_Custody());
				basePart.initCustody(custodySettings);
			}
			if (isAccessible(EvidenceViewsRepository.Object.Properties.provenance)) {
				provenanceSettings = new ReferencesTableSettings(elt, EvidencePackage.eINSTANCE.getEvidenceElement_Provenance());
				basePart.initProvenance(provenanceSettings);
			}
			if (isAccessible(EvidenceViewsRepository.Object.Properties.event)) {
				eventSettings = new ReferencesTableSettings(elt, EvidencePackage.eINSTANCE.getEvidenceElement_Event());
			...
			if (isAccessible(EvidenceViewsRepository.Object.Properties.definition)) {
				// init part
				definitionSettings = new EObjectFlatComboSettings(elt, EvidencePackage.eINSTANCE.getObject_Definition());
