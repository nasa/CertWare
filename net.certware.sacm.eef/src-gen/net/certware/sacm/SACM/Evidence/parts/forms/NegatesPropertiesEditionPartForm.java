 ...
 * 
 */
public class NegatesPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, NegatesPropertiesEditionPart {
	 ...
	 */
	public NegatesPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public NegatesPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(EvidenceViewsRepository.Negates.Properties.taggedValue);
		propertiesStep.addStep(EvidenceViewsRepository.Negates.Properties.annotation);
		...
		composer = new PartComposer(negatesStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == EvidenceViewsRepository.Negates.Properties.taggedValue) {
					return createTaggedValueTableComposition(widgetFactory, parent);
				}
				if (key == EvidenceViewsRepository.Negates.Properties.annotation) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(EvidenceMessages.NegatesPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createTaggedValueTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.taggedValue = new ReferencesTable(getDescription(EvidenceViewsRepository.Negates.Properties.taggedValue, EvidenceMessages.NegatesPropertiesEditionPart_TaggedValueLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				taggedValue.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				taggedValue.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				taggedValue.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				taggedValue.refresh();
			}
		...
		this.taggedValue.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.Negates.Properties.taggedValue, EvidenceViewsRepository.FORM_KIND));
		...
		this.taggedValue.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.taggedValue, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		taggedValue.setID(EvidenceViewsRepository.Negates.Properties.taggedValue);
	...
	protected Composite createAnnotationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.annotation = new ReferencesTable(getDescription(EvidenceViewsRepository.Negates.Properties.annotation, EvidenceMessages.NegatesPropertiesEditionPart_AnnotationLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				annotation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				annotation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				annotation.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				annotation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.annotation.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.Negates.Properties.annotation, EvidenceViewsRepository.FORM_KIND));
		this.annotation.createControls(parent, widgetFactory);
		this.annotation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.annotation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		annotation.setID(EvidenceViewsRepository.Negates.Properties.annotation);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							NegatesPropertiesEditionPartForm.this,
							EvidenceViewsRepository.Negates.Properties.id,
		...
		id.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
				}
			}
		});
		EditingUtils.setID(id, EvidenceViewsRepository.Negates.Properties.id);
		EditingUtils.setEEFtype(id, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.Negates.Properties.id, EvidenceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTimingTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.timing = new ReferencesTable(getDescription(EvidenceViewsRepository.Negates.Properties.timing, EvidenceMessages.NegatesPropertiesEditionPart_TimingLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.timing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				timing.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.timing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				timing.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.timing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				timing.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.timing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				timing.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.timing.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.Negates.Properties.timing, EvidenceViewsRepository.FORM_KIND));
		this.timing.createControls(parent, widgetFactory);
		this.timing.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.timing, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createCustodyTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.custody = new ReferencesTable(getDescription(EvidenceViewsRepository.Negates.Properties.custody, EvidenceMessages.NegatesPropertiesEditionPart_CustodyLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.custody, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				custody.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.custody, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				custody.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.custody, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				custody.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.custody, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				custody.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.custody.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.Negates.Properties.custody, EvidenceViewsRepository.FORM_KIND));
		this.custody.createControls(parent, widgetFactory);
		this.custody.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.custody, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createProvenanceTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.provenance = new ReferencesTable(getDescription(EvidenceViewsRepository.Negates.Properties.provenance, EvidenceMessages.NegatesPropertiesEditionPart_ProvenanceLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.provenance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				provenance.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.provenance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				provenance.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.provenance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				provenance.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.provenance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				provenance.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.provenance.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.Negates.Properties.provenance, EvidenceViewsRepository.FORM_KIND));
		this.provenance.createControls(parent, widgetFactory);
		this.provenance.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.provenance, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createEventTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.event = new ReferencesTable(getDescription(EvidenceViewsRepository.Negates.Properties.event, EvidenceMessages.NegatesPropertiesEditionPart_EventLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.event, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				event.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.event, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				event.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.event, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				event.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.event, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				event.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.event.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.Negates.Properties.event, EvidenceViewsRepository.FORM_KIND));
		this.event.createControls(parent, widgetFactory);
		this.event.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.event, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createAttributeTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.attribute = new ReferencesTable(getDescription(EvidenceViewsRepository.Negates.Properties.attribute, EvidenceMessages.NegatesPropertiesEditionPart_AttributeLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.attribute, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				attribute.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.attribute, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				attribute.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.attribute, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				attribute.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.attribute, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				attribute.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.attribute.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.Negates.Properties.attribute, EvidenceViewsRepository.FORM_KIND));
		this.attribute.createControls(parent, widgetFactory);
		this.attribute.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.attribute, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createElementFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		element = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(EvidenceViewsRepository.Negates.Properties.element, EvidenceViewsRepository.FORM_KIND));
		...
		element.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NegatesPropertiesEditionPartForm.this, EvidenceViewsRepository.Negates.Properties.element, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getElement()));
			}

		});
		element.setID(EvidenceViewsRepository.Negates.Properties.element);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.Negates.Properties.element, EvidenceViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#initTaggedValue(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initTaggedValue(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EvidenceViewsRepository.Negates.Properties.taggedValue);
		if (eefElementEditorReadOnlyState && taggedValue.isEnabled()) {
			taggedValue.setEnabled(false);
			taggedValue.setToolTipText(EvidenceMessages.Negates_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#updateTaggedValue()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#addFilterTaggedValue(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#addBusinessFilterTaggedValue(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#isContainedInTaggedValueTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#initAnnotation(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initAnnotation(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EvidenceViewsRepository.Negates.Properties.annotation);
		if (eefElementEditorReadOnlyState && annotation.isEnabled()) {
			annotation.setEnabled(false);
			annotation.setToolTipText(EvidenceMessages.Negates_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#updateAnnotation()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#addFilterAnnotation(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#addBusinessFilterAnnotation(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.NegatesPropertiesEditionPart#isContainedInAnnotationTable(EObject element)
	 * 
	 */
