 ...
 * 
 */
public class EvidenceContainerPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EvidenceContainerPropertiesEditionPart {
	 ...
	 * 
	 */
	public EvidenceContainerPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	public void createControls(Composite view) { 
		...
		propertiesStep.addStep(EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue);
		propertiesStep.addStep(EvidenceViewsRepository.EvidenceContainer.Properties.annotation);
		...
		composer = new PartComposer(evidenceContainerStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue) {
					return createTaggedValueAdvancedTableComposition(parent);
				}
				if (key == EvidenceViewsRepository.EvidenceContainer.Properties.annotation) {
				...
				if (key == EvidenceViewsRepository.EvidenceContainer.Properties.item) {
					return createItemAdvancedTableComposition(parent);
				}
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(EvidenceMessages.EvidenceContainerPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createTaggedValueAdvancedTableComposition(Composite parent) {
		this.taggedValue = new ReferencesTable(getDescription(EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue, EvidenceMessages.EvidenceContainerPropertiesEditionPart_TaggedValueLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				taggedValue.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				taggedValue.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				taggedValue.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				taggedValue.refresh();
			}
		...
		this.taggedValue.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue, EvidenceViewsRepository.SWT_KIND));
		this.taggedValue.createControls(parent);
		this.taggedValue.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		taggedValue.setID(EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue);
	...
	protected Composite createAnnotationAdvancedTableComposition(Composite parent) {
		this.annotation = new ReferencesTable(getDescription(EvidenceViewsRepository.EvidenceContainer.Properties.annotation, EvidenceMessages.EvidenceContainerPropertiesEditionPart_AnnotationLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				annotation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				annotation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				annotation.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.annotation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				annotation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.annotation.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.annotation, EvidenceViewsRepository.SWT_KIND));
		this.annotation.createControls(parent);
		this.annotation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.annotation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		annotation.setID(EvidenceViewsRepository.EvidenceContainer.Properties.annotation);
	...
	protected Composite createIdText(Composite parent) {
		...
		id.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.id, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, id.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.id, EvidenceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.name, EvidenceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createEvaluationAdvancedTableComposition(Composite parent) {
		this.evaluation = new ReferencesTable(getDescription(EvidenceViewsRepository.EvidenceContainer.Properties.evaluation, EvidenceMessages.EvidenceContainerPropertiesEditionPart_EvaluationLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.evaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				evaluation.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.evaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				evaluation.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.evaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				evaluation.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.evaluation, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				evaluation.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.evaluation.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.evaluation, EvidenceViewsRepository.SWT_KIND));
		this.evaluation.createControls(parent);
		this.evaluation.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.evaluation, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * 
	 */
	protected Composite createItemAdvancedTableComposition(Composite parent) {
		this.item = new ReferencesTable(getDescription(EvidenceViewsRepository.EvidenceContainer.Properties.item, EvidenceMessages.EvidenceContainerPropertiesEditionPart_ItemLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.item, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				item.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.item, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				item.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.item, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				item.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.item, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				item.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.item.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.item, EvidenceViewsRepository.SWT_KIND));
		this.item.createControls(parent);
		this.item.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.item, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createItemAdvancedTableComposition
	...
	protected Composite createGidText(Composite parent) {
		...
		gid.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.gid, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, gid.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.gid, EvidenceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPropertyAdvancedTableComposition(Composite parent) {
		this.property = new ReferencesTable(getDescription(EvidenceViewsRepository.EvidenceContainer.Properties.property, EvidenceMessages.EvidenceContainerPropertiesEditionPart_PropertyLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.property, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				property.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.property, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				property.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.property, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				property.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.property, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				property.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.property.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.property, EvidenceViewsRepository.SWT_KIND));
		this.property.createControls(parent);
		this.property.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.property, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createVersionText(Composite parent) {
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.version, EvidenceViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createElementAdvancedTableComposition(Composite parent) {
		this.element = new ReferencesTable(getDescription(EvidenceViewsRepository.EvidenceContainer.Properties.element, EvidenceMessages.EvidenceContainerPropertiesEditionPart_ElementLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.element, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				element.refresh();
			}
			public void handleEdit(EObject elementa) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.element, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, elementa));
				element.refresh();
			}
			public void handleMove(EObject elementa, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.element, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, elementa, newIndex));
				element.refresh();
			}
			public void handleRemove(EObject elementa) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.element, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, elementa));
				element.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.element.setHelpText(propertiesEditionComponent.getHelpContent(EvidenceViewsRepository.EvidenceContainer.Properties.element, EvidenceViewsRepository.SWT_KIND));
		this.element.createControls(parent);
		this.element.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(EvidenceContainerPropertiesEditionPartImpl.this, EvidenceViewsRepository.EvidenceContainer.Properties.element, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.EvidenceContainerPropertiesEditionPart#initTaggedValue(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initTaggedValue(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EvidenceViewsRepository.EvidenceContainer.Properties.taggedValue);
		if (eefElementEditorReadOnlyState && taggedValue.isEnabled()) {
			taggedValue.setEnabled(false);
			taggedValue.setToolTipText(EvidenceMessages.EvidenceContainer_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see net.certware.sacm.SACM.Evidence.parts.EvidenceContainerPropertiesEditionPart#initAnnotation(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initAnnotation(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(EvidenceViewsRepository.EvidenceContainer.Properties.annotation);
		if (eefElementEditorReadOnlyState && annotation.isEnabled()) {
			annotation.setEnabled(false);
			annotation.setToolTipText(EvidenceMessages.EvidenceContainer_ReadOnly);
