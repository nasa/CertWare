 ...
 * 
 */
public class CompletenessPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public CompletenessPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public CompletenessPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Completeness) 
					&& (EvidencePackage.Literals.COMPLETENESS == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.COMPLETENESS == eObj.eClass();
		}
