 ...
 * 
 */
public class CompositeObjectPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public CompositeObjectPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public CompositeObjectPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof CompositeObject) 
					&& (EvidencePackage.Literals.COMPOSITE_OBJECT == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.COMPOSITE_OBJECT == eObj.eClass();
		}
