 ...
 * 
 */
public class ExtendedProjectPropertyPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public ExtendedProjectPropertyPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public ExtendedProjectPropertyPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof ExtendedProjectProperty) 
					&& (EvidencePackage.Literals.EXTENDED_PROJECT_PROPERTY == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.EXTENDED_PROJECT_PROPERTY == eObj.eClass();
		}
