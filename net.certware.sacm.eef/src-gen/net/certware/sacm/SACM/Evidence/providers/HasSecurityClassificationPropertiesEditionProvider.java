 ...
 * 
 */
public class HasSecurityClassificationPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public HasSecurityClassificationPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public HasSecurityClassificationPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof HasSecurityClassification) 
					&& (EvidencePackage.Literals.HAS_SECURITY_CLASSIFICATION == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.HAS_SECURITY_CLASSIFICATION == eObj.eClass();
		}
