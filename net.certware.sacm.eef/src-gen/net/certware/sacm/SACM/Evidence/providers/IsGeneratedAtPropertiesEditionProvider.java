 ...
 * 
 */
public class IsGeneratedAtPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public IsGeneratedAtPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public IsGeneratedAtPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof IsGeneratedAt) 
					&& (EvidencePackage.Literals.IS_GENERATED_AT == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EvidencePackage.Literals.IS_GENERATED_AT == eObj.eClass();
		}
