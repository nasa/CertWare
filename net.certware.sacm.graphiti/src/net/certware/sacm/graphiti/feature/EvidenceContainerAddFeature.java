...
public class EvidenceContainerAddFeature extends AbstractAddShapeFeature {

	public EvidenceContainerAddFeature(IFeatureProvider fp) {
		super(fp);
	}

	public boolean canAdd(IAddContext context) {
		if ( context.getNewObject() instanceof EvidenceContainer ) {
	...
	public PictogramElement add(IAddContext context) {
		...
		final EvidenceContainer addedEvidenceContainer = (EvidenceContainer)context.getNewObject();
		...
		RoundedRectangle rect;
		{
			...
			rr.setFilled(false);
			rr.setLineStyle(LineStyle.DASH);
			rr.setForeground(manageColor(IColorConstant.BLUE));
			// rr.setBackground(manageColor(IColorConstant.DARK_ORANGE));
			link(containerShape, addedEvidenceContainer);
		}
