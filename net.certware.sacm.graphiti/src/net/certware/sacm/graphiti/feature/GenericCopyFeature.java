...
public class GenericCopyFeature extends AbstractCopyFeature {

	public GenericCopyFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canCopy(ICopyContext context) {
		...
		for (PictogramElement pe : pes) {
			...
			if (!(bo instanceof EClass)) { // TODO should not allow non-SACM objects
				return false;
			}
		}
		return true;
