 ...
 * <ul>
 *   <li>{@link net.certware.sacm.SACM.Evidence.impl.EndTimeImpl#getDatetime <em>Datetime</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EndTimeImpl extends EffectiveTimeImpl implements EndTime {
		...
		if (datetime != null && datetime.eIsProxy()) {
			...
			if (datetime != oldDatetime) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EvidencePackage.END_TIME__DATETIME, oldDatetime, datetime));
			}
		}
		return datetime;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EvidencePackage.END_TIME__TAGGED_VALUE:
				return getTaggedValue();
			case EvidencePackage.END_TIME__ANNOTATION:
				return getAnnotation();
			case EvidencePackage.END_TIME__ID:
				return getId();
			case EvidencePackage.END_TIME__TIMING:
				return getTiming();
			case EvidencePackage.END_TIME__CUSTODY:
				return getCustody();
			case EvidencePackage.END_TIME__PROVENANCE:
				return getProvenance();
			case EvidencePackage.END_TIME__EVENT:
				return getEvent();
