 ...
 * <ul>
 *   <li>{@link net.certware.sacm.SACM.Evidence.impl.ConsistencyImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ConsistencyImpl extends DocumentPropertyImpl implements Consistency {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return EvidencePackage.Literals.CONSISTENCY;
	}
	...
	public void setValue(ConsistencyLevel newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EvidencePackage.CONSISTENCY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EvidencePackage.CONSISTENCY__TAGGED_VALUE:
				return getTaggedValue();
			case EvidencePackage.CONSISTENCY__ANNOTATION:
				return getAnnotation();
			case EvidencePackage.CONSISTENCY__ID:
				return getId();
			case EvidencePackage.CONSISTENCY__TIMING:
				return getTiming();
			case EvidencePackage.CONSISTENCY__CUSTODY:
				return getCustody();
			case EvidencePackage.CONSISTENCY__PROVENANCE:
				return getProvenance();
			case EvidencePackage.CONSISTENCY__EVENT:
				return getEvent();
