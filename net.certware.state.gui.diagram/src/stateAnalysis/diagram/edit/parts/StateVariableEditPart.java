 ...
 * @generated
 */
public class StateVariableEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public StateVariableEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new stateAnalysis.diagram.edit.policies.StateVariableItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof stateAnalysis.diagram.edit.parts.StateVariableNameEditPart) {
			((stateAnalysis.diagram.edit.parts.StateVariableNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureStateVariableLabelFigure());
			return true;
		}
		if (childEditPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableInStateConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStateVariableInStateConstraintsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((stateAnalysis.diagram.edit.parts.StateVariableStateVariableInStateConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableOutStateConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStateVariableOutStateConstraintsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((stateAnalysis.diagram.edit.parts.StateVariableStateVariableOutStateConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableStateUpdatesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStateVariableStateUpdatesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((stateAnalysis.diagram.edit.parts.StateVariableStateVariableStateUpdatesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableInfluencedByCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStateVariableInfluencedByCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((stateAnalysis.diagram.edit.parts.StateVariableStateVariableInfluencedByCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableInStateConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStateVariableInStateConstraintsCompartmentFigure();
			pane.remove(((stateAnalysis.diagram.edit.parts.StateVariableStateVariableInStateConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableOutStateConstraintsCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStateVariableOutStateConstraintsCompartmentFigure();
			pane.remove(((stateAnalysis.diagram.edit.parts.StateVariableStateVariableOutStateConstraintsCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableStateUpdatesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStateVariableStateUpdatesCompartmentFigure();
			pane.remove(((stateAnalysis.diagram.edit.parts.StateVariableStateVariableStateUpdatesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableInfluencedByCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStateVariableInfluencedByCompartmentFigure();
			pane.remove(((stateAnalysis.diagram.edit.parts.StateVariableStateVariableInfluencedByCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableInStateConstraintsCompartmentEditPart) {
			return getPrimaryShape()
					.getStateVariableInStateConstraintsCompartmentFigure();
		}
		if (editPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableOutStateConstraintsCompartmentEditPart) {
			return getPrimaryShape()
					.getStateVariableOutStateConstraintsCompartmentFigure();
		}
		if (editPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableStateUpdatesCompartmentEditPart) {
			return getPrimaryShape()
					.getStateVariableStateUpdatesCompartmentFigure();
		}
		if (editPart instanceof stateAnalysis.diagram.edit.parts.StateVariableStateVariableInfluencedByCompartmentEditPart) {
			return getPrimaryShape()
					.getStateVariableInfluencedByCompartmentFigure();
		}
