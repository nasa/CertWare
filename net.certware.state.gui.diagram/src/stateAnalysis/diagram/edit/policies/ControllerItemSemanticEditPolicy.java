 ...
 * @generated
 */
public class ControllerItemSemanticEditPolicy
		extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (stateAnalysis.diagram.providers.StateAnalysisElementTypes.ControllerDelegates_4001 == req
				.getElementType()) {
			return getGEFWrapper(new stateAnalysis.diagram.edit.commands.ControllerDelegatesCreateCommand(
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case stateAnalysis.diagram.edit.parts.ControllerDelegatesEditPart.VISUAL_ID:
			return getGEFWrapper(new stateAnalysis.diagram.edit.commands.ControllerDelegatesReorientCommand(
					req));
		}
