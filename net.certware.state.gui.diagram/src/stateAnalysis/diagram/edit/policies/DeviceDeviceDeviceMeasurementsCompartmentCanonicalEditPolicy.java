 ...
 * @generated
 */
public class DeviceDeviceDeviceMeasurementsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<stateAnalysis.diagram.part.StateAnalysisNodeDescriptor> childDescriptors = stateAnalysis.diagram.part.StateAnalysisDiagramUpdater
				.getDeviceDeviceDeviceMeasurementsCompartment_7029SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return stateAnalysis.diagram.edit.parts.DeviceMeasurementEditPart.VISUAL_ID == stateAnalysis.diagram.part.StateAnalysisVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<stateAnalysis.diagram.part.StateAnalysisNodeDescriptor> childDescriptors = stateAnalysis.diagram.part.StateAnalysisDiagramUpdater
				.getDeviceDeviceDeviceMeasurementsCompartment_7029SemanticChildren((View) getHost()
						.getModel());
