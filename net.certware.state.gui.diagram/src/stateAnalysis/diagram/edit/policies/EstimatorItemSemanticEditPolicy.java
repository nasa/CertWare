 ...
 * @generated
 */
public class EstimatorItemSemanticEditPolicy
		extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (stateAnalysis.diagram.providers.StateAnalysisElementTypes.EstimatorDistilledMeasurements_4002 == req
				.getElementType()) {
			return getGEFWrapper(new stateAnalysis.diagram.edit.commands.EstimatorDistilledMeasurementsCreateCommand(
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case stateAnalysis.diagram.edit.parts.EstimatorDistilledMeasurementsEditPart.VISUAL_ID:
			return getGEFWrapper(new stateAnalysis.diagram.edit.commands.EstimatorDistilledMeasurementsReorientCommand(
					req));
		}
