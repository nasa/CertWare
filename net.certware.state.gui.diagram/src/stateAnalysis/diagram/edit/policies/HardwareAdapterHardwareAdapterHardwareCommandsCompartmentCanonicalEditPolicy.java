 ...
 * @generated
 */
public class HardwareAdapterHardwareAdapterHardwareCommandsCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<stateAnalysis.diagram.part.StateAnalysisNodeDescriptor> childDescriptors = stateAnalysis.diagram.part.StateAnalysisDiagramUpdater
				.getHardwareAdapterHardwareAdapterHardwareCommandsCompartment_7039SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return stateAnalysis.diagram.edit.parts.HardwareCommand2EditPart.VISUAL_ID == stateAnalysis.diagram.part.StateAnalysisVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<stateAnalysis.diagram.part.StateAnalysisNodeDescriptor> childDescriptors = stateAnalysis.diagram.part.StateAnalysisDiagramUpdater
				.getHardwareAdapterHardwareAdapterHardwareCommandsCompartment_7039SemanticChildren((View) getHost()
						.getModel());
