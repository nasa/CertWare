 ...
 * @generated
 */
public class StateVariableStateVariableOutStateConstraintsCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<stateAnalysis.diagram.part.StateAnalysisNodeDescriptor> childDescriptors = stateAnalysis.diagram.part.StateAnalysisDiagramUpdater
				.getStateVariableStateVariableOutStateConstraintsCompartment_7016SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return stateAnalysis.diagram.edit.parts.StateConstraint2EditPart.VISUAL_ID == stateAnalysis.diagram.part.StateAnalysisVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<stateAnalysis.diagram.part.StateAnalysisNodeDescriptor> childDescriptors = stateAnalysis.diagram.part.StateAnalysisDiagramUpdater
				.getStateVariableStateVariableOutStateConstraintsCompartment_7016SemanticChildren((View) getHost()
						.getModel());
