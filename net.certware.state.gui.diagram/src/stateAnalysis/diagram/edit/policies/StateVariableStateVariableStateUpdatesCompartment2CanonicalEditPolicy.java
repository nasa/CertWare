 ...
 * @generated
 */
public class StateVariableStateVariableStateUpdatesCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<stateAnalysis.diagram.part.StateAnalysisNodeDescriptor> childDescriptors = stateAnalysis.diagram.part.StateAnalysisDiagramUpdater
				.getStateVariableStateVariableStateUpdatesCompartment_7017SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return stateAnalysis.diagram.edit.parts.StateUpdateEditPart.VISUAL_ID == stateAnalysis.diagram.part.StateAnalysisVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<stateAnalysis.diagram.part.StateAnalysisNodeDescriptor> childDescriptors = stateAnalysis.diagram.part.StateAnalysisDiagramUpdater
				.getStateVariableStateVariableStateUpdatesCompartment_7017SemanticChildren((View) getHost()
						.getModel());
