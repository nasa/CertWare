 ...
 * @generated
 */
public class StateAnalysisDomainNavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof stateAnalysis.diagram.navigator.StateAnalysisDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((stateAnalysis.diagram.navigator.StateAnalysisDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new stateAnalysis.diagram.navigator.StateAnalysisDomainNavigatorItem(
