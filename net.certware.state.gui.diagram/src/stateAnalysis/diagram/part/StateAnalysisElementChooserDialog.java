 ...
 * @generated
 */
public class StateAnalysisElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public StateAnalysisElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						stateAnalysis.diagram.part.Messages.StateAnalysisElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "stateAnalysis".equals(fileExtension); //$NON-NLS-1$
	}
