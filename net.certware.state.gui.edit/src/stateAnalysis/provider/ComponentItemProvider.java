...
/**
 * This is the item provider adapter for a {@link stateAnalysis.Component} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StateAnalysisPackage.Literals.COMPONENT__NAME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StateAnalysisPackage.Literals.COMPONENT__DESCRIPTION,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StateAnalysisPackage.Literals.COMPONENT__STATE_VARIABLES);
      childrenFeatures.add(StateAnalysisPackage.Literals.COMPONENT__CONTROLLERS);
      childrenFeatures.add(StateAnalysisPackage.Literals.COMPONENT__ESTIMATORS);
      childrenFeatures.add(StateAnalysisPackage.Literals.COMPONENT__ADAPTERS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (StateAnalysisPackage.Literals.COMPONENT__STATE_VARIABLES,
         StateAnalysisFactory.eINSTANCE.createStateVariable()));

    newChildDescriptors.add
      (createChildParameter
        (StateAnalysisPackage.Literals.COMPONENT__CONTROLLERS,
         StateAnalysisFactory.eINSTANCE.createController()));

    newChildDescriptors.add
      (createChildParameter
        (StateAnalysisPackage.Literals.COMPONENT__ESTIMATORS,
         StateAnalysisFactory.eINSTANCE.createEstimator()));

    newChildDescriptors.add
      (createChildParameter
        (StateAnalysisPackage.Literals.COMPONENT__ADAPTERS,
