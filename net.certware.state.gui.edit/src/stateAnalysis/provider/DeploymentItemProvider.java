...
/**
 * This is the item provider adapter for a {@link stateAnalysis.Deployment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StateAnalysisPackage.Literals.DEPLOYMENT__NAME,
         true,
         false,
         false,
  ...
  protected void addDescriptionPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Deployment_description_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Deployment_description_feature", "_UI_Deployment_type"),
         StateAnalysisPackage.Literals.DEPLOYMENT__DESCRIPTION,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StateAnalysisPackage.Literals.DEPLOYMENT__COMPONENTS);
      childrenFeatures.add(StateAnalysisPackage.Literals.DEPLOYMENT__CATALOGS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (StateAnalysisPackage.Literals.DEPLOYMENT__CATALOGS,
         StateAnalysisFactory.eINSTANCE.createDataCollection()));
  }
