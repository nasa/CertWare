...
/**
 * This is the item provider adapter for a {@link stateAnalysis.Device} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StateAnalysisPackage.Literals.DEVICE__NAME,
         true,
         false,
         false,
  ...
  protected void addDescriptionPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Device_description_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Device_description_feature", "_UI_Device_type"),
         StateAnalysisPackage.Literals.DEVICE__DESCRIPTION,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StateAnalysisPackage.Literals.DEVICE__DEVICE_COMMANDS);
      childrenFeatures.add(StateAnalysisPackage.Literals.DEVICE__DEVICE_MEASUREMENTS);
    }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (StateAnalysisPackage.Literals.DEVICE__DEVICE_COMMANDS,
         StateAnalysisFactory.eINSTANCE.createDeviceCommand()));

    newChildDescriptors.add
      (createChildParameter
        (StateAnalysisPackage.Literals.DEVICE__DEVICE_MEASUREMENTS,
         StateAnalysisFactory.eINSTANCE.createDeviceMeasurement()));
  }
