...
/**
 * This is the item provider adapter for a {@link stateAnalysis.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StateAnalysisPackage.Literals.SYSTEM__NAME,
         true,
         false,
         false,
  ...
  protected void addDescriptionPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_System_description_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_System_description_feature", "_UI_System_type"),
         StateAnalysisPackage.Literals.SYSTEM__DESCRIPTION,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StateAnalysisPackage.Literals.SYSTEM__SUBSYSTEMS);
    }
  ...
  {
    String label = ((stateAnalysis.System)object).getName();
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(stateAnalysis.System.class))
    {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (StateAnalysisPackage.Literals.SYSTEM__SUBSYSTEMS,
         StateAnalysisFactory.eINSTANCE.createSubsystem()));
  }
