 ...
 * <ul>
 *   <li>{@link stateAnalysis.Estimator#getName <em>Name</em>}</li>
 *   <li>{@link stateAnalysis.Estimator#getDescription <em>Description</em>}</li>
...
public interface Estimator extends EObject
{
   ...
   * @see #setName(String)
   * @see stateAnalysis.StateAnalysisPackage#getEstimator_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link stateAnalysis.Estimator#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see stateAnalysis.StateAnalysisPackage#getEstimator_Description()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link stateAnalysis.Estimator#getDescription <em>Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
