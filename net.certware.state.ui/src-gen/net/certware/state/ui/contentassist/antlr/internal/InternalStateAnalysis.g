...
{ before(grammarAccess.getDeviceMeasurementAccess().getDescriptionSTRINGTerminalRuleCall_2_0()); }
	RULE_STRING{ after(grammarAccess.getDeviceMeasurementAccess().getDescriptionSTRINGTerminalRuleCall_2_0()); }
)
...
{ before(grammarAccess.getHardwareAdapterAccess().getDescriptionSTRINGTerminalRuleCall_2_0()); }
	RULE_STRING{ after(grammarAccess.getHardwareAdapterAccess().getDescriptionSTRINGTerminalRuleCall_2_0()); }
)
