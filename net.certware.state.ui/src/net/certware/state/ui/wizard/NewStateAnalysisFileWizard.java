 ...
 * @since 2.0.1
 */
public class NewStateAnalysisFileWizard extends Wizard implements INewWizard {
	/** initial selection, presumably a container */
	private IStructuredSelection selection;
	/** wizard page for file specifics */
	private NewStateAnalysisFileWizardPage newFileWizardPage;
	 ...
	 */
	public NewStateAnalysisFileWizard() {
		setWindowTitle("New State Analysis Model File");
	...
	public void addPages() {
		newFileWizardPage = new NewStateAnalysisFileWizardPage(selection);
