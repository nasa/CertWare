 ...
 *   <li>{@link net.certware.state.stateAnalysis.StateConstraint#getDescription <em>Description</em>}</li>
 * </ul>
 * </p>
 *
...
public interface StateConstraint extends EObject
{
   ...
   * @see net.certware.state.stateAnalysis.StateAnalysisPackage#getStateConstraint_Description()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.certware.state.stateAnalysis.StateConstraint#getDescription <em>Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
