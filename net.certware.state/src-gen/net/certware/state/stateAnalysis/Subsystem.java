 ...
 *   <li>{@link net.certware.state.stateAnalysis.Subsystem#getDescription <em>Description</em>}</li>
...
public interface Subsystem extends EObject
{
   ...
   * @see net.certware.state.stateAnalysis.StateAnalysisPackage#getSubsystem_Description()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link net.certware.state.stateAnalysis.Subsystem#getDescription <em>Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
