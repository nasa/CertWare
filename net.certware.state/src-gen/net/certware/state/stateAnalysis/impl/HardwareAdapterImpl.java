...
public class HardwareAdapterImpl extends MinimalEObjectImpl.Container implements HardwareAdapter
{
  ...
  /**
   * The cached value of the '{@link #getHardwareCommands() <em>Hardware Commands</em>}' reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The cached value of the '{@link #getHardwareMeasurements() <em>Hardware Measurements</em>}' reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The cached value of the '{@link #getDeviceCommands() <em>Device Commands</em>}' reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The cached value of the '{@link #getDeviceMeasurements() <em>Device Measurements</em>}' reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public EList<HardwareCommand> getHardwareCommands()
  {
    ...
    {
      hardwareCommands = new EObjectResolvingEList<HardwareCommand>(HardwareCommand.class, this, StateAnalysisPackage.HARDWARE_ADAPTER__HARDWARE_COMMANDS);
    }
  ...
  public EList<HardwareMeasurement> getHardwareMeasurements()
  {
    ...
    {
      hardwareMeasurements = new EObjectResolvingEList<HardwareMeasurement>(HardwareMeasurement.class, this, StateAnalysisPackage.HARDWARE_ADAPTER__HARDWARE_MEASUREMENTS);
    }
  ...
  public EList<DeviceCommand> getDeviceCommands()
  {
    ...
    {
      deviceCommands = new EObjectResolvingEList<DeviceCommand>(DeviceCommand.class, this, StateAnalysisPackage.HARDWARE_ADAPTER__DEVICE_COMMANDS);
    }
  ...
  public EList<DeviceMeasurement> getDeviceMeasurements()
  {
    ...
    {
      deviceMeasurements = new EObjectResolvingEList<DeviceMeasurement>(DeviceMeasurement.class, this, StateAnalysisPackage.HARDWARE_ADAPTER__DEVICE_MEASUREMENTS);
    }
