...
public class CategoryPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Category) && (ChecklistPackage.eINSTANCE.getCategory() == eObject.eClass());
	}
	...
	public boolean provides(EObject eObject, String part) {
		return (eObject instanceof Category) && (CategoryPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(EObject eObject, java.lang.Class refinement) {
		return (eObject instanceof Category) && (refinement == CategoryPropertiesEditionComponent.class);
	}
	...
	public boolean provides(EObject eObject, String part, java.lang.Class refinement) {
		return (eObject instanceof Category) && ((CategoryPropertiesEditionComponent.BASE_PART.equals(part) && refinement == CategoryPropertiesEditionComponent.class));
	}
