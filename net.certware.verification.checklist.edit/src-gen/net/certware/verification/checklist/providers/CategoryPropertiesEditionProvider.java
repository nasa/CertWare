...
public class CategoryPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	 ...
	 */
	public CategoryPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public CategoryPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public boolean provides(PropertiesEditingContext editingContext, String part) {
		return (editingContext.getEObject() instanceof Category) && (CategoryPropertiesEditionComponent.BASE_PART.equals(part));
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof Category) && (refinement == CategoryPropertiesEditionComponent.class);
	}
	...
	public boolean provides(PropertiesEditingContext editingContext, String part, java.lang.Class refinement) {
		return (editingContext.getEObject() instanceof Category) && ((CategoryPropertiesEditionComponent.BASE_PART.equals(part) && refinement == CategoryPropertiesEditionComponent.class));
	}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part) {
		if (editingContext.getEObject() instanceof Category) {
			if (CategoryPropertiesEditionComponent.BASE_PART.equals(part))
				return new CategoryPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof Category) {
			if (CategoryPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == CategoryPropertiesEditionComponent.class)
				return new CategoryPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
