...
/**
 * This is the item provider adapter for a {@link net.certware.verification.checklist.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ChecklistPackage.Literals.CATEGORY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addItemsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_items_feature"), //$NON-NLS-1$
				 getString("_UI_Category_items_description"), //$NON-NLS-1$
				 ChecklistPackage.Literals.CATEGORY__ITEMS,
				 true,
				 false,
				 false,
				 null,
	...
	protected void addCommentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_comment_feature"), //$NON-NLS-1$
				 getString("_UI_Category_comment_description"), //$NON-NLS-1$
				 ChecklistPackage.Literals.CATEGORY__COMMENT,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ChecklistPackage.Literals.CATEGORY__ITEMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ChecklistPackage.Literals.CATEGORY__ITEMS,
				 ChecklistFactory.eINSTANCE.createItem()));
	}
