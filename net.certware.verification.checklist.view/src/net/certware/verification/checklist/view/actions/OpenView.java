package net.certware.verification.checklist.view.actions;
...
{
  static private final String PROJECT_VIEW_ID = "net.certware.verification.checklist.view.list"; //$NON-NLS-1$
  ...
  public void run(IAction action)
  {
    if ( latestPart != null ) {
      try {
        ...
        CertWareLog.logError("Opening checklist view", e);
      }
    }
  }
